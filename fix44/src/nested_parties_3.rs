...
pub struct NestedParties3 {
	/// Repeating group below should contain unique combinations of <a href="tag_949_Nested3PartyID.html" target="bottom">Nested3PartyID&nbsp;(949)</a> , <a href="tag_950_Nested3PartyIDSource.html" target="bottom">Nested3PartyIDSource&nbsp;(950)</a> , and <a href="tag_951_Nested3PartyRole.html" target="bottom">Nested3PartyRole&nbsp;(951)</a>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "948")]
	pub nested_3_party_i_ds: Option<fix_common::RepeatingValues<Nested3PartyID>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct Nested3PartyID {
	/// Used to identify source of Nested3PartyID. Required if <a href="tag_950_Nested3PartyIDSource.html" target="bottom">Nested3PartyIDSource&nbsp;(950)</a> is specified. Required if <a href="tag_948_NoNested3PartyIDs.html" target="bottom">NoNested3PartyIDs&nbsp;(948)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "949")]
	pub nested_3_party_id: Option<String>,
	/// Used to identify class source of Nested3PartyID value (e.g. BIC). Required if <a href="tag_949_Nested3PartyID.html" target="bottom">Nested3PartyID&nbsp;(949)</a> is specified. Required if <a href="tag_948_NoNested3PartyIDs.html" target="bottom">NoNested3PartyIDs&nbsp;(948)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "950")]
	pub nested_3_party_id_source: Option<Nested3PartyIDSource>,
	/// Identifies the type of Nested3PartyID (e.g. Executing Broker). Required if <a href="tag_948_NoNested3PartyIDs.html" target="bottom">NoNested3PartyIDs&nbsp;(948)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "951")]
	pub nested_3_party_role: Option<Nested3PartyRole>,
	/// Repeating group of Nested3Party sub-identifiers.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "952")]
	pub no_nested_3_party_sub_i_ds: Option<usize>,
	/// Sub-identifier (e.g. Clearing Acct for <a href="tag_448_PartyID.html" target="bottom">PartyID&nbsp;(448)</a> =Clearing Firm) if applicable. Required if <a href="tag_952_NoNested3PartySubIDs.html" target="bottom">NoNested3PartySubIDs&nbsp;(952)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "953")]
	pub nested_3_party_sub_id: Option<String>,
	/// Type of Sub-identifier. Required if <a href="tag_952_NoNested3PartySubIDs.html" target="bottom">NoNested3PartySubIDs&nbsp;(952)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "954")]
...
impl Default for Nested3PartyIDSource {
	fn default() -> Self {
		Nested3PartyIDSource::BicCode
	}
}

#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum Nested3PartyRole {
...
impl Default for Nested3PartyRole {
	fn default() -> Self {
		Nested3PartyRole::ExecutingFirm
	}
}
