...
pub struct AllocationReport {
	/// MsgType = AS
	#[serde(flatten)]
	pub standard_message_header: super::super::standard_message_header::StandardMessageHeader<'A', 'S'>,
	...
	/// Required for <a href="tag_71_AllocTransType.html" target="bottom">AllocTransType&nbsp;(71)</a> = Replace or Cancel. Gives the reason for replacing or cancelling the allocation report
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "796")]
	...
	/// Specifies the purpose or type of <a href="message_Allocation_Report_AS.html" target="main">Allocation Report&nbsp;(AS)</a> message
	#[serde(rename = "794")]
	...
	/// Can be used to link two different Allocation messages (each with unique <a href="tag_70_AllocID.html" target="bottom">AllocID&nbsp;(70)</a> ) together, i.e. for F/X "Netting" or "Swaps"
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "196")]
	...
	/// Expressed in same currency as <a href="tag_6_AvgPx.html" target="bottom">AvgPx&nbsp;(6)</a> . Sum of ( <a href="tag_80_AllocQty.html" target="bottom">AllocQty&nbsp;(80)</a> * <a href="tag_153_AllocAvgPx.html" target="bottom">AllocAvgPx&nbsp;(153)</a> or <a href="tag_366_AllocPrice.html" target="bottom">AllocPrice&nbsp;(366)</a> ).
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "381")]
	...
	/// Indicates number of allocation groups to follow. Not required for <a href="tag_71_AllocTransType.html" target="bottom">AllocTransType&nbsp;(71)</a> =Cancel. Not required for <a href="tag_794_AllocReportType.html" target="bottom">AllocReportType&nbsp;(794)</a> = "Warehouse recap".
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "78")]
...
pub struct Order {
	...
	/// that the sum of the <a href="tag_800_OrderBookingQty.html" target="bottom">OrderBookingQty&nbsp;(800)</a> values in this repeating group must equal the total quantity being allocated (in <a href="tag_53_Quantity.html" target="bottom">Quantity&nbsp;(53)</a> field)
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "800")]
...
pub struct Alloc {
	...
	/// disclose individual account breakdowns to the ExecBroker. Required if NoAllocs &gt; 0. Must be first field in repeating group.Not
	/// required for AllocTransType=Cancel.Not required for AllocType="Buyside Ready-To-Book " or "Warehouse instruction".
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "79")]
	...
	/// <a href="tag_118_NetMoney.html" target="bottom">NetMoney&nbsp;(118)</a> for this <a href="tag_79_AllocAccount.html" target="bottom">AllocAccount&nbsp;(79)</a> : (( <a href="tag_80_AllocQty.html" target="bottom">AllocQty&nbsp;(80)</a> * <a href="tag_153_AllocAvgPx.html" target="bottom">AllocAvgPx&nbsp;(153)</a> ) - <a href="tag_12_Commission.html" target="bottom">Commission&nbsp;(12)</a> - sum of <a href="tag_137_MiscFeeAmt.html" target="bottom">MiscFeeAmt&nbsp;(137)</a> + <a href="tag_159_AccruedInterestAmt.html" target="bottom">AccruedInterestAmt&nbsp;(159)</a> ) if a Sell; (( <a href="tag_80_AllocQty.html" target="bottom">AllocQty&nbsp;(80)</a> * <a href="tag_153_AllocAvgPx.html" target="bottom">AllocAvgPx&nbsp;(153)</a> ) + <a href="tag_12_Commission.html" target="bottom">Commission&nbsp;(12)</a> + sum of <a href="tag_137_MiscFeeAmt.html" target="bottom">MiscFeeAmt&nbsp;(137)</a> + <a href="tag_159_AccruedInterestAmt.html" target="bottom">AccruedInterestAmt&nbsp;(159)</a> ) if a Buy
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "154")]
