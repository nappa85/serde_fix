...
pub struct OrderCancelRequest {
	...
	/// Note: <a href="tag_38_OrderQty.html" target="bottom">OrderQty&nbsp;(38)</a> = <a href="tag_14_CumQty.html" target="bottom">CumQty&nbsp;(14)</a> + <a href="tag_151_LeavesQty.html" target="bottom">LeavesQty&nbsp;(151)</a> (see exceptions above)
	#[serde(flatten)]
