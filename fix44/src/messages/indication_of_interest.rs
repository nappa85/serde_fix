...
pub struct IndicationOfInterest {
	...
	/// The value zero is used if <a href="tag_555_NoLegs.html" target="bottom">NoLegs&nbsp;(555)</a> repeating group is used. Applicable if needed to express <a href="tag_152_CashOrderQty.html" target="bottom">CashOrderQty&nbsp;(152)</a>
	#[serde(flatten)]
