...
pub struct PositionMaintenanceReport {
	...
	/// Status of <a href="message_Position_Maintenance_Request_AL.html" target="main">Position Maintenance Request&nbsp;(AL)</a>
	#[serde(rename = "722")]
	...
	/// Type of adjustment to be applied. Delta_plus, Delta_minus, Final. If Adjustment Type is null, the PCS request will be processed
	/// as Margin Disposition only.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "718")]
