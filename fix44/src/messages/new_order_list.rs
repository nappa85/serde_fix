...
pub struct Order {
	...
	/// Note: to indicate the side of SideValue1 or SideValue2, specify <a href="tag_54_Side.html" target="bottom">Side&nbsp;(54)</a> =Undisclosed and <a href="tag_401_SideValueInd.html" target="bottom">SideValueInd&nbsp;(401)</a> =either the SideValue1 or SideValue2 indicator.
	#[serde(rename = "54")]
	pub side: Side,
