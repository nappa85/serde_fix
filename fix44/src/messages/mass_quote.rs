...
pub struct QuoteSet {
	...
	#[serde(rename = "304")]
	pub tot_no_quote_entries: u32,
	/// Indicates if this message is the last fragment of a fragmented <a href="message_Mass_Quote_i.html" target="main">mass quote&nbsp;(i)</a> message
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "893")]
