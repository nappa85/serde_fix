...
pub struct AllocationReportAck {
	/// MsgType = AT
	#[serde(flatten)]
	pub standard_message_header: super::super::standard_message_header::StandardMessageHeader<'A', 'T'>,
	/// AllocReportID
	#[serde(rename = "755")]
	...
	/// Optional second identifier for the <a href="message_Allocation_Report_AS.html" target="main">allocation report&nbsp;(AS)</a> being acknowledged (need not be unique)
	...
	/// Date/Time <a href="message_Allocation_Report_Ack_AT.html" target="main">Allocation Report Ack&nbsp;(AT)</a> generated
	#[serde(rename = "60")]
	pub transact_time: fix_common::UTCTimestamp,
	/// Denotes the status of the <a href="message_Allocation_Report_AS.html" target="main">allocation report&nbsp;(AS)</a> ; received (but not yet processed), rejected (at block or account level) or accepted (and processed).
	#[serde(rename = "87")]
	...
	/// Denotes whether the financial details provided on the <a href="message_Allocation_Report_AS.html" target="main">Allocation Report&nbsp;(AS)</a> were successfully matched.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "573")]
	...
	/// This group should not be populated where <a href="tag_87_AllocStatus.html" target="bottom">AllocStatus&nbsp;(87)</a> has any other value. Indicates number of allocation groups to follow.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "78")]
