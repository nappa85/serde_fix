...
pub struct Logon {
	...
	/// Optional, alternative via counterparty bi-lateral agreement message gap detection and recovery approach (see <a xmlns="http://www.b2bits.com/FIXProtocol" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" href="https://www.fixtrading.org/standards/" target="_blank">Volume 2: "Logon Message NextExpectedMsgSeqNum Processing" of FIX Specification</a> )
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "789")]
	pub next_expected_msg_seq_num: Option<usize>,
