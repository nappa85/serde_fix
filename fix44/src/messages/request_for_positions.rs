...
pub struct RequestForPositions {
	/// MsgType = AN
	#[serde(flatten)]
	pub standard_message_header: super::super::standard_message_header::StandardMessageHeader<'A', 'N'>,
	/// Unique identifier for the <a href="message_Request_for_Positions_AN.html" target="main">Request for Positions&nbsp;(AN)</a> as assigned by the submitter.
	#[serde(rename = "710")]
