...
pub struct CollateralRequest {
	/// MsgType = AX
	#[serde(flatten)]
	pub standard_message_header: super::super::standard_message_header::StandardMessageHeader<'A', 'X'>,
	/// Unique identifier for <a href="message_Collateral_Request_AX.html" target="main">collateral request&nbsp;(AX)</a>
	#[serde(rename = "894")]
	pub coll_req_id: String,
	/// Reason <a href="message_Collateral_Assignment_AY.html" target="main">collateral assignment&nbsp;(AY)</a> is being requested
	#[serde(rename = "895")]
