...
pub struct PositionReport {
	...
	/// Unique identifier for the <a href="message_Request_for_Positions_AN.html" target="main">Request for Positions&nbsp;(AN)</a> associated with this report. This field should not be provided if the report was sent unsolicited.
	...
	#[serde(rename = "731")]
	pub settl_price_type: SettlPriceType,
	/// PriorSettlPrice
	#[serde(deserialize_with = "fix_common::workarounds::from_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(rename = "734")]
	pub prior_settl_price: f64,
	...
	#[serde(flatten)]
	pub position_amount_data: super::super::position_amount_data::PositionAmountData,
	/// RegNonRegInd
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "506")]
	...
	/// Must be set if <a href="tag_355_EncodedText.html" target="bottom">EncodedText&nbsp;(355)</a> field is specified and must immediately precede it. Japanese use only.
	#[serde(rename = "354")]
	/// Encoded (non-ASCII characters) representation of the <a href="tag_58_Text.html" target="bottom">Text&nbsp;(58)</a> field in the encoded format specified via the <a href="tag_347_MessageEncoding.html" target="bottom">MessageEncoding&nbsp;(347)</a> field. Japanese use only.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(alias = "355")]
...
pub struct Underlying {
	...
	/// Values = Final, Theoretical. Required if <a href="tag_711_NoUnderlyings.html" target="bottom">NoUnderlyings&nbsp;(711)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "733")]
...
pub enum PosReqResult {
	...
	/// Other (use <a href="tag_58_Text.html" target="bottom">Text&nbsp;(58)</a> in conjunction with this code for an explanation)
	#[serde(rename = "99")]
	OtherAInConjunctionWithThisCodeForAnExplanation,
}
