...
pub struct AssignmentReport {
	/// MsgType = AW
	#[serde(flatten)]
	pub standard_message_header: super::super::standard_message_header::StandardMessageHeader<'A', 'W'>,
	...
	#[serde(deserialize_with = "fix_common::workarounds::from_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(rename = "732")]
	pub underlying_settl_price: f64,
	/// Expiration Date of Option
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "432")]
	pub expire_date: Option<fix_common::LocalMktDate>,
	/// Method under which assignment was conducted. Values = Random, ProRata
	#[serde(rename = "744")]
	...
	#[serde(rename = "747")]
	pub exercise_method: ExerciseMethod,
	/// Settlement Session - EOD or Intraday
	#[serde(rename = "716")]
	pub settl_sess_id: String,
	/// Settlement Session enumerator
	#[serde(rename = "717")]
	pub settl_sess_sub_id: String,
