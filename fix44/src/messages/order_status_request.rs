...
pub struct OrderStatusRequest {
	...
	/// Optional, can be used to uniquely identify a specific <a href="message_Order_Status_Request_H.html" target="main">Order Status Request&nbsp;(H)</a> message. Echoed back on <a href="message_Execution_Report_8.html" target="main">Execution Report&nbsp;(8)</a> if provided.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "790")]
