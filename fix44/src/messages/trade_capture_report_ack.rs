...
pub struct TradeCaptureReportAck {
	...
	/// The <a href="tag_818_SecondaryTradeReportID.html" target="bottom">SecondaryTradeReportID&nbsp;(818)</a> that is being referenced for some action, such as correction or cancelation
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "881")]
	...
	/// Reason for Rejection of <a href="message_Trade_Capture_Report_AE.html" target="main">Trade Report&nbsp;(AE)</a> .
	#[serde(rename = "751")]
	pub trade_report_reject_reason: TradeReportRejectReason,
