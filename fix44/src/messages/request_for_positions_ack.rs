...
pub struct RequestForPositionsAck {
	/// MsgType = AO
	#[serde(flatten)]
	pub standard_message_header: super::super::standard_message_header::StandardMessageHeader<'A', 'O'>,
	...
	/// Unique identifier for the Request for Position associated with this report. This field should not be provided if the report
	...
	#[serde(rename = "354")]
	/// Encoded (non-ASCII characters) representation of the <a href="tag_58_Text.html" target="bottom">Text&nbsp;(58)</a> field in the encoded format specified via the MessageEncoding field. Japanese use only.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(alias = "355")]
