...
pub struct CollateralAssignment {
	...
	/// Unique Identifer for <a href="message_Collateral_Assignment_AY.html" target="main">collateral assignment&nbsp;(AY)</a>
	#[serde(rename = "902")]
	...
	/// Reason for <a href="message_Collateral_Assignment_AY.html" target="main">collateral assignment&nbsp;(AY)</a>
	#[serde(rename = "895")]
...
pub struct Underlying {
	/// Required if <a href="tag_711_NoUnderlyings.html" target="bottom">NoUnderlyings&nbsp;(711)</a> &gt; 0, otherwise this field should not be used.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "944")]
