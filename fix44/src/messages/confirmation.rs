...
pub struct Confirmation {
	...
	/// Required for fixed income. Also to be used in associated with <a href="tag_81_ProcessCode.html" target="bottom">ProcessCode&nbsp;(81)</a> for broker of credit (e.g. for directed brokerage trades). Also to be used to specify party-specific regulatory details (e.g.
	...
	/// Used to refer to an earlier <a href="message_Allocation_Instruction_J.html" target="main">Allocation Instruction&nbsp;(J)</a> .
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "70")]
	...
	/// Used to refer to an allocation account within an earlier <a href="message_Allocation_Instruction_J.html" target="main">Allocation Instruction&nbsp;(J)</a> .
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "467")]
	...
	/// The quantity being confirmed by this message (not this is at a trade level, not block or order level)
	...
	/// Used to communicate settlement instructions for this <a href="message_Confirmation_AK.html" target="main">Confirmation&nbsp;(AK)</a> .
	#[serde(flatten)]
...
pub struct Capacitie {
	...
	/// The quantity that was executed under this capacity (e.g. quantity executed as agent, as principal etc.). Sum of <a href="tag_863_OrderCapacityQty.html" target="bottom">OrderCapacityQty&nbsp;(863)</a> values must equal this message's <a href="tag_80_AllocQty.html" target="bottom">AllocQty&nbsp;(80)</a> .
	#[serde(deserialize_with = "fix_common::workarounds::from_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(rename = "863")]
	pub order_capacity_qty: f64,
}
