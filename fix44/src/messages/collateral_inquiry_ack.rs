...
pub struct CollateralInquiryAck {
	...
	/// Status of the <a href="message_Collateral_Inquiry_BB.html" target="main">Collateral Inquiry&nbsp;(BB)</a> referenced by <a href="tag_909_CollInquiryID.html" target="bottom">CollInquiryID&nbsp;(909)</a>
	#[serde(rename = "945")]
	pub coll_inquiry_status: CollInquiryStatus,
	/// Result of the <a href="message_Collateral_Inquiry_BB.html" target="main">Collateral Inquiry&nbsp;(BB)</a> referenced by <a href="tag_909_CollInquiryID.html" target="bottom">CollInquiryID&nbsp;(909)</a> - specifies any errors or warnings
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "946")]
	pub coll_inquiry_result: Option<CollInquiryResult>,
...
impl Default for CollInquiryStatus {
	fn default() -> Self {
...
pub enum CollInquiryResult {
	...
	/// Other (further information in <a href="tag_58_Text.html" target="bottom">Text&nbsp;(58)</a> field)
	#[serde(rename = "99")]
	OtherAField,
}

impl Default for CollInquiryResult {
	fn default() -> Self {
