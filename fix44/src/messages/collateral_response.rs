...
pub struct CollateralResponse {
	...
	/// Unique identifer for the <a href="message_Collateral_Response_AZ.html" target="main">collateral response&nbsp;(AZ)</a>
	#[serde(rename = "904")]
	pub coll_resp_id: String,
	/// <a href="message_Collateral_Assignment_AY.html" target="main">Collateral assignment&nbsp;(AY)</a> to which this response refers
	#[serde(rename = "902")]
	...
	/// Reason for <a href="message_Collateral_Assignment_AY.html" target="main">collateral assignment&nbsp;(AY)</a> is being requeste
	#[serde(rename = "895")]
	...
	#[serde(rename = "905")]
	pub coll_asgn_resp_type: i32,
	/// Reason <a href="message_Collateral_Assignment_AY.html" target="main">Collateral Assignment&nbsp;(AY)</a> was rejected
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "906")]
