...
pub struct AllocationInstruction {
	...
	/// Unique identifier for this <a href="message_Allocation_Instruction_J.html" target="main">Allocation Instruction&nbsp;(J)</a> message
	#[serde(rename = "70")]
	pub alloc_id: String,
	/// i.e. New, Cancel, Replace
	#[serde(rename = "71")]
	pub alloc_trans_type: AllocTransType,
	/// Specifies the purpose or type of <a href="message_Allocation_Instruction_J.html" target="main">Allocation Instruction&nbsp;(J)</a> message
	#[serde(rename = "626")]
	pub alloc_type: AllocType,
	/// Optional second identifier for this <a href="message_Allocation_Instruction_J.html" target="main">allocation instruction&nbsp;(J)</a> (need not be unique)
	...
	/// Required for <a href="tag_71_AllocTransType.html" target="bottom">AllocTransType&nbsp;(71)</a> = Replace or Cancel. Gives the reason for replacing or cancelling the <a href="message_Allocation_Instruction_J.html" target="main">Allocation Instruction&nbsp;(J)</a>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "796")]
	...
	/// Can be used to link two different <a href="message_Allocation_Instruction_J.html" target="main">Allocation Instruction&nbsp;(J)</a> messages (each with unique <a href="tag_70_AllocID.html" target="bottom">AllocID&nbsp;(70)</a> ) together, i.e. for F/X "Netting" or "Swaps"
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "196")]
	pub alloc_link_id: Option<String>,
	/// Can be used to link two different <a href="message_Allocation_Instruction_J.html" target="main">Allocation Instruction&nbsp;(J)</a> messages and identifies the type of link. Required if <a href="tag_196_AllocLinkID.html" target="bottom">AllocLinkID&nbsp;(196)</a> is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "197")]
	pub alloc_link_type: Option<AllocLinkType>,
	/// Can be used with <a href="tag_626_AllocType.html" target="bottom">AllocType&nbsp;(626)</a> =" Ready-To-Book "
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "466")]
	...
	#[serde(rename = "857")]
	pub alloc_no_orders_type: AllocNoOrdersType,
	...
	/// Expressed in same currency as <a href="tag_6_AvgPx.html" target="bottom">AvgPx&nbsp;(6)</a> . Sum of ( <a href="tag_80_AllocQty.html" target="bottom">AllocShares&nbsp;(80)</a> * <a href="tag_153_AllocAvgPx.html" target="bottom">AllocAvgPx&nbsp;(153)</a> or <a href="tag_366_AllocPrice.html" target="bottom">AllocPrice&nbsp;(366)</a> ).
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "381")]
	...
	/// Expressed in same currency as <a href="tag_6_AvgPx.html" target="bottom">AvgPx&nbsp;(6)</a> . Sum of <a href="tag_154_AllocNetMoney.html" target="bottom">AllocNetMoney&nbsp;(154)</a> .
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "118")]
	...
	/// Indicates if <a href="message_Allocation_Instruction_J.html" target="main">Allocation Instruction&nbsp;(J)</a> has been automatically accepted on behalf of the Carry Firm by the Clearing House.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "754")]
	...
	/// Sum of <a href="tag_742_AllocAccruedInterestAmt.html" target="bottom">AllocAccruedInterestAmt&nbsp;(742)</a> within repeating group.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "159")]
	pub accrued_interest_amt: Option<f64>,
	/// (Deprecated) Use <a href="tag_159_AccruedInterestAmt.html" target="bottom">AccruedInterestAmt&nbsp;(159)</a> .
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "540")]
	...
	/// Indicates number of allocation groups to follow. Not required for <a href="tag_71_AllocTransType.html" target="bottom">AllocTransType&nbsp;(71)</a> =Cancel. Not required for <a href="tag_626_AllocType.html" target="bottom">AllocType&nbsp;(626)</a> ="Buyside Ready-To-Book" or "Warehouse instruction".
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "78")]
...
pub struct Order {
	...
	/// Quantity of this order that is being booked out by this message (will be equal to or less than this order's <a href="tag_38_OrderQty.html" target="bottom">OrderQty&nbsp;(38)</a> ). Note that the sum of the <a href="tag_800_OrderBookingQty.html" target="bottom">OrderBookingQty&nbsp;(800)</a> values in this repeating group must equal the total quantity being allocated (in <a href="tag_53_Quantity.html" target="bottom">Quantity&nbsp;(53)</a> field)
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "800")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct Exec {
	/// Amount of quantity (e.g. number of shares) in individual execution. Required if <a href="tag_124_NoExecs.html" target="bottom">NoExecs&nbsp;(124)</a> &gt; 0
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "32")]
	...
	/// Last price expressed in percent-of-par. Conditionally required for Fixed Income trades when <a href="tag_31_LastPx.html" target="bottom">LastPx&nbsp;(31)</a> is expressed in Yield, Spread, Discount or any other price type.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "669")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct Alloc {
	/// May be the same value as BrokerOfCredit if <a href="tag_81_ProcessCode.html" target="bottom">ProcessCode&nbsp;(81)</a> is step-out or soft-dollar step-out and Institution does not wish to disclose individual account breakdowns to the ExecBroker.
	/// Required if <a href="tag_78_NoAllocs.html" target="bottom">NoAllocs&nbsp;(78)</a> &gt; 0. Must be first field in repeating group. Not required for <a href="tag_71_AllocTransType.html" target="bottom">AllocTransType&nbsp;(71)</a> =Cancel. Not required for <a href="tag_626_AllocType.html" target="bottom">AllocType&nbsp;(626)</a> ="Buyside Ready-To-Book" or "Warehouse instruction".
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "79")]
	...
	/// Not required for <a href="tag_71_AllocTransType.html" target="bottom">AllocTransType&nbsp;(71)</a> =Cancel. Not required for <a href="tag_626_AllocType.html" target="bottom">AllocType&nbsp;(626)</a> ="Buyside Ready-To-Book" or "Warehouse instruction".
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "80")]
	...
	/// <a href="tag_6_AvgPx.html" target="bottom">AvgPx&nbsp;(6)</a> for this <a href="tag_79_AllocAccount.html" target="bottom">AllocAccount&nbsp;(79)</a> . For F/X orders, should be the "all-in" rate (spot rate adjusted for forward points) for this allocation. For Fixed Income
	/// always express value as "percent of par".
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "153")]
	pub alloc_avg_px: Option<f64>,
	/// <a href="tag_118_NetMoney.html" target="bottom">NetMoney&nbsp;(118)</a> for this <a href="tag_79_AllocAccount.html" target="bottom">AllocAccount&nbsp;(79)</a> . (( <a href="tag_80_AllocQty.html" target="bottom">AllocShares&nbsp;(80)</a> * <a href="tag_153_AllocAvgPx.html" target="bottom">AllocAvgPx&nbsp;(153)</a> ) - <a href="tag_12_Commission.html" target="bottom">Commission&nbsp;(12)</a> - sum of <a href="tag_137_MiscFeeAmt.html" target="bottom">MiscFeeAmt&nbsp;(137)</a> + <a href="tag_159_AccruedInterestAmt.html" target="bottom">AccruedInterestAmt&nbsp;(159)</a> ) if a Sell. (( <a href="tag_80_AllocQty.html" target="bottom">AllocShares&nbsp;(80)</a> * <a href="tag_153_AllocAvgPx.html" target="bottom">AllocAvgPx&nbsp;(153)</a> ) + <a href="tag_12_Commission.html" target="bottom">Commission&nbsp;(12)</a> + sum of <a href="tag_137_MiscFeeAmt.html" target="bottom">MiscFeeAmt&nbsp;(137)</a> + <a href="tag_159_AccruedInterestAmt.html" target="bottom">AccruedInterestAmt&nbsp;(159)</a> ) if a Buy
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "154")]
	pub alloc_net_money: Option<f64>,
	/// (Deprecated) Replaced by <a href="tag_737_AllocSettlCurrAmt.html" target="bottom">AllocSettlCurrAmt&nbsp;(737)</a> . <a href="tag_154_AllocNetMoney.html" target="bottom">AllocNetMoney&nbsp;(154)</a> in <a href="tag_120_SettlCurrency.html" target="bottom">SettlCurrency&nbsp;(120)</a> for this <a href="tag_79_AllocAccount.html" target="bottom">AllocAccount&nbsp;(79)</a> if <a href="tag_120_SettlCurrency.html" target="bottom">SettlCurrency&nbsp;(120)</a> is different from "overall" <a href="tag_15_Currency.html" target="bottom">Currency&nbsp;(15)</a> .
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "119")]
	pub settl_curr_amt: Option<f64>,
	/// <a href="tag_154_AllocNetMoney.html" target="bottom">AllocNetMoney&nbsp;(154)</a> in <a href="tag_736_AllocSettlCurrency.html" target="bottom">AllocSettlCurrency&nbsp;(736)</a> for this <a href="tag_79_AllocAccount.html" target="bottom">AllocAccount&nbsp;(79)</a> if <a href="tag_736_AllocSettlCurrency.html" target="bottom">AllocSettlCurrency&nbsp;(736)</a> is different from "overall" <a href="tag_15_Currency.html" target="bottom">Currency&nbsp;(15)</a> .
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "737")]
	pub alloc_settl_curr_amt: Option<f64>,
	/// (Deprecated) Replaced by <a href="tag_736_AllocSettlCurrency.html" target="bottom">AllocSettlCurrency&nbsp;(736)</a> . <a href="tag_120_SettlCurrency.html" target="bottom">SettlCurrency&nbsp;(120)</a> for this <a href="tag_79_AllocAccount.html" target="bottom">AllocAccount&nbsp;(79)</a> if different from "overall" <a href="tag_15_Currency.html" target="bottom">Currency&nbsp;(15)</a> . Required if <a href="tag_119_SettlCurrAmt.html" target="bottom">SettlCurrAmt&nbsp;(119)</a> is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "120")]
	pub settl_currency: Option<SettlCurrency>,
	/// <a href="tag_736_AllocSettlCurrency.html" target="bottom">AllocSettlCurrency&nbsp;(736)</a> for this <a href="tag_79_AllocAccount.html" target="bottom">AllocAccount&nbsp;(79)</a> if different from "overall" <a href="tag_15_Currency.html" target="bottom">Currency&nbsp;(15)</a> . Required if <a href="tag_737_AllocSettlCurrAmt.html" target="bottom">AllocSettlCurrAmt&nbsp;(737)</a> is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "736")]
	pub alloc_settl_currency: Option<AllocSettlCurrency>,
	/// Foreign exchange rate used to compute <a href="tag_737_AllocSettlCurrAmt.html" target="bottom">AllocSettlCurrAmt&nbsp;(737)</a> from <a href="tag_15_Currency.html" target="bottom">Currency&nbsp;(15)</a> to <a href="tag_736_AllocSettlCurrency.html" target="bottom">AllocSettlCurrency&nbsp;(736)</a>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "155")]
	...
	#[serde(default)]
	#[serde(rename = "742")]
	pub alloc_accrued_interest_amt: Option<f64>,
	/// Applicable for securities that pay interest in lump-sum at maturity.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "741")]
	pub alloc_interest_at_maturity: Option<f64>,
	...
	/// Required if <a href="tag_576_NoClearingInstructions.html" target="bottom">NoClearingInstructions&nbsp;(576)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "577")]
	...
	/// Used to indicate whether settlement instructions are provided on this message, and if not, how they are to be derived. Absence
	/// of this field implies use of default instructions.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "780")]
...
impl Default for AllocCancReplaceReason {
	fn default() -> Self {
...
impl Default for AllocLinkType {
	fn default() -> Self {
...
impl Default for AllocNoOrdersType {
	fn default() -> Self {
