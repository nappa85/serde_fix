...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct LegStipulation {
	/// Required if <a href="tag_683_NoLegStipulations.html" target="bottom">NoLegStipulations&nbsp;(683)</a> &gt;0
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "688")]
	pub leg_stipulation_type: Option<LegStipulationType>,
	/// LegStipulationValue
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "689")]
