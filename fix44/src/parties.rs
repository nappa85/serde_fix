...
pub struct PartyID {
	...
	/// Used to identify class source of PartyID value (e.g. BIC). Required if <a href="tag_448_PartyID.html" target="bottom">PartyID&nbsp;(448)</a> is specified. Required if <a href="tag_453_NoPartyIDs.html" target="bottom">NoPartyIDs&nbsp;(453)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "447")]
	pub party_id_source: Option<PartyIDSource>,
	/// Identifies the type of PartyID (e.g. Executing Broker). Required if <a href="tag_453_NoPartyIDs.html" target="bottom">NoPartyIDs&nbsp;(453)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "452")]
	...
	#[serde(default)]
	#[serde(rename = "802")]
	pub no_party_sub_i_ds: Option<usize>,
	/// Sub-identifier (e.g. Clearing Acct for <a href="tag_448_PartyID.html" target="bottom">PartyID&nbsp;(448)</a> =Clearing Firm) if applicable. Required if <a href="tag_802_NoPartySubIDs.html" target="bottom">NoPartySubIDs&nbsp;(802)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "523")]
	pub party_sub_id: Option<String>,
	/// Type of Sub-identifier. Required if <a href="tag_802_NoPartySubIDs.html" target="bottom">NoPartySubIDs&nbsp;(802)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "803")]
...
impl Default for PartySubIDType {
	fn default() -> Self {
		PartySubIDType::N1
	}
}
