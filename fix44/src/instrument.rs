...
pub struct Instrument {
	...
	/// Takes precedence in identifying security to counterparty over SecurityAltID block. Requires <a href="tag_22_SecurityIDSource.html" target="bottom">SecurityIDSource&nbsp;(22)</a> if specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "48")]
	...
	/// It is recommended that <a href="tag_461_CFICode.html" target="bottom">CFICode&nbsp;(461)</a> be used instead of <a href="tag_167_SecurityType.html" target="bottom">SecurityType&nbsp;(167)</a> for non-Fixed Income instruments. Required for Fixed Income. Refer to <a xmlns="http://www.b2bits.com/FIXProtocol" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" href="https://www.fixtrading.org/standards/" target="_blank">"Volume 7 - Fixed Income" of FIX Specification</a> . Futures and Options should be specified using the <a href="tag_461_CFICode.html" target="bottom">CFICode&nbsp;(461)</a> field instead of <a href="tag_167_SecurityType.html" target="bottom">SecurityType&nbsp;(167)</a> (Refer to <a xmlns="http://www.b2bits.com/FIXProtocol" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" href="https://www.fixtrading.org/standards/" target="_blank">"Volume 7 - Recommendations and Guidelines for Futures and Options Markets" of FIX Specification</a> ).
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "167")]
	pub security_type: Option<SecurityType>,
	/// Sub-type qualification/identification of the <a href="tag_167_SecurityType.html" target="bottom">SecurityType&nbsp;(167)</a> (e.g. for <a href="tag_167_SecurityType.html" target="bottom">SecurityType&nbsp;(167)</a> ="MLEG"). If specified, <a href="tag_167_SecurityType.html" target="bottom">SecurityType&nbsp;(167)</a> is required.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "762")]
	...
	/// Deprecated, use <a href="tag_310_UnderlyingSecurityType.html" target="bottom">UnderlyingSecurityType&nbsp;(310)</a> .
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "239")]
	pub repo_collateral_security_type: Option<RepoCollateralSecurityType>,
	/// Deprecated, use <a href="tag_788_TerminationType.html" target="bottom">TerminationType&nbsp;(788)</a> .
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "226")]
	pub repurchase_term: Option<i32>,
	/// Deprecated, use <a href="tag_44_Price.html" target="bottom">Price&nbsp;(44)</a> .
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "227")]
	...
	/// Deprecated, use <a href="tag_696_YieldRedemptionDate.html" target="bottom">YieldRedemptionDate&nbsp;(696)</a> in <a href="block_Yield_Data.html" target="main">YieldData</a> component block
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "240")]
	...
	/// If different from <a href="tag_225_IssueDate.html" target="bottom">IssueDate&nbsp;(225)</a>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "873")]
	pub dated_date: Option<fix_common::LocalMktDate>,
	/// If different from <a href="tag_225_IssueDate.html" target="bottom">IssueDate&nbsp;(225)</a> and <a href="tag_873_DatedDate.html" target="bottom">DatedDate&nbsp;(873)</a>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "874")]
...
pub struct SecurityAltI {
	/// Security Alternate identifier for this security. First member of repeating group - must be specified if <a href="tag_454_NoSecurityAltID.html" target="bottom">NoSecurityAltID&nbsp;(454)</a> &gt; 0. The Security Alternative identifier block should not be populated unless SecurityID and SecurityIDSource are populated
	/// and should not duplicate the SecurityID and SecurityIDSource values contained in the <a href="tag_48_SecurityID.html" target="bottom">SecurityID&nbsp;(48)</a> / <a href="tag_22_SecurityIDSource.html" target="bottom">SecurityIDSource&nbsp;(22)</a> tags. Use of <a href="tag_455_SecurityAltID.html" target="bottom">SecurityAltID&nbsp;(455)</a> may be used if bilaterally agreed to assist in security identification, and does not imply an obligation on the receiver of
...
impl Default for RepoCollateralSecurityType {
	fn default() -> Self {
		RepoCollateralSecurityType::Treasury
	}
}
