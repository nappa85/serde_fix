...
pub struct SpreadOrBenchmarkCurveData {
	...
	/// Source of <a href="tag_699_BenchmarkSecurityID.html" target="bottom">BenchmarkSecurityID&nbsp;(699)</a> . If not specified, then ID Source is understood to be the same as that in the <a href="block_Instrument.html" target="main">Instrument</a> block.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "761")]
