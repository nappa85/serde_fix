...
pub struct UndlyInstrumentPartie {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1059")]
	pub undly_instrument_party_id: Option<String>,
	/// Used to identify source of instrument party id
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1060")]
	pub undly_instrument_party_id_source: Option<UndlyInstrumentPartyIDSource>,
	/// Used to identify the role of instrument party id
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1061")]
	pub undly_instrument_party_role: Option<UndlyInstrumentPartyRole>,
	/// NoUndlyInstrumentPartySubIDs
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "1062")]
	pub no_undly_instrument_party_sub_i_ds: Option<usize>,
	/// UndlyInstrumentPartySubID
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1063")]
	pub undly_instrument_party_sub_id: Option<String>,
	/// UndlyInstrumentPartySubIDType
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1064")]
	pub undly_instrument_party_sub_id_type: Option<UndlyInstrumentPartySubIDType>,
}

#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum UndlyInstrumentPartyIDSource {
...
impl Default for UndlyInstrumentPartyIDSource {
	fn default() -> Self {
		UndlyInstrumentPartyIDSource::BicCode
	}
}

#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum UndlyInstrumentPartyRole {
...
impl Default for UndlyInstrumentPartyRole {
	fn default() -> Self {
		UndlyInstrumentPartyRole::ExecutingFirm
	}
}

#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum UndlyInstrumentPartySubIDType {
	/// Firm
	#[serde(rename = "1")]
	N1,
	/// Person
...
impl Default for UndlyInstrumentPartySubIDType {
	fn default() -> Self {
		UndlyInstrumentPartySubIDType::N1
	}
}
