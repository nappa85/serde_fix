...
pub struct UnderlyingInstrument {
	...
	/// Specific to the <a href="block_Underlying_Instrument.html" target="main">UnderlyingInstrument</a> (not in <a href="block_Instrument.html" target="main">Instrument</a> ).
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "318")]
	pub underlying_currency: Option<UnderlyingCurrency>,
	/// Specific to the <a href="block_Underlying_Instrument.html" target="main">UnderlyingInstrument</a> (not in <a href="block_Instrument.html" target="main">Instrument</a> ). Unit amount of the underlying security (par, shares, currency, etc.)
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "879")]
	pub underlying_qty: Option<f64>,
	/// Specific to the <a href="block_Underlying_Instrument.html" target="main">UnderlyingInstrument</a> (not in <a href="block_Instrument.html" target="main">Instrument</a> ). In a financing deal clean price (percent-of-par or per unit) of the underlying security or basket.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "810")]
	pub underlying_px: Option<f64>,
	/// Specific to the <a href="block_Underlying_Instrument.html" target="main">UnderlyingInstrument</a> (not in <a href="block_Instrument.html" target="main">Instrument</a> ). In a financing deal price (percent-of-par or per unit) of the underlying security or basket. "Dirty" means it includes
	/// accrued interest
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	...
	/// Specific to the <a href="block_Underlying_Instrument.html" target="main">UnderlyingInstrument</a> (not in <a href="block_Instrument.html" target="main">Instrument</a> ). In a financing deal price (percent-of-par or per unit) of the underlying security or basket at the end of the agreement.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "883")]
	pub underlying_end_price: Option<f64>,
	/// Specific to the <a href="block_Underlying_Instrument.html" target="main">UnderlyingInstrument</a> (not in <a href="block_Instrument.html" target="main">Instrument</a> ). Currency value attributed to this collateral at the start of the agreement
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "884")]
	pub underlying_start_value: Option<f64>,
	/// Specific to the <a href="block_Underlying_Instrument.html" target="main">UnderlyingInstrument</a> (not in <a href="block_Instrument.html" target="main">Instrument</a> ). Currency value currently attributed to this collateral
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "885")]
	pub underlying_current_value: Option<f64>,
	/// Specific to the <a href="block_Underlying_Instrument.html" target="main">UnderlyingInstrument</a> (not in <a href="block_Instrument.html" target="main">Instrument</a> ). Currency value attributed to this collateral at the end of the agreement
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "886")]
...
impl Default for UnderlyingSecurityType {
	fn default() -> Self {
		UnderlyingSecurityType::Treasury
	}
}
...
impl Default for UnderlyingRepoCollateralSecurityType {
	fn default() -> Self {
		UnderlyingRepoCollateralSecurityType::Treasury
	}
}
