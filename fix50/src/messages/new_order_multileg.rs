...
pub struct NewOrderMultileg {
	...
	#[serde(rename = "54")]
	pub side: Side,
	/// Insert here the set of "Instrument" fields defined in "Common Components of Application Messages". SecurityType[167] = "MLEG". <a href="tag_461_CFICode.html" target="bottom">CFICode&nbsp;(461)</a> should be set to the type of multileg product, such as "O" - options, "F" - Future or Swap.
	#[serde(flatten)]
	...
	/// Insert here the set of "OrderQtyData" fields defined in "Common Components of Application Messages" Conditionally required
	/// when the multileg order is not for a FX Swap, or any other swap transaction where having <a href="tag_38_OrderQty.html" target="bottom">OrderQty&nbsp;(38)</a> is irrelevant as the amounts are expressed in the LegQty."
	#[serde(flatten)]
...
pub struct Leg {
	...
	/// Refer to values for <a href="tag_63_SettlType.html" target="bottom">SettlType&nbsp;(63)</a> (63)
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "587")]
	pub leg_settl_type: Option<LegSettlType>,
	/// Refer to values for <a href="tag_64_SettlDate.html" target="bottom">SettlDate&nbsp;(64)</a> (64)
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "588")]
