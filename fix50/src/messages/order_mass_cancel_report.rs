...
pub struct Order {
	...
	/// Unique Identifier for the <a href="message_Order_Mass_Cancel_Request_q.html" target="main">Order Mass Cancel Request&nbsp;(q)</a> assigned by the recipient of the Order Mass Cancel Request
	#[serde(rename = "37")]
	pub order_id: String,
