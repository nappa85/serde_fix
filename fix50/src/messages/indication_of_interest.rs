...
pub struct IndicationOfInterest {
	...
	/// if <a href="tag_555_NoLegs.html" target="bottom">NoLegs&nbsp;(555)</a> repeating group is used. Applicable if needed to express CashOrder Qty (tag 152)
	#[serde(flatten)]
...
pub struct IOIQualifier {
	/// Required if <a href="tag_199_NoIOIQualifiers.html" target="bottom">NoIOIQualifiers&nbsp;(199)</a> &gt; 0
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "104")]
