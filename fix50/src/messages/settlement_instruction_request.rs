...
pub struct SettlementInstructionRequest {
	...
	/// The identifier of the standing instructions within the database specified in StandInstDbType Required if <a href="tag_169_StandInstDbType.html" target="bottom">StandInstDbType&nbsp;(169)</a> populated Should not be populated if any of <a href="tag_79_AllocAccount.html" target="bottom">AllocAccount&nbsp;(79)</a> through to <a href="tag_779_LastUpdateTime.html" target="bottom">LastUpdateTime&nbsp;(779)</a> are populated
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "171")]
