...
pub struct TradeCaptureReport {
	...
	/// Identifies <a href="message_Trade_Capture_Report_AE.html" target="main">Trade Capture Report&nbsp;(AE)</a> message transaction type.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "487")]
	...
	/// Status of Trade Report "In 3 party listed derivatives model used to convey status of a trade to a counterparty. Used specifically
	/// in a "claim" model."
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "939")]
	pub trd_rpt_status: Option<TrdRptStatus>,
	/// Request ID if the <a href="message_Trade_Capture_Report_AE.html" target="main">Trade Capture Report&nbsp;(AE)</a> is in response to a <a href="message_Trade_Capture_Report_AE.html" target="main">Trade Capture Report&nbsp;(AE)</a> Request
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "568")]
	...
	/// Number of trade reports returned - if this report is part of a response to a <a href="message_Trade_Capture_Report_AE.html" target="main">Trade Capture Report&nbsp;(AE)</a> Request
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "748")]
	pub tot_num_trade_reports: Option<i32>,
	/// Indicates if this is the last report in the response to a <a href="message_Trade_Capture_Report_AE.html" target="main">Trade Capture Report&nbsp;(AE)</a> Request
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "912")]
	...
	/// The <a href="tag_571_TradeReportID.html" target="bottom">TradeReportID&nbsp;(571)</a> that is being referenced for some action, such as correction or cancelation
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "572")]
	...
	/// Insert here the set of "OrderQtyData" fields defined in "Common Components of Application Messages". Note: <a href="tag_38_OrderQty.html" target="bottom">OrderQty&nbsp;(38)</a> field is required unless rejecting or an order ack for a <a href="tag_152_CashOrderQty.html" target="bottom">CashOrderQty&nbsp;(152)</a> or PercentOrder.
	#[serde(flatten)]
	...
	/// The reason(s) for the price difference should be stated by using field (Tag 828 ) <a href="tag_828_TrdType.html" target="bottom">TrdType&nbsp;(828)</a> and, if required, field (Tag 829) <a href="tag_829_TrdSubType.html" target="bottom">TrdSubType&nbsp;(829)</a> as well
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1134")]
...
pub struct Leg {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "990")]
	pub leg_report_id: Option<String>,
	...
	/// Provide only if a <a href="tag_44_Price.html" target="bottom">Price&nbsp;(44)</a> is required for a specific leg. Used for anchoring the overall multileg security price to a specific leg Price.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "566")]
	...
	/// Takes precedence over LegSettlmntTyp value and conditionally required/omitted for specific <a href="tag_587_LegSettlType.html" target="bottom">LegSettlType&nbsp;(587)</a> values.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "588")]
...
pub struct NoSide {
	...
	#[serde(rename = "54")]
	pub side: Side,
	/// OrderID should be conditionally required when <a href="message_Trade_Capture_Report_AE.html" target="main">Trade Capture Report&nbsp;(AE)</a> is used for back office processing.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "37")]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1136")]
	pub alloc_clearing_fee_indicator: Option<String>,
	/// SideGrossTradeAmt
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
...
impl Default for SideTrdSubTyp {
	fn default() -> Self {
		SideTrdSubTyp::Cmta
	}
}
