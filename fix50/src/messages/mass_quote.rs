...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct QuoteSet {
	/// Sequential number for the <a href="message_Quote_S.html" target="main">Quote&nbsp;(S)</a> Set. For a given <a href="tag_117_QuoteID.html" target="bottom">QuoteID&nbsp;(117)</a> assumed to start at 1. Must be the first field in the repeating group.
	#[serde(rename = "302")]
