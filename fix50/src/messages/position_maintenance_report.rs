...
pub struct PositionMaintenanceReport {
	...
	/// See definition for Position <a href="tag_53_Quantity.html" target="bottom">Quantity&nbsp;(53)</a> in the Proposed Component Block section above
	#[serde(flatten)]
...
pub enum PosMaintAction {
	...
	#[serde(rename = "2")]
	ReplaceUsedToOverrideTheOverallTransactionQuantityOrSpecifiAddMessagesBasedOnTheReferenceId,
	...
	#[serde(rename = "4")]
	ReverseUsedToCompletellyBackOutTheTransactionSuchThatTheTransactionNeverExisted,
}

impl Default for PosMaintAction {
	fn default() -> Self {
		PosMaintAction::NewUsedToIncrementTheOverallTransactionQuantity
	}
}
