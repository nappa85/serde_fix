...
pub struct Security {
	...
	/// Identifier for <a href="message_Security_Definition_d.html" target="main">Security Definition&nbsp;(d)</a> message
	...
	/// Insert here the set of "Instrument" fields defined in "Common Components of Application Messages". of the requested Security
	#[serde(flatten)]
