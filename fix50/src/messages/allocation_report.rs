...
pub struct AllocationReport {
	...
	/// Expressed in same currency as AvgPx. Sum of (AllocQty * <a href="tag_153_AllocAvgPx.html" target="bottom">AllocAvgPx&nbsp;(153)</a> or AllocPrice).
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "381")]
	...
	/// Conditionally required except when <a href="tag_71_AllocTransType.html" target="bottom">AllocTransType&nbsp;(71)</a> = Cancel, or when <a href="tag_626_AllocType.html" target="bottom">AllocType&nbsp;(626)</a> = Ready-to-book or Warehouse instruction
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "78")]
...
pub struct Alloc {
	...
	/// Required if <a href="tag_78_NoAllocs.html" target="bottom">NoAllocs&nbsp;(78)</a> &gt; 0. Must be first field in repeating group. Conditionally required except when for AllocTransType="Cancel", or when AllocType=
	/// "Ready-To-Book" or "Warehouse instruction".
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "79")]
	...
	/// NetMoney for this AllocAccount ((AllocQty * AllocAvgPx) - <a href="tag_12_Commission.html" target="bottom">Commission&nbsp;(12)</a> - sum of <a href="tag_137_MiscFeeAmt.html" target="bottom">MiscFeeAmt&nbsp;(137)</a> + AccruedInterestAmt) if a Sell ((AllocQty * AllocAvgPx) + <a href="tag_12_Commission.html" target="bottom">Commission&nbsp;(12)</a> + sum of <a href="tag_137_MiscFeeAmt.html" target="bottom">MiscFeeAmt&nbsp;(137)</a> + AccruedInterestAmt) if a Buy
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "154")]
	...
	/// AllocNetMoney in <a href="tag_736_AllocSettlCurrency.html" target="bottom">AllocSettlCurrency&nbsp;(736)</a> for this <a href="tag_79_AllocAccount.html" target="bottom">AllocAccount&nbsp;(79)</a> if <a href="tag_736_AllocSettlCurrency.html" target="bottom">AllocSettlCurrency&nbsp;(736)</a> is different from "overall" Currency.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "737")]
	pub alloc_settl_curr_amt: Option<f64>,
	/// Replaced by AllocSettlCurrency <a href="tag_120_SettlCurrency.html" target="bottom">SettlCurrency&nbsp;(120)</a> for this <a href="tag_79_AllocAccount.html" target="bottom">AllocAccount&nbsp;(79)</a> if different from "overall" Currency. Required if <a href="tag_119_SettlCurrAmt.html" target="bottom">SettlCurrAmt&nbsp;(119)</a> is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "120")]
	pub settl_currency: Option<SettlCurrency>,
	/// AllocSettlCurrency for this <a href="tag_79_AllocAccount.html" target="bottom">AllocAccount&nbsp;(79)</a> if different from "overall" Currency. Required if <a href="tag_737_AllocSettlCurrAmt.html" target="bottom">AllocSettlCurrAmt&nbsp;(737)</a> is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "736")]
	pub alloc_settl_currency: Option<AllocSettlCurrency>,
	/// Foreign exchange rate used to compute <a href="tag_737_AllocSettlCurrAmt.html" target="bottom">AllocSettlCurrAmt&nbsp;(737)</a> from <a href="tag_15_Currency.html" target="bottom">Currency&nbsp;(15)</a> to AllocSettlCurrency.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "155")]
...
pub enum TrdSubType {
	...
	/// prices or on different terms (requires a trade report with trade type indicator R for each transaction (ii) market maker is
	/// reporting all the legs of a riskless principal transaction where the buying and selling transactions are executed at different
...
pub enum NotifyBrokerOfCredit {
	...
	#[serde(rename = "N")]
	DetailsShoultNotBeCommunicated,
...
impl Default for NotifyBrokerOfCredit {
	fn default() -> Self {
		NotifyBrokerOfCredit::DetailsShoultNotBeCommunicated
	}
}
