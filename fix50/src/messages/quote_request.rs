...
pub struct Quote {
	...
	/// Required when <a href="tag_537_QuoteType.html" target="bottom">QuoteType&nbsp;(537)</a> is Tradeable and the <a href="tag_40_OrdType.html" target="bottom">OrdType&nbsp;(40)</a> is Limit.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "11")]
...
pub struct RelatedSy {
	...
	/// Type of quote being requested from counterparty or market (e.g. Indicative, Firm, or Restricted Tradeable) Valid values used
	...
	/// is being requested. For single instrument use. FX values, 1 = Buy, 2 = Sell; This is from the perspective of the Initiator.
	/// If absent then a two-sided quote is being requested for spot or forward.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "54")]
	...
	/// Used by the quote initiator to indicate the period of time the resulting <a href="message_Quote_S.html" target="main">Quote&nbsp;(S)</a> must be valid until
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "62")]
	...
	/// Can be used with <a href="tag_40_OrdType.html" target="bottom">OrdType&nbsp;(40)</a> = "Forex - Swap" to specify the Quoted or target price for the future portion of a F/X swap.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "640")]
