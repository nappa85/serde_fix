...
pub struct QuoteResponse {
	/// MsgType = AJ
	#[serde(flatten)]
	pub standard_message_header: super::super::standard_message_header::StandardMessageHeader<'A', 'J'>,
	...
	/// Type of response this <a href="message_Quote_Response_AJ.html" target="main">Quote Response&nbsp;(AJ)</a> is.
	#[serde(rename = "694")]
	pub quote_resp_type: QuoteRespType,
	/// Unique ID as assigned by the Initiator. Required only when <a href="tag_694_QuoteRespType.html" target="bottom">QuoteRespType&nbsp;(694)</a> is 1 (Hit/Lift) or 2 (Counter quote).
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "11")]
	...
	/// (Deprecated in FIX.5.0)Default is Indicative.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "537")]
	...
	/// Insert here the set of "Instrument" fields defined in "Common Components of Application Messages". For multilegs supply minimally
	/// a value for <a href="tag_55_Symbol.html" target="bottom">Symbol&nbsp;(55)</a> .
	#[serde(flatten)]
	pub instrument: super::super::instrument::Instrument,
	/// Insert here the set of "FinancingDetails" fields defined in "Common Components of Application Messages". For multilegs supply
	/// minimally a value for <a href="tag_55_Symbol.html" target="bottom">Symbol&nbsp;(55)</a> .
	#[serde(flatten)]
	...
	/// Insert here the set of "OrderQtyData" fields defined in "Common Components of Application Messages". Required when countering
	/// a single instrument quote or "hit/lift" an IOI or Quote.
	#[serde(flatten)]
	...
	/// Used to identify the source of the <a href="tag_1_Account.html" target="bottom">Account&nbsp;(1)</a> code.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "660")]
	...
	/// The time when the quote will expire. Required for FI when the <a href="tag_694_QuoteRespType.html" target="bottom">QuoteRespType&nbsp;(694)</a> is 2 (Counter quote) to indicate to the Respondent when the counter offer is valid until.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "62")]
	...
	/// prices contained in this quote message
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "656")]
...
pub struct Leg {
	...
	/// Code to represent type of price presented in <a href="tag_681_LegBidPx.html" target="bottom">LegBidPx&nbsp;(681)</a> and LegOfferPx. Required if <a href="tag_681_LegBidPx.html" target="bottom">LegBidPx&nbsp;(681)</a> or PegOfferPx is present.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "686")]
	...
	/// Initiator can optionally provide a unique identifier for the specific leg. Required for FX Swaps
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "654")]
...
pub enum CommType {
	...
	/// Points per bond or contract (supply ContractMultiplier (231) in the &lt;Instrument&gt; component block if the object security is
	/// denominated in a size other than the industry default - 1000 par for bonds)
	#[serde(rename = "6")]
	PointsPerBondOrContractInTheLtInstrumentGtComponentBlockIfTheObjectSecurityIsDenominatedInASizeOtherThanTheIndustryDefault1000ParForBonds,
}
