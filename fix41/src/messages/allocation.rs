...
pub struct Allocation {
	...
	/// Indicates number of individual execution record groups to follow. Absence of this field indicates that no individual execution
	/// records are included. Primarily used to support step-outs.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "124")]
	...
	/// Indicates number of allocation groups to follow. Not required for <a href="tag_71_AllocTransType.html" target="bottom">AllocTransType&nbsp;(71)</a> =Cancel
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "78")]
...
pub struct Alloc {
	...
	/// AvgPx for this <a href="tag_79_AllocAccount.html" target="bottom">AllocAccount&nbsp;(79)</a> . For F/X orders, should be the "all-in" rate (spot rate adjusted for forward points) for this allocation.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "153")]
	pub alloc_avg_px: Option<f64>,
	/// NetMoney for this <a href="tag_79_AllocAccount.html" target="bottom">AllocAccount&nbsp;(79)</a> . (( <a href="tag_80_AllocShares.html" target="bottom">AllocShares&nbsp;(80)</a> * <a href="tag_153_AllocAvgPx.html" target="bottom">AllocAvgPx&nbsp;(153)</a> ) - <a href="tag_12_Commission.html" target="bottom">Commission&nbsp;(12)</a> - sum of <a href="tag_137_MiscFeeAmt.html" target="bottom">MiscFeeAmt&nbsp;(137)</a> - <a href="tag_159_AccruedInterestAmt.html" target="bottom">AccruedInterestAmt&nbsp;(159)</a> ) if a Sell. (( <a href="tag_80_AllocShares.html" target="bottom">AllocShares&nbsp;(80)</a> * <a href="tag_153_AllocAvgPx.html" target="bottom">AllocAvgPx&nbsp;(153)</a> ) + <a href="tag_12_Commission.html" target="bottom">Commission&nbsp;(12)</a> + sum of <a href="tag_137_MiscFeeAmt.html" target="bottom">MiscFeeAmt&nbsp;(137)</a> + <a href="tag_159_AccruedInterestAmt.html" target="bottom">AccruedInterestAmt&nbsp;(159)</a> ) if a Buy.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "154")]
	...
	/// SettlCurrency for this <a href="tag_79_AllocAccount.html" target="bottom">AllocAccount&nbsp;(79)</a> if different from "overall" <a href="tag_15_Currency.html" target="bottom">Currency&nbsp;(15)</a> . Required if <a href="tag_119_SettlCurrAmt.html" target="bottom">SettlCurrAmt&nbsp;(119)</a> is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "120")]
	...
	/// Type of Settlement Instructions which will be provided via <a href="message_Settlement_Instructions_T.html" target="main">Settlement Instructions&nbsp;(T)</a> message
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "160")]
	...
	/// Required if <a href="tag_136_NoMiscFees.html" target="bottom">NoMiscFees&nbsp;(136)</a> &gt; 0. (can only occur once within a MiscFee group)
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "139")]
