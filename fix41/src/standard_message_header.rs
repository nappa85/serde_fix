...
pub struct StandardMessageHeader<const T: char> {
	...
	/// Required for message resends. If data is not available set to same value as <a href="tag_52_SendingTime.html" target="bottom">SendingTime&nbsp;(52)</a> (Can be embedded within encrypted data section.)
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "122")]
