...
impl HasHeaderBoxed for Message {
    fn get_header_boxed<'a>(&'a self) -> Box<&'a dyn crate::header::Header> {
        match self {
            ...
            Message::AllocationInstruction(m) => Box::new(m.get_header()),
            ...
            Message::AllocationInstructionAck(m) => Box::new(m.get_header()),
            ...
            Message::MassQuoteAcknowledgement(m) => Box::new(m.get_header()),
            ...
            Message::QuoteResponse(m) => Box::new(m.get_header()),
            Message::Confirmation(m) => Box::new(m.get_header()),
            Message::PositionMaintenanceRequest(m) => Box::new(m.get_header()),
            Message::PositionMaintenanceReport(m) => Box::new(m.get_header()),
            Message::RequestForPositions(m) => Box::new(m.get_header()),
            Message::RequestForPositionsAck(m) => Box::new(m.get_header()),
            Message::PositionReport(m) => Box::new(m.get_header()),
            Message::TradeCaptureReportRequestAck(m) => Box::new(m.get_header()),
            Message::TradeCaptureReportAck(m) => Box::new(m.get_header()),
            Message::AllocationReport(m) => Box::new(m.get_header()),
            Message::AllocationReportAck(m) => Box::new(m.get_header()),
            Message::ConfirmationAck(m) => Box::new(m.get_header()),
            Message::SettlementInstructionRequest(m) => Box::new(m.get_header()),
            Message::AssignmentReport(m) => Box::new(m.get_header()),
            Message::CollateralRequest(m) => Box::new(m.get_header()),
            Message::CollateralAssignment(m) => Box::new(m.get_header()),
            Message::CollateralResponse(m) => Box::new(m.get_header()),
            Message::CollateralReport(m) => Box::new(m.get_header()),
            Message::CollateralInquiry(m) => Box::new(m.get_header()),
            Message::NetworkCounterpartySystemStatusRequest(m) => Box::new(m.get_header()),
            Message::NetworkCounterpartySystemStatusResponse(m) => Box::new(m.get_header()),
            Message::UserRequest(m) => Box::new(m.get_header()),
            Message::UserResponse(m) => Box::new(m.get_header()),
            Message::CollateralInquiryAck(m) => Box::new(m.get_header()),
            Message::ConfirmationRequest(m) => Box::new(m.get_header()),
        }
    }
}
