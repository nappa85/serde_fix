...
pub struct ExecutionReport {
	...
	#[serde(default)]
	#[serde(rename = "19")]
	pub exec_ref_id: Option<i32>,
	/// OrdStatus
	#[serde(rename = "39")]
	pub ord_status: OrdStatus,
	/// For optional use with <a href="tag_39_OrdStatus.html" target="bottom">OrdStatus&nbsp;(39)</a> = 8 (Rejected)
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "103")]
	...
	/// Not required for <a href="tag_20_ExecTransType.html" target="bottom">ExecTransType&nbsp;(20)</a> = 3 (Status)
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "32")]
