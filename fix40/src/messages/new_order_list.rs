...
pub struct NewOrderList {
	...
	#[serde(deserialize_with = "fix_common::workarounds::from_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(rename = "68")]
	pub list_no_ords: i32,
	/// Include only in <a href="tag_67_ListSeqNo.html" target="bottom">ListSeqNo&nbsp;(67)</a> = 1 message
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "69")]
	...
	/// Required in <a href="tag_59_TimeInForce.html" target="bottom">TimeInForce&nbsp;(59)</a> = GTD
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "126")]
