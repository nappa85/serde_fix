...
pub struct Allocation {
	...
	/// Required for <a href="tag_71_AllocTransType.html" target="bottom">AllocTransType&nbsp;(71)</a> = R (Replace) or C (Cancel)
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "72")]
	pub ref_alloc_id: Option<i32>,
	/// Indicates number of orders to be combined for allocation. If order(s) were manually
	/// delivered set to 1 (one).
	#[serde(rename = "73")]
	pub orders: fix_common::RepeatingValues<Order>,
	/// Indicates number of individual execution record groups to follow. Absence of this
	/// field indicates that no individual execution records are included.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "124")]
	...
	#[serde(rename = "6")]
	pub avg_px: f64,
	/// Currency of <a href="tag_6_AvgPx.html" target="bottom">AvgPx&nbsp;(6)</a> , absence of this field indicates US dollars
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "15")]
	...
	/// Required with <a href="tag_63_SettlmntTyp.html" target="bottom">SettlmntTyp&nbsp;(63)</a> other than regular
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "64")]
	pub fut_sett_date: Option<fix_common::UTCDateOnly>,
	/// Expressed in same currency as <a href="tag_6_AvgPx.html" target="bottom">AvgPx&nbsp;(6)</a>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "118")]
