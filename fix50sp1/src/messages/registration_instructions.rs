...
pub struct RegistrationInstructions {
	/// MsgType = o
	#[serde(flatten)]
	pub standard_message_header: super::super::standard_message_header::StandardMessageHeader<'o', ' '>,
	/// RegistID
	#[serde(rename = "513")]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "510")]
	pub distrib_insts: Option<fix_common::RepeatingValues<DistribInst>>,
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct DistribInst {
	/// Must be first field in the repeating group if <a href="tag_510_NoDistribInsts.html" target="bottom">NoDistribInsts&nbsp;(510)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "477")]
	...
	#[serde(default)]
	#[serde(rename = "512")]
	pub distrib_percentage: Option<f32>,
	/// CashDistribCurr
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "478")]
	pub cash_distrib_curr: Option<CashDistribCurr>,
	/// CashDistribAgentName
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "498")]
	pub cash_distrib_agent_name: Option<String>,
	/// CashDistribAgentCode
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "499")]
	pub cash_distrib_agent_code: Option<String>,
	/// CashDistribAgentAcctNumber
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "500")]
	pub cash_distrib_agent_acct_number: Option<String>,
	/// CashDistribPayRef
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "501")]
	pub cash_distrib_pay_ref: Option<String>,
