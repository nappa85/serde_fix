...
pub struct DerivativeSecurityList {
	...
	/// Takes precedence in identifying security to counterparty over SecurityAltID block. Requires <a href="tag_1217_DerivativeSecurityIDSource.html" target="bottom">DerivativeSecurityIDSource&nbsp;(1217)</a> if specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1216")]
	...
	/// Income. Refer to Volume 7 - Fixed Income Futures and Options should be specified using the <a href="tag_461_CFICode.html" target="bottom">CFICode&nbsp;(461)</a> field instead of DerivativeSecurityType (Refer to Volume 7 - Recommendations and Guidelines for Futures and Options Markets.)
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1249")]
	...
	/// actions to the underlying. Should not be used to indicate type of option - use the <a href="tag_461_CFICode.html" target="bottom">FICode&nbsp;(461)</a> for this purpose.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1265")]
	...
	/// Should contain unique combinations of <a href="tag_1293_DerivativeInstrumentPartyID.html" target="bottom">DerivativeInstrumentPartyID&nbsp;(1293)</a> , <a href="tag_1294_DerivativeInstrumentPartyIDSource.html" target="bottom">DerivativeInstrumentPartyIDSource&nbsp;(1294)</a> , and <a href="tag_1295_DerivativeInstrumentPartyRole.html" target="bottom">DerivativeInstrumentPartyRole&nbsp;(1295)</a>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1292")]
...
pub struct DerivativeEvent {
	...
	/// Specific time of event. To be used in combination with <a href="tag_1288_DerivativeEventDate.html" target="bottom">DerivativeEventDateEventDate&nbsp;(1288)</a>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1289")]
