...
pub struct OrderStatusRequest {
	...
	/// The ClOrdID of the order whose status is being requested. Conditionally required if the OrderID(37) is not provided. Either
	/// OrderID or ClOrdID must be provided.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "11")]
