...
pub struct SecurityDefinitionUpdateReport {
	/// MsgType = BP
	#[serde(flatten)]
	pub standard_message_header: super::super::standard_message_header::StandardMessageHeader<'B', 'P'>,
	/// ApplicationSequenceControl
	#[serde(flatten)]
	pub application_sequence_control: Option<super::super::application_sequence_control::ApplicationSequenceControl>,
	/// Identifier for the <a href="message_Security_Definition_d.html" target="main">Security Definition&nbsp;(d)</a> Update message in a bulk transfer environment (No Request/Response)
	...
	/// Response to the <a href="message_Security_Definition_d.html" target="main">Security Definition&nbsp;(d)</a> Request.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "323")]
	...
	/// Specifies New (0), Cancel (1) or Replace (2)
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "980")]
...
pub enum SecurityResponseType {
	...
	/// List of security types returned per request (deprecated in FIX 5.0 SP1)
	#[serde(rename = "3")]
