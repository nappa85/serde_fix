...
pub struct TradeCaptureReport {
	...
	/// The reason(s) for the price difference should be stated by using field <a href="tag_828_TrdType.html" target="bottom">TrdType&nbsp;(828)</a> and, if required, field <a href="tag_829_TrdSubType.html" target="bottom">TrdSubType&nbsp;(829)</a> as well
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1134")]
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct Leg {
	/// Deprecated in FIX.5.0 SP1. <a href="tag_1418_LegLastQty.html" target="bottom">LegLastQty&nbsp;(1418)</a> should be used.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "687")]
	...
	#[serde(default)]
	#[serde(rename = "1342")]
	pub no_of_leg_underlyings: Option<usize>,
	/// UnderlyingLegSymbol
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1330")]
	...
	#[serde(default)]
	#[serde(rename = "1334")]
	pub no_underlying_leg_security_alt_id: Option<usize>,
	/// UnderlyingLegSecurityAltID
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1335")]
	pub underlying_leg_security_alt_id: Option<String>,
	/// UnderlyingLegSecurityAltIDSource
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1336")]
	pub underlying_leg_security_alt_id_source: Option<UnderlyingLegSecurityAltIDSource>,
...
pub struct NoSide {
	...
	/// In the case of quotes can be mapped to: <a href="tag_1166_QuoteMsgID.html" target="bottom">QuoteMsgID&nbsp;(1166)</a> of a single Quote, <a href="tag_117_QuoteID.html" target="bottom">QuoteID&nbsp;(117)</a> of a Mass Quote
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "11")]
	...
	/// to: <a href="tag_117_QuoteID.html" target="bottom">QuoteID&nbsp;(117)</a> of a single Quote, <a href="tag_299_QuoteEntryID.html" target="bottom">QuoteEntryID&nbsp;(299)</a> of a Mass Quote
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "526")]
	...
	#[serde(default)]
	#[serde(rename = "1158")]
	pub no_settl_details: Option<usize>,
	/// SettlObligSource
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1164")]
...
pub struct TrdRepIndicator {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1388")]
	pub trd_rep_party_role: Option<TrdRepPartyRole>,
	/// TrdRepIndicator
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1389")]
...
#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum UnderlyingLegSecurityAltIDSource {
	/// CUSIP
	#[serde(rename = "1")]
	Cusip,
	/// SEDOL
...
impl Default for SideSettlCurrency {
	fn default() -> Self {
		SideSettlCurrency::Afa
	}
}
