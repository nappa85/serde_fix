...
pub struct Quote {
	...
	/// Required when responding to the <a href="message_Quote_Response_AJ.html" target="main">Quote Response&nbsp;(AJ)</a> message. The counterparty specified ID of the <a href="message_Quote_Response_AJ.html" target="main">Quote Response&nbsp;(AJ)</a> message.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "693")]
	...
	#[serde(default)]
	#[serde(rename = "1065")]
	pub bid_swap_points: Option<f64>,
	/// OfferSwapPoints
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "1066")]
	pub offer_swap_points: Option<f64>,
	/// MidPx
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
