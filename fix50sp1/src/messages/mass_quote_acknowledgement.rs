...
pub struct QuoteSet {
	...
	#[serde(default)]
	#[serde(rename = "295")]
	pub no_quote_entries: Option<usize>,
	...
	/// Required if <a href="tag_295_NoQuoteEntries.html" target="bottom">NoQuoteEntries&nbsp;(295)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "299")]
	...
	/// Reason <a href="message_Quote_S.html" target="main">Quote&nbsp;(S)</a> Entry was rejected.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "368")]
