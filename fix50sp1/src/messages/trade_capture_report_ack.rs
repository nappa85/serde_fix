...
pub struct TradeCaptureReportAck {
	...
	/// Insert here the set of "Root Parties" (firm identification) fields defined in "common components of application messages"
	...
	/// (Deprecated in FIX.5.0)The <a href="tag_818_SecondaryTradeReportID.html" target="bottom">SecondaryTradeReportID&nbsp;(818)</a> that is being referenced for some action, such as correction or cancelation
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "881")]
...
pub struct Leg {
	...
	/// in terms of number of contracts - <a href="tag_614_LegContractMultiplier.html" target="bottom">LegContractMultiplier&nbsp;(614)</a> is required in this case.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "1075")]
