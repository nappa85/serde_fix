...
pub struct AllocationInstructionAck {
	...
	/// Denotes whether the financial details provided on the <a href="message_Allocation_Instruction_J.html" target="main">Allocation Instruction&nbsp;(J)</a> were successfully matched.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "573")]
