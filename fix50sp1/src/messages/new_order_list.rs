...
pub struct NewOrderList {
	...
	/// The currency that AllowableOneSidedness is expressed in if <a href="tag_766_AllowableOneSidednessValue.html" target="bottom">AllowableOneSidednessValue&nbsp;(766)</a> is used.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "767")]
...
pub struct Order {
	...
	/// Note: to indicate the side of <a href="tag_396_SideValue1.html" target="bottom">SideValue1&nbsp;(396)</a> or SideValue2, specify Side=Undisclosed and SideValueInd=either the <a href="tag_396_SideValue1.html" target="bottom">SideValue1&nbsp;(396)</a> or <a href="tag_397_SideValue2.html" target="bottom">SideValue2&nbsp;(397)</a> indicator.
	#[serde(rename = "54")]
	pub side: Side,
	...
	#[serde(default)]
	#[serde(rename = "957")]
	pub no_strategy_parameters: Option<usize>,
	/// Name of parameter
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "958")]
	...
	/// (Deprecated in FIX 5.0). Mandatory for a TargetStrategy = Participate order and specifies the target particpation rate. For
	/// other order types optionally specifies a volume limit (i.e. do not be more than this percent of the market volume)
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "849")]
...
pub enum ProgRptReqs {
	...
	#[serde(rename = "1")]
	BuySideExplicitlyRequestsStatusUsingStatueRequestTheSellSideFirmCanHoweverSendADoneStatusListSTatusResponseInAnUnsolicitedFashion,
