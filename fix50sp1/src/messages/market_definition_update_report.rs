...
pub struct Market {
	...
	/// Unique identifier for each Market Definition Update message
	#[serde(rename = "1394")]
	...
	#[serde(rename = "1397")]
	/// Encoded (non-ASCII characters) representation of the MarketSegmDesc field in the encoded format specified via the MessageEncoding
	/// field.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(alias = "1398")]
...
pub struct LotTypeRule {
	/// Defines the lot type assigned to the order. Use as an alternate to RoundLot(561). To be used with MinLotSize(1231). LotType
	/// + MinLotSize ( max is next level minus 1)
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1093")]
