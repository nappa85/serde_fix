...
pub struct PositionMaintenanceRequest {
	...
	/// Unique identifier for the position maintenance request as assigned by the submitter. Conditionally required when used in a
	/// request/reply scenario (i.e. not required in batch scenario)
	...
	/// Reference to a <a href="tag_721_PosMaintRptID.html" target="bottom">PosMaintRptID&nbsp;(721)</a> from a previous <a href="message_Position_Maintenance_Report_AM.html" target="main">Position Maintenance Report&nbsp;(AM)</a> that is being replaced or canceled.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "714")]
	...
	/// Type of adjustment to be applied, used for PCS &amp; PAJ Delta_plus, Delta_minus, Final, If <a href="tag_334_Adjustment.html" target="bottom">Adjustment&nbsp;(334)</a> Type is null, the request will be processed as Margin Disposition
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "718")]
