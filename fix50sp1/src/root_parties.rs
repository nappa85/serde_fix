...
pub struct RootParties {
	/// Repeating group below should contain unique combinations of RootPartyID, RootPartyIDSource, and RootPartyRole
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1116")]
	pub root_party_i_ds: Option<fix_common::RepeatingValues<RootPartyID>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct RootPartyID {
	/// Used to identify source of RootPartyID. Required if <a href="tag_1118_RootPartyIDSource.html" target="bottom">RootPartyIDSource&nbsp;(1118)</a> is specified. Required if <a href="tag_1116_NoRootPartyIDs.html" target="bottom">NoRootPartyIDs&nbsp;(1116)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1117")]
	pub root_party_id: Option<String>,
	/// Used to identify class source of <a href="tag_1117_RootPartyID.html" target="bottom">RootPartyID&nbsp;(1117)</a> value (e.g. BIC). Required if <a href="tag_1117_RootPartyID.html" target="bottom">RootPartyID&nbsp;(1117)</a> is specified. Required if <a href="tag_1116_NoRootPartyIDs.html" target="bottom">NoRootPartyIDs&nbsp;(1116)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1118")]
	pub root_party_id_source: Option<RootPartyIDSource>,
	/// Identifies the type of <a href="tag_1117_RootPartyID.html" target="bottom">RootPartyID&nbsp;(1117)</a> (e.g. Executing Broker). Required if <a href="tag_1116_NoRootPartyIDs.html" target="bottom">NoRootPartyIDs&nbsp;(1116)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1119")]
	pub root_party_role: Option<RootPartyRole>,
	/// Repeating group of RootParty sub-identifiers.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "1120")]
	pub no_root_party_sub_i_ds: Option<usize>,
	/// Sub-identifier (e.g. Clearing Acct for PartyID=Clearing Firm) if applicable. Required if <a href="tag_1120_NoRootPartySubIDs.html" target="bottom">NoRootPartySubIDs&nbsp;(1120)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1121")]
	pub root_party_sub_id: Option<String>,
	/// Type of Sub-identifier. Required if <a href="tag_1120_NoRootPartySubIDs.html" target="bottom">NoRootPartySubIDs&nbsp;(1120)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1122")]
...
impl Default for RootPartyIDSource {
	fn default() -> Self {
		RootPartyIDSource::BicCode
	}
}

#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum RootPartyRole {
...
impl Default for RootPartyRole {
	fn default() -> Self {
		RootPartyRole::ExecutingFirm
	}
}
