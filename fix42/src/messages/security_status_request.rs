...
pub struct SecurityStatusRequest {
	...
	/// Must be unique, or the ID of previous <a href="message_Security_Status_Request_e.html" target="main">Security Status Request&nbsp;(e)</a> to disable if <a href="tag_2_AdvId.html" target="bottom">&nbsp;(2)</a> = Disable previous Snapshot + Updates Request (2).
	#[serde(rename = "324")]
