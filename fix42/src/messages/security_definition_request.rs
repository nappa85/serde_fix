...
pub struct RelatedSy {
	/// The <a href="tag_311_UnderlyingSymbol.html" target="bottom">UnderlyingSymbol&nbsp;(311)</a> must be specified as the first field in the repeating group. Required if <a href="tag_146_NoRelatedSym.html" target="bottom">NoRelatedSym&nbsp;(146)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "311")]
	...
	/// Specifies the month and year of maturity. Required if <a href="tag_314_UnderlyingMaturityDay.html" target="bottom">UnderlyingMaturityDay&nbsp;(314)</a> is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "313")]
