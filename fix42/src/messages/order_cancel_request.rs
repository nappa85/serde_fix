...
pub struct OrderCancelRequest {
	...
	/// Unique ID of <a href="message_Order_Cancel_Request_F.html" target="main">cancel request&nbsp;(F)</a> as assigned by the institution.
	#[serde(rename = "11")]
	...
	/// Either <a href="tag_152_CashOrderQty.html" target="bottom">CashOrderQty&nbsp;(152)</a> or <a href="tag_38_OrderQty.html" target="bottom">OrderQty&nbsp;(38)</a> is required. <a href="tag_38_OrderQty.html" target="bottom">OrderQty&nbsp;(38)</a> = <a href="tag_14_CumQty.html" target="bottom">CumQty&nbsp;(14)</a> + <a href="tag_151_LeavesQty.html" target="bottom">LeavesQty&nbsp;(151)</a> (see exceptions above)
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "38")]
	pub order_qty: Option<f64>,
	/// Either <a href="tag_152_CashOrderQty.html" target="bottom">CashOrderQty&nbsp;(152)</a> or <a href="tag_38_OrderQty.html" target="bottom">OrderQty&nbsp;(38)</a> is required. Specifies the approximate "monetary quantity" for the order. Broker is responsible for converting and calculating <a href="tag_38_OrderQty.html" target="bottom">OrderQty&nbsp;(38)</a> in shares for subsequent messages.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "152")]
