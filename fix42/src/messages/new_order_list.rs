...
pub struct NewOrderList {
	...
	#[serde(default)]
	#[serde(rename = "352")]
	pub encoded_list_exec_inst_len: Option<i32>,
...
pub struct Order {
	...
	#[serde(default)]
	#[serde(rename = "386")]
	pub no_trading_sessions: Option<i32>,
	...
	/// Either <a href="tag_152_CashOrderQty.html" target="bottom">CashOrderQty&nbsp;(152)</a> or <a href="tag_38_OrderQty.html" target="bottom">OrderQty&nbsp;(38)</a> is required. Note that either, but not both, CashOrderQty or OrderQty should be specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "38")]
	pub order_qty: Option<f64>,
	/// Either <a href="tag_152_CashOrderQty.html" target="bottom">CashOrderQty&nbsp;(152)</a> or <a href="tag_38_OrderQty.html" target="bottom">OrderQty&nbsp;(38)</a> is required. Note that either, but not both, <a href="tag_152_CashOrderQty.html" target="bottom">CashOrderQty&nbsp;(152)</a> or <a href="tag_38_OrderQty.html" target="bottom">OrderQty&nbsp;(38)</a> should be specified. Specifies the approximate "monetary quantity" for the order. Broker is responsible for converting and
	/// calculating <a href="tag_38_OrderQty.html" target="bottom">OrderQty&nbsp;(38)</a> in shares for subsequent messages.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "152")]
