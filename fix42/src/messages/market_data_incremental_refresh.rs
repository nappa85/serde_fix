...
pub struct MDEntrie {
	...
	/// Either <a href="tag_55_Symbol.html" target="bottom">Symbol&nbsp;(55)</a> or <a href="tag_280_MDEntryRefID.html" target="bottom">MDEntryRefID&nbsp;(280)</a> must be specified if <a href="tag_279_MDUpdateAction.html" target="bottom">MDUpdateAction&nbsp;(279)</a> = New(0) for the first Market Data Entry in a message. For subsequent Market Data Entries where <a href="tag_279_MDUpdateAction.html" target="bottom">MDUpdateAction&nbsp;(279)</a> = New(0), the default is the instrument used in the previous Market Data Entry if neither <a href="tag_55_Symbol.html" target="bottom">Symbol&nbsp;(55)</a> nor <a href="tag_280_MDEntryRefID.html" target="bottom">MDEntryRefID&nbsp;(280)</a> are specified, or in the case of options and futures, the previous instrument with changes specified in <a href="tag_200_MaturityMonthYear.html" target="bottom">MaturityMonthYear&nbsp;(200)</a> , <a href="tag_205_MaturityDay.html" target="bottom">MaturityDay&nbsp;(205)</a> , <a href="tag_201_PutOrCall.html" target="bottom">PutOrCall&nbsp;(201)</a> , <a href="tag_202_StrikePrice.html" target="bottom">StrikePrice&nbsp;(202)</a> , <a href="tag_206_OptAttribute.html" target="bottom">OptAttribute&nbsp;(206)</a> , and <a href="tag_207_SecurityExchange.html" target="bottom">SecurityExchange&nbsp;(207)</a> . May not be changed.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "55")]
	...
	/// Specifies the month and year of maturity. Required if <a href="tag_205_MaturityDay.html" target="bottom">MaturityDay&nbsp;(205)</a> is specified. May not be changed.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "200")]
	pub maturity_month_year: Option<fix_common::MonthYear>,
	/// Can be used in conjunction with <a href="tag_200_MaturityMonthYear.html" target="bottom">MaturityMonthYear&nbsp;(200)</a> to specify a particular maturity date. May not be changed.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "205")]
	...
	/// Conditionally required when <a href="tag_279_MDUpdateAction.html" target="bottom">MDUpdateAction&nbsp;(279)</a> = New(0).
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "270")]
	...
	/// Conditionally required when <a href="tag_279_MDUpdateAction.html" target="bottom">MDUpdateAction&nbsp;(279)</a> = New(0) and <a href="tag_269_MDEntryType.html" target="bottom">MDEntryType&nbsp;(269)</a> = Bid(0), Offer(1), or Trade(2).
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "271")]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "286")]
	pub open_close_settle_flag: Option<OpenCloseSettleFlag>,
