...
pub struct BidComponent {
	/// First element of price. Required if <a href="tag_420_NoBidComponents.html" target="bottom">NoBidComponents&nbsp;(420)</a> &gt; 0.
	...
	/// When used in response to a "Disclosed" request indicates whether <a href="tag_396_SideValue1.html" target="bottom">SideValue1&nbsp;(396)</a> is Buy or Sell. <a href="tag_397_SideValue2.html" target="bottom">SideValue2&nbsp;(397)</a> can be derived by inference.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "54")]
