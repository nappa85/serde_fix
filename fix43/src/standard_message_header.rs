...
pub struct StandardMessageHeader<const T1: char, const T2: char> {
	...
	#[serde(rename = "8")]
	#[serde(default)]
	pub begin_string: fix_common::FixVersion<3>,
	...
	#[serde(rename = "212")]
	/// Can contain a XML formatted message block (e.g. FIXML). Always immediately follows <a href="tag_212_XmlDataLen.html" target="bottom">XmlDataLen&nbsp;(212)</a> field. (Can be embedded within encrypted data section.)
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(alias = "213")]
	...
	/// The last <a href="tag_34_MsgSeqNum.html" target="bottom">MsgSeqNum&nbsp;(34)</a> value received by the FIX engine and processed by downstream application, such as trading system or order routing system.
	...
	/// (deprecated) Used when a message is sent via a "hub" or "service bureau". If A sends to Q (the hub) who then sends to B via
	/// a separate FIX session, then when Q sends to B the value of this field should represent the <a href="tag_52_SendingTime.html" target="bottom">SendingTime&nbsp;(52)</a> on the message A sent to Q. (always expressed in UTC (Universal Time Coordinated, also known as "GMT")
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "370")]
