...
pub struct TradeCaptureReport {
	...
	/// Type of <a href="message_Execution_Report_8.html" target="main">Execution&nbsp;(8)</a> being reported: Uses subset of <a href="tag_150_ExecType.html" target="bottom">ExecType&nbsp;(150)</a> for Trade Capture Reports
	#[serde(rename = "150")]
	...
	/// <a href="tag_38_OrderQty.html" target="bottom">OrderQty&nbsp;(38)</a> field is required unless rejecting or an order ack for a <a href="tag_152_CashOrderQty.html" target="bottom">CashOrderQty&nbsp;(152)</a> or <a href="tag_516_OrderPercent.html" target="bottom">OrderPercent&nbsp;(516)</a> .
	#[serde(flatten)]
	pub order_qty_data: super::super::order_qty_data::OrderQtyData,
	/// Quantity (e.g. shares) bought/sold on this (last) fill. Not required if <a href="tag_150_ExecType.html" target="bottom">ExecType&nbsp;(150)</a> = Order Status. When required, should be "0" for non-fills ("fill" defined as <a href="tag_150_ExecType.html" target="bottom">ExecType&nbsp;(150)</a> =Trade) unless noted below. If <a href="tag_150_ExecType.html" target="bottom">ExecType&nbsp;(150)</a> =Stopped, represents the quantity stopped/guaranteed/protected for.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "32")]
	pub last_qty: Option<f64>,
	/// Price of this (last) fill. Not required for <a href="tag_150_ExecType.html" target="bottom">ExecType&nbsp;(150)</a> = Order Status. Should represent the "all-in" ( <a href="tag_194_LastSpotRate.html" target="bottom">LastSpotRate&nbsp;(194)</a> + <a href="tag_195_LastForwardPoints.html" target="bottom">LastForwardPoints&nbsp;(195)</a> ) rate for F/X orders. ). When required, should be "0" for non-fills ("fill" defined as <a href="tag_150_ExecType.html" target="bottom">ExecType&nbsp;(150)</a> =Trade New) unless noted below. If <a href="tag_150_ExecType.html" target="bottom">ExecType&nbsp;(150)</a> =Stopped, represents the price stopped/guaranteed/protected at.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "31")]
...
pub struct NoSide {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "230")]
	pub ex_date: Option<fix_common::UTCDateOnly>,
	/// AccruedInterestRate
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
...
pub enum MatchType {
	...
	/// Summarized Match using A1 to A5 exact match criteria except quantity is summarized
	#[serde(rename = "S1_S5")]
	SummarizedMatchUsingA1ToA5ExactMatchCriteriaExceptQuantityIsSummarized,
