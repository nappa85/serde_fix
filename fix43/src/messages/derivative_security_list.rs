...
pub struct DerivativeSecurityList {
	...
	/// Identifier for the <a href="message_Derivative_Security_List_AA.html" target="main">Derivative Security List&nbsp;(AA)</a> message
	#[serde(rename = "322")]
	pub security_response_id: String,
	/// Result of the Security Request identified by <a href="tag_320_SecurityReqID.html" target="bottom">SecurityReqID&nbsp;(320)</a>
	#[serde(rename = "560")]
	...
	/// Used to indicate if the total number of securities being returned for this request. Used in the event that message fragmentation
	/// is required.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "393")]
	pub total_num_securities: Option<i32>,
