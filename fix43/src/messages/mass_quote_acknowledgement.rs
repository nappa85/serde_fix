...
pub struct MassQuoteAcknowledgement {
	...
	/// Status of the <a href="message_Mass_Quote_Acknowledgement_b.html" target="main">mass quote acknowledgement&nbsp;(b)</a> .
	#[serde(rename = "297")]
	...
	/// Level of Response requested from receiver of <a href="message_Quote_S.html" target="main">quote&nbsp;(S)</a> messages. Is echoed back to the counterparty.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "301")]
