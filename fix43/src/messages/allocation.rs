...
pub struct Allocation {
	...
	/// Specifies the purpose or type of <a href="message_Allocation_J.html" target="main">Allocation&nbsp;(J)</a> message
	#[serde(rename = "626")]
	pub alloc_type: AllocType,
	/// Required for <a href="tag_71_AllocTransType.html" target="bottom">AllocTransType&nbsp;(71)</a> = Replace or Cancel. Required for <a href="tag_626_AllocType.html" target="bottom">AllocType&nbsp;(626)</a> = "Sellside Calculated Using Preliminary"
	...
	/// Can be used with <a href="tag_626_AllocType.html" target="bottom">AllocType&nbsp;(626)</a> ="Buyside Ready-To-Book - Single Order" or "Buyside Ready-To-Book - Combined Set of Orders"
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "466")]
	pub booking_ref_id: Option<String>,
	/// Indicates number of orders to be combined for allocation. If order(s) were manually delivered set to 1 (one). Not required
	/// for <a href="tag_71_AllocTransType.html" target="bottom">AllocTransType&nbsp;(71)</a> =Cancel
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "73")]
	...
	#[serde(default)]
	#[serde(rename = "74")]
	pub avg_prx_precision: Option<i32>,
	/// Parties
	#[serde(flatten)]
	...
	/// Sum of <a href="tag_159_AccruedInterestAmt.html" target="bottom">AccruedInterestAmt&nbsp;(159)</a> within repeating group.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "540")]
	...
	/// Indicates number of allocation groups to follow. Not required for <a href="tag_71_AllocTransType.html" target="bottom">AllocTransType&nbsp;(71)</a> =Cancel. Not required for <a href="tag_626_AllocType.html" target="bottom">AllocType&nbsp;(626)</a> ="Buyside Ready-To-Book - Single Order" or "Buyside Ready-To-Book - Combined Set of Orders".
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "78")]
...
pub struct Exec {
	...
	/// Can be specified by broker for <a href="tag_626_AllocType.html" target="bottom">AllocType&nbsp;(626)</a> ="Sellside Calculated Without Preliminary" and "Sellside Calculated Using Preliminary"
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "29")]
...
pub struct Alloc {
	...
	/// Not required for <a href="tag_71_AllocTransType.html" target="bottom">AllocTransType&nbsp;(71)</a> =Cancel. Not required for <a href="tag_626_AllocType.html" target="bottom">AllocType&nbsp;(626)</a> ="Buyside Ready-To-Book - Single Order" or "Buyside Ready-To-Book - Combined Set of Orders".
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "80")]
	...
	/// <a href="tag_6_AvgPx.html" target="bottom">AvgPx&nbsp;(6)</a> for this <a href="tag_79_AllocAccount.html" target="bottom">AllocAccount&nbsp;(79)</a> . For F/X orders, should be the "all-in" rate (spot rate adjusted for forward points) for this allocation.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "153")]
	...
	/// <a href="tag_154_AllocNetMoney.html" target="bottom">AllocNetMoney&nbsp;(154)</a> in <a href="tag_120_SettlCurrency.html" target="bottom">SettlCurrency&nbsp;(120)</a> for this <a href="tag_79_AllocAccount.html" target="bottom">AllocAccount&nbsp;(79)</a> if <a href="tag_120_SettlCurrency.html" target="bottom">SettlCurrency&nbsp;(120)</a> is different from "overall" <a href="tag_15_Currency.html" target="bottom">Currency&nbsp;(15)</a>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "119")]
	pub settl_curr_amt: Option<f64>,
	/// <a href="tag_120_SettlCurrency.html" target="bottom">SettlCurrency&nbsp;(120)</a> for this <a href="tag_79_AllocAccount.html" target="bottom">AllocAccount&nbsp;(79)</a> if different from "overall" <a href="tag_15_Currency.html" target="bottom">Currency&nbsp;(15)</a> . Required if <a href="tag_119_SettlCurrAmt.html" target="bottom">SettlCurrAmt&nbsp;(119)</a> is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "120")]
	...
	/// Type of Settlement Instructions which will be provided via <a href="message_Settlement_Instructions_T.html" target="main">Settlement Instructions&nbsp;(T)</a> message (0=Default, 1=Standing Instructions, 2=Specific Allocation Account Overriding, 3=Specific Allocation Account Standing)
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "160")]
	...
	/// group.** Nested Repeating Group follows **
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "136")]
