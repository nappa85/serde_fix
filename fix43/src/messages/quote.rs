...
pub struct Quote {
	...
	/// bid prices contained in this <a href="message_Quote_S.html" target="main">quote&nbsp;(S)</a> message
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "656")]
	...
	/// Can be used when the quote is provided in a currency other than the instrument's "normal" trading currency. Applies to all
	/// offer prices contained in this <a href="message_Quote_S.html" target="main">quote&nbsp;(S)</a> message
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "657")]
