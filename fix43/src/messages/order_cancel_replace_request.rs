...
pub struct OrderCancelReplaceRequest {
	...
	/// <a href="tag_60_TransactTime.html" target="bottom">TransactTime&nbsp;(60)</a> of the last state change that occurred to the original order
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "586")]
	...
	/// (deprecated) Must match original order
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "47")]
	...
	/// Can be used with <a href="tag_40_OrdType.html" target="bottom">OrdType&nbsp;(40)</a> = "Forex - Swap" to specify the price for the future portion of a F/X swap.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "640")]
