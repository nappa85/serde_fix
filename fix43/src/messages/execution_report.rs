...
pub struct ExecutionReport {
	...
	/// Note: <a href="tag_38_OrderQty.html" target="bottom">OrderQty&nbsp;(38)</a> field is required unless rejecting or an order ack for a <a href="tag_152_CashOrderQty.html" target="bottom">CashOrderQty&nbsp;(152)</a> or <a href="tag_516_OrderPercent.html" target="bottom">OrderPercent&nbsp;(516)</a> .
	#[serde(flatten)]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "259")]
	pub basis_feature_date: Option<fix_common::UTCDateOnly>,
	/// BasisFeaturePrice
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
...
pub struct Leg {
	...
	/// Provide only if a <a href="tag_44_Price.html" target="bottom">Price&nbsp;(44)</a> is required for a specific leg. Used for anchoring the overall multileg security price to a specific leg <a href="tag_44_Price.html" target="bottom">Price&nbsp;(44)</a> .
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "566")]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "587")]
	pub leg_settlmnt_typ: Option<LegSettlmntTyp>,
	/// Takes precedence over <a href="tag_587_LegSettlmntTyp.html" target="bottom">LegSettlmntTyp&nbsp;(587)</a> value and conditionally required/omitted for specific <a href="tag_587_LegSettlmntTyp.html" target="bottom">LegSettlmntTyp&nbsp;(587)</a> values.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "588")]
	pub leg_fut_sett_date: Option<fix_common::LocalMktDate>,
...
impl Default for LegSettlmntTyp {
	fn default() -> Self {
		LegSettlmntTyp::Regular
	}
}
