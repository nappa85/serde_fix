...
pub struct CrossOrderCancelRequest {
	...
	/// <a href="tag_548_CrossID.html" target="bottom">CrossID&nbsp;(548)</a> for the replacement order
	#[serde(rename = "548")]
	pub cross_id: String,
	/// Must match the <a href="tag_548_CrossID.html" target="bottom">CrossID&nbsp;(548)</a> of previous cross order. Same order chaining mechanism as <a href="tag_11_ClOrdID.html" target="bottom">ClOrdID&nbsp;(11)</a> / <a href="tag_41_OrigClOrdID.html" target="bottom">OrigClOrdID&nbsp;(41)</a> with single <a href="message_Order_Cancel_Replace_Request_G.html" target="main">order Cancel/Replace&nbsp;(G)</a> .
	#[serde(rename = "551")]
