...
pub struct MultilegOrderCancelReplaceRequest {
	/// MsgType = AC
	#[serde(flatten)]
	pub standard_message_header: super::super::standard_message_header::StandardMessageHeader<'A', 'C'>,
	...
	/// investor. Note that this identifier will be used in <a href="tag_11_ClOrdID.html" target="bottom">ClOrdID&nbsp;(11)</a> field of the <a href="message_Order_Cancel_Reject_9.html" target="main">Cancel Reject&nbsp;(9)</a> message if the replacement request is rejected.
	#[serde(rename = "11")]
...
pub struct Leg {
	...
	/// Provide if the <a href="tag_203_CoveredOrUncovered.html" target="bottom">CoveredOrUncovered&nbsp;(203)</a> for the leg is different from that specified forthe overall multileg security.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "565")]
	...
	/// Refer to values for <a href="tag_63_SettlmntTyp.html" target="bottom">SettlmntTyp&nbsp;(63)</a>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "587")]
	pub leg_settlmnt_typ: Option<LegSettlmntTyp>,
	/// Refer to values for <a href="tag_64_FutSettDate.html" target="bottom">FutSettDate&nbsp;(64)</a>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "588")]
