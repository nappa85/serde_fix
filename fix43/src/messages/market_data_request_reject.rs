...
pub enum MDReqRejReason {
	...
	/// Unsupported <a href="tag_286_OpenCloseSettleFlag.html" target="bottom">OpenCloseSettleFlag&nbsp;(286)</a>
	#[serde(rename = "B")]
	UnsupportedAHrefTag286OpenCloseSettleFlagHtmlTargetBottomOpenCloseSettleFlagNbspA,
