...
pub struct MDEntrie {
	...
	/// Conditionally required when <a href="tag_279_MDUpdateAction.html" target="bottom">MDUpdateAction&nbsp;(279)</a> = New(0) and <a href="tag_269_MDEntryType.html" target="bottom">MDEntryType&nbsp;(269)</a> is not Imbalance(A).
	#[serde(skip_serializing_if = "Option::is_none")]
	...
	/// Market posting quote / trade. Valid values: <a xmlns="http://www.b2bits.com/FIXProtocol" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" href="../appendices/appendix_6-c.html" target="_blank">See Appendix C</a>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "275")]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "449")]
	pub total_volume_traded_date: Option<fix_common::UTCDateOnly>,
	/// TotalVolumeTradedTime
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "450")]
	pub total_volume_traded_time: Option<fix_common::UTCTimeOnly>,
	/// NetChgPrevDay
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
