...
pub struct UnderlyingPaymentStreamPaymentDateGrp {
	...
	#[serde(rename = "41937")]
	pub underlying_payment_stream_payment_dates: Option<crate::entities::RepeatingValues<UnderlyingPaymentStreamPaymentDate>>,
}
...
pub struct UnderlyingPaymentStreamPaymentDate {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41938")]
	pub underlying_payment_stream_payment_date: Option<crate::entities::LocalMktDate>,
