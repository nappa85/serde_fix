...
pub struct LegDividendAccrualPaymentDate {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42334")]
	pub leg_dividend_accrual_payment_date_unadjusted: Option<crate::entities::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42336")]
	pub leg_dividend_accrual_payment_date_adjusted: Option<crate::entities::LocalMktDate>,
}
