...
pub struct LegProtectionTermGrp {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41620")]
	pub leg_protection_term_seller_notifies: Option<crate::entities::Boolean>,
	/// LegProtectionTermBuyerNotifies
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41621")]
	pub leg_protection_term_buyer_notifies: Option<crate::entities::Boolean>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41623")]
	pub leg_protection_term_standard_sources: Option<crate::entities::Boolean>,
