...
pub struct UnderlyingInstrument {
	...
	/// UndSecAltIDGrp
	#[serde(flatten)]
	pub und_sec_alt_id_grp: Option<super::und_sec_alt_id_grp::UndSecAltIDGrp>,
	/// UnderlyingProduct
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "462")]
	...
	/// <p>CFTC: The futures contract expiration date or the price exposure month resulting from a futures swap. For the EndOfDay Settlement
	/// Prices report show the contract expiration month or date. Both YYYYMM and YYYYMMDD are supported.
	/// </p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "313")]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1453")]
	pub underlying_restructuring_type: Option<UnderlyingRestructuringType>,
	/// UnderlyingSeniority
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1454")]
	pub underlying_seniority: Option<UnderlyingSeniority>,
	/// UnderlyingNotionalPercentageOutstanding
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "1455")]
	pub underlying_notional_percentage_outstanding: Option<f32>,
	/// UnderlyingOriginalNotionalPercentageOutstanding
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "1456")]
	pub underlying_original_notional_percentage_outstanding: Option<f32>,
	/// UnderlyingAttachmentPoint
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "1459")]
	pub underlying_attachment_point: Option<f32>,
	/// UnderlyingDetachmentPoint
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "1460")]
	pub underlying_detachment_point: Option<f32>,
	/// UnderlyingIssueDate
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "242")]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1437")]
	pub underlying_contract_multiplier_unit: Option<UnderlyingContractMultiplierUnit>,
	/// UnderlyingFlowScheduleType
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1441")]
	pub underlying_flow_schedule_type: Option<UnderlyingFlowScheduleType>,
	...
	#[serde(rename = "362")]
	/// Encoded (non-ASCII characters) representation of the UnderlyingIssuer(363) field in the encoded format specified via the MessageEncoding(347)
	/// field.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(alias = "363")]
	...
	#[serde(default)]
	#[serde(rename = "877")]
	pub underlying_cp_program: Option<i32>,
	/// UnderlyingCPRegType
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "878")]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1526")]
	pub underlying_price_quote_currency: Option<UnderlyingPriceQuoteCurrency>,
	/// UnderlyingUnitOfMeasureCurrency
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1718")]
	pub underlying_unit_of_measure_currency: Option<UnderlyingUnitOfMeasureCurrency>,
	/// UnderlyingPriceUnitOfMeasureCurrency
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1719")]
	pub underlying_price_unit_of_measure_currency: Option<UnderlyingPriceUnitOfMeasureCurrency>,
	/// <p>CFTC: The calendar month exposure resulting from 1) a situation where a paired swap does not reference a DCM contract and
	/// the delivery of the instruments comprising the cash market index used for pricing does not coincide with any delivery window
	/// of a relevant DCM contract; or, 2) any exposure reported as part of a paired swap but which is not in any of the commodities
	/// (or substantially the same commodities) underlying the listed DCM contract. The price reference month should, by definition,
	/// only be reported when there is not an applicable futures equivalent month for the position being reported.
	/// </p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1837")]
	pub underlying_contract_price_ref_month: Option<fix_common::MonthYear>,
	/// Embedded XML document describing the underlying instrument.
	#[serde(flatten)]
	pub underlying_security_xml: Option<super::underlying_security_xml::UnderlyingSecurityXML>,
	/// UnderlyingConstituentWeight
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "1988")]
	pub underlying_constituent_weight: Option<f64>,
	/// UnderlyingCouponType
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1989")]
	pub underlying_coupon_type: Option<UnderlyingCouponType>,
	/// UnderlyingTotalIssuedAmount
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "1990")]
	pub underlying_total_issued_amount: Option<f64>,
	/// Conditionally required when UnderlyingCouponFrequencyUnit(1992) is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "1991")]
	pub underlying_coupon_frequency_period: Option<i32>,
	/// Conditionally required when UnderlyingCouponFrequencyPeriod(1991) is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1992")]
	pub underlying_coupon_frequency_unit: Option<UnderlyingCouponFrequencyUnit>,
	/// UnderlyingCouponDayCount
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1993")]
	pub underlying_coupon_day_count: Option<UnderlyingCouponDayCount>,
	/// UnderlyingObligationID
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1994")]
	pub underlying_obligation_id: Option<String>,
	/// Conditionally required when UnderlyingObligationID(1994) is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1995")]
	pub underlying_obligation_id_source: Option<UnderlyingObligationIDSource>,
	/// UnderlyingEquityID
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1996")]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1997")]
	pub underlying_equity_id_source: Option<UnderlyingEquityIDSource>,
	/// UnderlyingEvntGrp
	#[serde(flatten)]
	pub underlying_evnt_grp: Option<super::underlying_evnt_grp::UnderlyingEvntGrp>,
	/// UnderlyingLienSeniority
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1998")]
	pub underlying_lien_seniority: Option<UnderlyingLienSeniority>,
	/// UnderlyingLoanFacility
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1999")]
	pub underlying_loan_facility: Option<UnderlyingLoanFacility>,
	/// UnderlyingReferenceEntityType
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2000")]
	pub underlying_reference_entity_type: Option<UnderlyingReferenceEntityType>,
	/// UnderlyingIndexSeries
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2003")]
	pub underlying_index_series: Option<i32>,
	/// UnderlyingIndexAnnexVersion
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2004")]
	pub underlying_index_annex_version: Option<i32>,
	/// UnderlyingIndexAnnexDate
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2005")]
	pub underlying_index_annex_date: Option<fix_common::LocalMktDate>,
	/// UnderlyingIndexAnnexSource
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2006")]
	pub underlying_index_annex_source: Option<String>,
	/// UnderlyingProductComplex
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2007")]
	pub underlying_product_complex: Option<String>,
	/// UnderlyingSecurityGroup
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2008")]
	pub underlying_security_group: Option<String>,
	/// UnderlyingSettleOnOpenFlag
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2009")]
	pub underlying_settle_on_open_flag: Option<String>,
	/// UnderlyingAssignmentMethod
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2010")]
	pub underlying_assignment_method: Option<UnderlyingAssignmentMethod>,
	/// UnderlyingSecurityStatus
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2011")]
	pub underlying_security_status: Option<UnderlyingSecurityStatus>,
	/// UnderlyingObligationType
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2012")]
	pub underlying_obligation_type: Option<UnderlyingObligationType>,
	/// Required if UnderlyingAssetSubClass(2014) is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2013")]
	pub underlying_asset_class: Option<UnderlyingAssetClass>,
	/// Required if UnderlyingAssetType(2015) is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2014")]
	pub underlying_asset_sub_class: Option<UnderlyingAssetSubClass>,
	/// Required if UnderlyingAssetSubType(2744) is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2015")]
	pub underlying_asset_type: Option<String>,
	/// UnderlyingSecondaryAssetGrp
	#[serde(flatten)]
	pub underlying_secondary_asset_grp: Option<super::underlying_secondary_asset_grp::UnderlyingSecondaryAssetGrp>,
	/// UnderlyingSwapClass
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2016")]
	pub underlying_swap_class: Option<UnderlyingSwapClass>,
	/// Conditionally required when UnderlyingMthToDefault(2018) is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2017")]
	pub underlying_nth_to_default: Option<i32>,
	/// UnderlyingMthToDefault
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2018")]
	pub underlying_mth_to_default: Option<i32>,
	/// UnderlyingSettledEntityMatrixSource
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2019")]
	pub underlying_settled_entity_matrix_source: Option<String>,
	/// UnderlyingSettledEntityMatrixPublicationDate
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2020")]
	pub underlying_settled_entity_matrix_publication_date: Option<fix_common::LocalMktDate>,
	/// UnderlyingStrikeMultiplier
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2021")]
	pub underlying_strike_multiplier: Option<f64>,
	/// UnderlyingStrikeValue
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2022")]
	pub underlying_strike_value: Option<f64>,
	/// UnderlyingStrikePriceDeterminationMethod
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2023")]
	pub underlying_strike_price_determination_method: Option<UnderlyingStrikePriceDeterminationMethod>,
	/// When specified, UnderlyingPutOrCall(315), UnderlyingStrikePrice(316), and UnderlyingStrikePriceBoundaryPrecision(2025) must
	/// also be specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2024")]
	pub underlying_strike_price_boundary_method: Option<UnderlyingStrikePriceBoundaryMethod>,
	/// UnderlyingStrikePriceBoundaryPrecision
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2025")]
	pub underlying_strike_price_boundary_precision: Option<f32>,
	/// UnderlyingMinPriceIncrement
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2026")]
	pub underlying_min_price_increment: Option<f64>,
	/// UnderlyingMinPriceIncrementAmount
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2027")]
	pub underlying_min_price_increment_amount: Option<f64>,
	/// UnderlyingOptPayoutType
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2028")]
	pub underlying_opt_payout_type: Option<UnderlyingOptPayoutType>,
	/// Conditionally required if UnderlyingOptPayoutType(2028) = 3 (Binary).
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2029")]
	pub underlying_opt_payout_amount: Option<f64>,
	/// UnderlyingPriceQuoteMethod
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2030")]
	pub underlying_price_quote_method: Option<UnderlyingPriceQuoteMethod>,
	/// UnderlyingValuationMethod
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2031")]
	pub underlying_valuation_method: Option<String>,
	/// UnderlyingListMethod
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2032")]
	pub underlying_list_method: Option<UnderlyingListMethod>,
	/// UnderlyingCapPrice
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2033")]
	pub underlying_cap_price: Option<f64>,
	/// UnderlyingFloorPrice
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2034")]
	pub underlying_floor_price: Option<f64>,
	/// UnderlyingFlexibleIndicator
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2035")]
	pub underlying_flexible_indicator: Option<fix_common::Boolean>,
	/// UnderlyingFlexProductEligibilityIndicator
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2036")]
	pub underlying_flex_product_eligibility_indicator: Option<fix_common::Boolean>,
	/// UnderlyingPositionLimit
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2037")]
	pub underlying_position_limit: Option<i32>,
	/// UnderlyingNTPositionLimit
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2038")]
	pub underlying_nt_position_limit: Option<i32>,
	/// UnderlyingPool
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2039")]
	pub underlying_pool: Option<String>,
	/// UnderlyingContractSettlMonth
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2040")]
	pub underlying_contract_settl_month: Option<fix_common::MonthYear>,
	/// UnderlyingDatedDate
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2041")]
	pub underlying_dated_date: Option<fix_common::LocalMktDate>,
	/// UnderlyingInterestAccrualDate
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2042")]
	pub underlying_interest_accrual_date: Option<fix_common::LocalMktDate>,
	/// UnderlyingShortSaleRestriction
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2043")]
	pub underlying_short_sale_restriction: Option<UnderlyingShortSaleRestriction>,
	/// UnderlyingRefTickTableID
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2044")]
	pub underlying_ref_tick_table_id: Option<i32>,
	/// UnderlyingProtectionTermXIDRef
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41314")]
	pub underlying_protection_term_xid_ref: Option<String>,
	/// UnderlyingSettlTermXIDRef
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41315")]
	pub underlying_settl_term_xid_ref: Option<String>,
	/// UnderlyingComplexEvents
	#[serde(flatten)]
	pub underlying_complex_events: Option<super::underlying_complex_events::UnderlyingComplexEvents>,
	/// UnderlyingDateAdjustment
	#[serde(flatten)]
	pub underlying_date_adjustment: Option<super::underlying_date_adjustment::UnderlyingDateAdjustment>,
	/// UnderlyingStreamGrp
	#[serde(flatten)]
	pub underlying_stream_grp: Option<super::underlying_stream_grp::UnderlyingStreamGrp>,
	/// UnderlyingSettlRateIndex
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2284")]
	pub underlying_settl_rate_index: Option<String>,
	/// UnderlyingSettlRateIndexLocation
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2285")]
	pub underlying_settl_rate_index_location: Option<String>,
	/// UnderlyingOptionExpirationDesc
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2286")]
	pub underlying_option_expiration_desc: Option<String>,
	/// Must be set if EncodedUnderlyingOptionExpirationDesc(2288) field is specified and must immediately precede it.
	#[serde(rename = "2287")]
	/// Encoded (non-ASCII characters) representation of the UnderlyingOptionExpirationDesc(2286) field in the encoded format specified
	/// via the MessageEncoding(347) field.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(alias = "2288")]
	pub encoded_underlying_option_expiration_desc: Option<fix_common::EncodedText<2288>>,
	/// UnderlyingAssetAttributeGrp
	#[serde(flatten)]
	pub underlying_asset_attribute_grp: Option<super::underlying_asset_attribute_grp::UnderlyingAssetAttributeGrp>,
	/// UnderlyingSwapSubClass
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2289")]
	pub underlying_swap_sub_class: Option<UnderlyingSwapSubClass>,
	/// UnderlyingStrikeUnitOfMeasure
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2290")]
	pub underlying_strike_unit_of_measure: Option<UnderlyingStrikeUnitOfMeasure>,
	/// UnderlyingStrikeIndex
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2291")]
	pub underlying_strike_index: Option<String>,
	/// UnderlyingStrikeIndexSpread
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2292")]
	pub underlying_strike_index_spread: Option<f64>,
	/// UnderlyingTradingUnitPeriodMultiplier
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2363")]
	pub underlying_trading_unit_period_multiplier: Option<i32>,
	/// UnderlyingProvisionGrp
	#[serde(flatten)]
	pub underlying_provision_grp: Option<super::underlying_provision_grp::UnderlyingProvisionGrp>,
	/// UnderlyingAdditionalTermGrp
	#[serde(flatten)]
	pub underlying_additional_term_grp: Option<super::underlying_additional_term_grp::UnderlyingAdditionalTermGrp>,
	/// UnderlyingProtectionTermGrp
	#[serde(flatten)]
	pub underlying_protection_term_grp: Option<super::underlying_protection_term_grp::UnderlyingProtectionTermGrp>,
	/// UnderlyingCashSettlTermGrp
	#[serde(flatten)]
	pub underlying_cash_settl_term_grp: Option<super::underlying_cash_settl_term_grp::UnderlyingCashSettlTermGrp>,
	/// UnderlyingPhysicalSettlTermGrp
	#[serde(flatten)]
	pub underlying_physical_settl_term_grp: Option<super::underlying_physical_settl_term_grp::UnderlyingPhysicalSettlTermGrp>,
	/// UnderlyingAssetGroup
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2491")]
	pub underlying_asset_group: Option<UnderlyingAssetGroup>,
	/// UnderlyingNotional
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2614")]
	pub underlying_notional: Option<f64>,
	/// UnderlyingNotionalCurrency
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2615")]
	pub underlying_notional_currency: Option<String>,
	/// UnderlyingNotionalDeterminationMethod
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2616")]
	pub underlying_notional_determination_method: Option<String>,
	/// UnderlyingNotionalAdjustments
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2617")]
	pub underlying_notional_adjustments: Option<UnderlyingNotionalAdjustments>,
	/// UnderlyingNotionalXIDRef
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2619")]
	pub underlying_notional_xid_ref: Option<String>,
	/// UnderlyingFutureID
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2620")]
	pub underlying_future_id: Option<String>,
	/// Required if UnderlyingFutureID(2620) is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2621")]
	pub underlying_future_id_source: Option<String>,
	/// UnderlyingStrikeIndexCurvePoint
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2622")]
	pub underlying_strike_index_curve_point: Option<String>,
	/// UnderlyingStrikeIndexQuote
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2623")]
	pub underlying_strike_index_quote: Option<i32>,
	/// UnderlyingRateSpreadSchedule
	#[serde(flatten)]
	pub underlying_rate_spread_schedule: Option<super::underlying_rate_spread_schedule::UnderlyingRateSpreadSchedule>,
	/// UnderlyingDividendPayout
	#[serde(flatten)]
	pub underlying_dividend_payout: Option<super::underlying_dividend_payout::UnderlyingDividendPayout>,
	/// UnderlyingExtraordinaryEventGrp
	#[serde(flatten)]
	pub underlying_extraordinary_event_grp: Option<super::underlying_extraordinary_event_grp::UnderlyingExtraordinaryEventGrp>,
	/// UnderlyingExtraordinaryEventAdjustmentMethod
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2624")]
	pub underlying_extraordinary_event_adjustment_method: Option<i32>,
	/// UnderlyingExchangeLookAlike
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2625")]
	pub underlying_exchange_look_alike: Option<fix_common::Boolean>,
	/// UnderlyingAverageVolumeLimitationPercentage
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2626")]
	pub underlying_average_volume_limitation_percentage: Option<f64>,
	/// UnderlyingAverageVolumeLimitationPeriodDays
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2627")]
	pub underlying_average_volume_limitation_period_days: Option<i32>,
	/// UnderlyingDepositoryReceiptIndicator
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2628")]
	pub underlying_depository_receipt_indicator: Option<fix_common::Boolean>,
	/// UnderlyingOpenUnits
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2629")]
	pub underlying_open_units: Option<f64>,
	/// UnderlyingBasketDivisor
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2630")]
	pub underlying_basket_divisor: Option<f64>,
	/// UnderlyingInstrumentXID
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2631")]
	pub underlying_instrument_xid: Option<String>,
	/// Used to express in-the-moneyness behavior in general terms for the option without the use of UnderlyingStrikePrice(316) and
	/// UnderlyingPutOrCall(315).
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2683")]
	pub underlying_in_the_money_condition: Option<i32>,
	/// UnderlyingContraryInstructionEligibilityIndicator
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2687")]
	pub underlying_contrary_instruction_eligibility_indicator: Option<fix_common::Boolean>,
	/// UnderlyingFinancialInstrumentFullName
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2720")]
	pub underlying_financial_instrument_full_name: Option<String>,
	/// Must be set if EncodedUnderlyingFinancialInstrumentFullName(2722) field is specified and must immediately precede it.
	#[serde(rename = "2721")]
	/// Encoded (non-ASCII characters) representation of the UnderlyingFinancialInstrumentFullName(2720) field in the encoded format
	/// specified via the MessageEncoding(347) field.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(alias = "2722")]
	pub encoded_underlying_financial_instrument_full_name: Option<fix_common::EncodedText<2722>>,
	/// Requires UnderlyingSecurityID(305) to identify the index. Requires UnderlyingIndexCurvePeriod(2724).
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2723")]
	pub underlying_index_curve_unit: Option<String>,
	/// Requires UnderlyingSecurityID(305) to identify the index. Requires UnderlyingIndexCurveUnit(2723).
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2724")]
	pub underlying_index_curve_period: Option<i32>,
	/// UnderlyingAssetSubType
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2744")]
	pub underlying_asset_sub_type: Option<String>,
	/// UnderlyingFinancialInstrumentShortName
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2742")]
	pub underlying_financial_instrument_short_name: Option<String>,
	/// UnderlyingReturnTrigger
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2757")]
	pub underlying_return_trigger: Option<i32>,
	/// UnderlyingDeliveryRouteOrCharter
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2756")]
	pub underlying_delivery_route_or_charter: Option<String>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2881")]
	pub underlying_coupon_other_day_count: Option<String>,
	/// UnderlyingAccruedInterestAmt
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2885")]
	pub underlying_accrued_interest_amt: Option<f64>,
	/// UnderlyingNumDaysInterest
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2886")]
	pub underlying_num_days_interest: Option<i32>,
}
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingRestructuringType {
	/// Full Restructuring
	#[serde(rename = "FR")]
	FullRestructuring,
...
impl Default for UnderlyingRestructuringType {
	fn default() -> Self {
		UnderlyingRestructuringType::FullRestructuring
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingSeniority {
	/// Senior Secured
	#[serde(rename = "SD")]
	SeniorSecured,
	/// Senior
...
impl Default for UnderlyingSeniority {
	fn default() -> Self {
		UnderlyingSeniority::SeniorSecured
	}
}
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingContractMultiplierUnit {
	/// Shares
	#[serde(rename = "0")]
	Shares,
	/// Hours
...
impl Default for UnderlyingContractMultiplierUnit {
	fn default() -> Self {
		UnderlyingContractMultiplierUnit::Shares
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingFlowScheduleType {
...
impl Default for UnderlyingFlowScheduleType {
	fn default() -> Self {
		UnderlyingFlowScheduleType::NercEasternOffPeak
	}
}
...
impl Default for UnderlyingPriceUnitOfMeasure {
	fn default() -> Self {
		UnderlyingPriceUnitOfMeasure::Bbl
	}
}
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingPriceQuoteCurrency {
	/// Afghani
	#[serde(rename = "AFA")]
	Afa,
	/// Algerian Dinar
...
impl Default for UnderlyingPriceQuoteCurrency {
	fn default() -> Self {
		UnderlyingPriceQuoteCurrency::Afa
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingUnitOfMeasureCurrency {
	/// Afghani
	#[serde(rename = "AFA")]
	Afa,
	/// Algerian Dinar
...
impl Default for UnderlyingUnitOfMeasureCurrency {
	fn default() -> Self {
		UnderlyingUnitOfMeasureCurrency::Afa
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingPriceUnitOfMeasureCurrency {
	/// Afghani
	#[serde(rename = "AFA")]
	Afa,
	/// Algerian Dinar
...
impl Default for UnderlyingPriceUnitOfMeasureCurrency {
	fn default() -> Self {
		UnderlyingPriceUnitOfMeasureCurrency::Afa
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingCouponType {
	/// Zero
	#[serde(rename = "0")]
	Zero,
	/// Fixed rate
...
impl Default for UnderlyingCouponType {
	fn default() -> Self {
		UnderlyingCouponType::Zero
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingCouponFrequencyUnit {
	/// Day
	#[serde(rename = "D")]
	Day,
	/// Week
...
impl Default for UnderlyingCouponFrequencyUnit {
	fn default() -> Self {
		UnderlyingCouponFrequencyUnit::Day
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingCouponDayCount {
...
impl Default for UnderlyingCouponDayCount {
	fn default() -> Self {
		UnderlyingCouponDayCount::N0
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingObligationIDSource {
	/// CUSIP
	#[serde(rename = "1")]
	Cusip,
	/// SEDOL
...
impl Default for UnderlyingObligationIDSource {
	fn default() -> Self {
		UnderlyingObligationIDSource::Cusip
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingEquityIDSource {
	/// CUSIP
	#[serde(rename = "1")]
	Cusip,
	/// SEDOL
...
impl Default for UnderlyingEquityIDSource {
	fn default() -> Self {
		UnderlyingEquityIDSource::Cusip
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingLienSeniority {
	/// Unknown
	#[serde(rename = "0")]
	Unknown,
	/// First lien
...
impl Default for UnderlyingLienSeniority {
	fn default() -> Self {
		UnderlyingLienSeniority::Unknown
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingLoanFacility {
	/// Bridge loan
	#[serde(rename = "0")]
	BridgeLoan,
	/// Letter of credit
...
impl Default for UnderlyingLoanFacility {
	fn default() -> Self {
		UnderlyingLoanFacility::BridgeLoan
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingReferenceEntityType {
	/// Asian
	#[serde(rename = "1")]
	Asian,
...
impl Default for UnderlyingReferenceEntityType {
	fn default() -> Self {
		UnderlyingReferenceEntityType::Asian
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingAssignmentMethod {
	/// Random
	#[serde(rename = "R")]
	Random,
	/// ProRata
...
impl Default for UnderlyingAssignmentMethod {
	fn default() -> Self {
		UnderlyingAssignmentMethod::Random
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingSecurityStatus {
	/// Active
	#[serde(rename = "1")]
	Active,
	/// Inactive
...
impl Default for UnderlyingSecurityStatus {
	fn default() -> Self {
		UnderlyingSecurityStatus::Active
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingObligationType {
	/// Bond
	#[serde(rename = "0")]
	Bond,
	/// Convertible bond
...
impl Default for UnderlyingObligationType {
	fn default() -> Self {
...
impl Default for UnderlyingAssetClass {
	fn default() -> Self {
		UnderlyingAssetClass::InterestRate
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingAssetSubClass {
	/// Interest rate
	#[serde(rename = "1")]
	InterestRate,
	/// Currency
...
impl Default for UnderlyingAssetSubClass {
	fn default() -> Self {
		UnderlyingAssetSubClass::InterestRate
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingSwapClass {
	/// Basis swap
	#[serde(rename = "BS")]
	BasisSwap,
	/// Index swap
...
impl Default for UnderlyingSwapClass {
	fn default() -> Self {
		UnderlyingSwapClass::BasisSwap
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingStrikePriceDeterminationMethod {
	/// Fixed Strike
	#[serde(rename = "1")]
	FixedStrike,
...
impl Default for UnderlyingStrikePriceDeterminationMethod {
	fn default() -> Self {
		UnderlyingStrikePriceDeterminationMethod::FixedStrike
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingStrikePriceBoundaryMethod {
...
impl Default for UnderlyingStrikePriceBoundaryMethod {
	fn default() -> Self {
		UnderlyingStrikePriceBoundaryMethod::LessThanUnderlyingPriceIsInTheMoney
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingOptPayoutType {
	/// Vanilla
	#[serde(rename = "1")]
	Vanilla,
	/// Capped
...
impl Default for UnderlyingOptPayoutType {
	fn default() -> Self {
		UnderlyingOptPayoutType::Vanilla
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingPriceQuoteMethod {
...
impl Default for UnderlyingPriceQuoteMethod {
	fn default() -> Self {
		UnderlyingPriceQuoteMethod::StandardMoneyPerUnitOfAPhysical
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingListMethod {
	/// premium style
	#[serde(rename = "EQTY")]
	PremiumStyle,
...
impl Default for UnderlyingListMethod {
	fn default() -> Self {
		UnderlyingListMethod::PremiumStyle
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingShortSaleRestriction {
	/// No Restrictions
	#[serde(rename = "0")]
	NoRestrictions,
...
impl Default for UnderlyingShortSaleRestriction {
	fn default() -> Self {
		UnderlyingShortSaleRestriction::NoRestrictions
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingSwapSubClass {
...
impl Default for UnderlyingSwapSubClass {
	fn default() -> Self {
		UnderlyingSwapSubClass::AmortizingNotionalSchedule
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingStrikeUnitOfMeasure {
	/// Barrels
	#[serde(rename = "Bbl")]
	Bbl,
	/// Billion cubic feet
...
impl Default for UnderlyingStrikeUnitOfMeasure {
	fn default() -> Self {
		UnderlyingStrikeUnitOfMeasure::Bbl
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingAssetGroup {
...
impl Default for UnderlyingAssetGroup {
	fn default() -> Self {
		UnderlyingAssetGroup::Financials
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingNotionalAdjustments {
	/// Execution
	#[serde(rename = "0")]
	Execution,
...
impl Default for UnderlyingNotionalAdjustments {
	fn default() -> Self {
