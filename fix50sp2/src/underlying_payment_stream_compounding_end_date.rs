...
pub struct UnderlyingPaymentStreamCompoundingEndDate {
	...
	#[serde(rename = "42917")]
	pub underlying_payment_stream_compounding_end_date_unadjusted: Option<crate::entities::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42922")]
	pub underlying_payment_stream_compounding_end_date_adjusted: Option<crate::entities::LocalMktDate>,
}
