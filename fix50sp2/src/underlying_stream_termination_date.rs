...
pub struct UnderlyingStreamTerminationDate {
	...
	#[serde(rename = "40548")]
	pub underlying_stream_termination_date_unadjusted: Option<fix_common::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40555")]
	pub underlying_stream_termination_date_adjusted: Option<fix_common::LocalMktDate>,
}
