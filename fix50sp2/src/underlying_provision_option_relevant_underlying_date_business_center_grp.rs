...
pub struct UnderlyingProvisionOptionRelevantUnderlyingDateBusinessCenterGrp {
	...
	#[serde(rename = "42188")]
	pub underlying_provision_option_relevant_underlying_date_business_centers: Option<fix_common::RepeatingValues<UnderlyingProvisionOptionRelevantUnderlyingDateBusinessCenter>>,
}
