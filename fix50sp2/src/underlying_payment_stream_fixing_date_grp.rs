...
pub struct UnderlyingPaymentStreamFixingDateGrp {
	...
	#[serde(rename = "42955")]
	pub underlying_payment_stream_fixing_dates: Option<crate::entities::RepeatingValues<UnderlyingPaymentStreamFixingDate>>,
}
...
pub struct UnderlyingPaymentStreamFixingDate {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42956")]
	pub underlying_payment_stream_fixing_date: Option<crate::entities::LocalMktDate>,
