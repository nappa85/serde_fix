...
pub struct PricingDateTime {
	...
	#[serde(rename = "41232")]
	pub pricing_date_unadjusted: Option<fix_common::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41234")]
	pub pricing_date_adjusted: Option<fix_common::LocalMktDate>,
	/// PricingTime
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41235")]
...
impl Default for PricingDateBusinessDayConvention {
	fn default() -> Self {
		PricingDateBusinessDayConvention::NotApplicable
	}
}
