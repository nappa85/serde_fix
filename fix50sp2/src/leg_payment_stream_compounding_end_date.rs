...
pub struct LegPaymentStreamCompoundingEndDate {
	...
	#[serde(rename = "42421")]
	pub leg_payment_stream_compounding_end_date_unadjusted: Option<fix_common::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42426")]
	pub leg_payment_stream_compounding_end_date_adjusted: Option<fix_common::LocalMktDate>,
}
