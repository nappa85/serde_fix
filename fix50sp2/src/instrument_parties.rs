...
pub struct InstrumentPartie {
	/// Required if NoInstrumentParties(1018) &gt; 0. Identification of the party.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1019")]
	pub instrument_party_id: Option<String>,
	/// Required if NoInstrumentParties(1018) &gt; 0. Used to identify classification source.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1050")]
	pub instrument_party_id_source: Option<InstrumentPartyIDSource>,
	/// Required if NoInstrumentParties(1018) &gt; 0. Identifies the type of InstrumentPartyID(1019).
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1051")]
