...
pub struct UnderlyingPaymentStreamCompoundingStartDate {
	...
	#[serde(rename = "42941")]
	pub underlying_payment_stream_compounding_start_date_unadjusted: Option<crate::entities::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42946")]
	pub underlying_payment_stream_compounding_start_date_adjusted: Option<crate::entities::LocalMktDate>,
}
