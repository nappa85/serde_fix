...
pub struct SettlParties {
	...
	#[serde(rename = "781")]
	pub settl_party_i_ds: Option<crate::entities::RepeatingValues<SettlPartyID>>,
}
...
pub struct SettlPartyID {
	...
	/// Used to identify class source of <a href="tag_782_SettlPartyID.html" target="bottom">SettlPartyID&nbsp;(782)</a> value (e.g. BIC). Required if <a href="tag_782_SettlPartyID.html" target="bottom">SettlPartyID&nbsp;(782)</a> is specified. Required if <a href="tag_781_NoSettlPartyIDs.html" target="bottom">NoSettlPartyIDs&nbsp;(781)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "783")]
	pub settl_party_id_source: Option<SettlPartyIDSource>,
	/// Identifies the type of <a href="tag_782_SettlPartyID.html" target="bottom">SettlPartyID&nbsp;(782)</a> (e.g. Executing Broker). Required if <a href="tag_781_NoSettlPartyIDs.html" target="bottom">NoSettlPartyIDs&nbsp;(781)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "784")]
	...
	#[serde(default)]
	#[serde(rename = "2389")]
	pub settl_party_role_qualifier: Option<i32>,
}
