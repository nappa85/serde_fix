...
pub struct UnderlyingReturnRateGrp {
	...
	#[serde(rename = "43034")]
	pub underlying_return_rates: Option<crate::entities::RepeatingValues<UnderlyingReturnRate>>,
}
...
pub struct UnderlyingReturnRate {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "43048")]
	pub underlying_return_rate_quote_time: Option<crate::entities::LocalMktDate>,
	/// UnderlyingReturnRateQuoteDate
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "43049")]
	pub underlying_return_rate_quote_date: Option<crate::entities::LocalMktDate>,
