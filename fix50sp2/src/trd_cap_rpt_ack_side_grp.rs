...
pub struct TrdCapRptAckSideGrp {
	/// NoSides
	#[serde(rename = "552")]
...
pub struct NoSide {
	...
	/// Generally the same for all sides of a trade, if reported only on the first side the same <a href="tag_336_TradingSessionID.html" target="bottom">TradingSessionID&nbsp;(336)</a> will apply to all sides of the trade
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "336")]
	pub trading_session_id: Option<TradingSessionID>,
	/// Generally the same for all sides of a trade, if reported only on the first side the same <a href="tag_625_TradingSessionSubID.html" target="bottom">TradingSessionSubID&nbsp;(625)</a> will apply to all sides of the trade.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "625")]
...
impl Default for SideAvgPxIndicator {
	fn default() -> Self {
		SideAvgPxIndicator::NoAveragePricing
	}
}
...
impl Default for SideTradeReportingIndicator {
	fn default() -> Self {
		SideTradeReportingIndicator::TradeHasNotBeenReported
	}
}
