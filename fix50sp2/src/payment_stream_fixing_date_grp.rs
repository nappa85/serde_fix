...
pub struct PaymentStreamFixingDateGrp {
	...
	#[serde(rename = "42660")]
	pub payment_stream_fixing_dates: Option<crate::entities::RepeatingValues<PaymentStreamFixingDate>>,
}
...
pub struct PaymentStreamFixingDate {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42661")]
	pub payment_stream_fixing_date: Option<crate::entities::LocalMktDate>,
