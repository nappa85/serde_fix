...
pub struct ProvisionPtysSubGrp {
	/// NoProvisionPartySubIDs
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40178")]
	pub provision_party_sub_i_ds: Option<fix_common::RepeatingValues<ProvisionPartySubID>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct ProvisionPartySubID {
	/// Required if NoProvisionPartySubIDs(40178) &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40179")]
	pub provision_party_sub_id: Option<String>,
	/// Required if NoProvisionPartySubIDs(40178) &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40180")]
...
impl Default for ProvisionPartySubIDType {
	fn default() -> Self {
		ProvisionPartySubIDType::N1
	}
}
