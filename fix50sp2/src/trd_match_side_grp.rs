...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TrdMatchSide {
	/// Required if NoTrdMatchSides (1890) &gt; 0
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "54")]
	pub side: Option<Side>,
	/// This refers to the ExecID of the execution being reported. Used in trade reporting models that utilize different execution
	/// IDs for each side of the trade. This is used when reporting a trade with two or more sides.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1427")]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1900")]
	pub side_exec_ref_id: Option<String>,
	/// SideTradeID
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1506")]
	pub side_trade_id: Option<String>,
	/// Used to indicate the report ID for this trade match side.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1005")]
	...
	/// Used to indicate whether the trade is clearing using execution price or alternate clearing price.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1598")]
	pub side_clearing_trade_price_type: Option<SideClearingTradePriceType>,
	/// Used for order routing to indicate the Fill Station Code for this trade match side.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1006")]
	pub side_fill_station_cd: Option<String>,
	/// Used to indicate the reason for execution for this trade match side.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1007")]
	...
	/// Used to identify the currency of the trade match side.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1154")]
	pub side_currency: Option<SideCurrency>,
	/// Used to identify the settlement currency of the trade match side.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1155")]
	...
	/// Identifies the average price group for the trade
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1731")]
	pub avg_px_group_id: Option<String>,
	/// <p>Can be used if the match event results in matches across different market segments for this side.</p>
	/// <p>Used instead of MarketSegmentID(1300) when market segment may be different across sides.</p>
	/// <p>Note that the market cannot be different across sides and is specified in MarketID(1301).</p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1898")]
	pub side_market_segment_id: Option<String>,
	/// <p>Can be used if the match event results in matches across different venue types for this side.</p>
	/// <p>Used instead of VenueType(1430) when venue type may be different across sides.</p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1899")]
	pub side_venue_type: Option<SideVenueType>,
	...
	/// May be used by the executing market to record any execution Details that are particular to that market. Can be used to include
	/// text included in the order submission.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "58")]
	pub text: Option<String>,
	/// Must be set if EncodedText field is specified and must immediately precede it
	#[serde(rename = "354")]
	/// Encoded (non-ASCII characters) representation of the Text field in the encoded format specified via theMessageEncoding field.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(alias = "355")]
...
impl Default for SideClearingTradePriceType {
	fn default() -> Self {
...
impl Default for SideVenueType {
	fn default() -> Self {
		SideVenueType::Electronic
	}
}
