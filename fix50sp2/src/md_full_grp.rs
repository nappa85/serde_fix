...
pub struct MDEntrie {
	...
	/// Conditionally required when maintaining an order-depth book (AggregatedBook (266) is "N"). Allows subsequent Incremental changes
	/// to be applied using MDEntryID.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "278")]
	...
	/// May be specified for an MDEntryType(269)=2 (Trade) entry to indicate that MDEntryPx(270), PriceType(423) and MDEntrySize(271)
	/// apply to the instance of the InstrmtLegGrp component with matching LegID(1788).
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "654")]
