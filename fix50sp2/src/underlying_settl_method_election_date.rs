...
pub struct UnderlyingSettlMethodElectionDate {
	...
	#[serde(rename = "43076")]
	pub underlying_settl_method_election_date_unadjusted: Option<crate::entities::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "43082")]
	pub underlying_settl_method_election_date_adjusted: Option<crate::entities::LocalMktDate>,
}
