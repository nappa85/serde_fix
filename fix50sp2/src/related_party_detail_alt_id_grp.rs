...
pub struct RelatedPartyDetailAltIDGrp {
	/// NoRelatedPartyDetailAltIDs
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1569")]
	pub related_party_detail_alt_i_ds: Option<crate::entities::RepeatingValues<RelatedPartyDetailAltID>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct RelatedPartyDetailAltID {
	/// <p>Required when <a href="tag_1569_NoRelatedPartyDetailAltIDs.html" target="bottom">NoRelatedPartyDetailAltIDs (1569)&nbsp;(1569)</a> &gt; 0
	/// </p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1570")]
	pub related_party_detail_alt_id: Option<String>,
	/// <p>Required when <a href="tag_1569_NoRelatedPartyDetailAltIDs.html" target="bottom">NoRelatedPartyDetailAltIDs (1569)&nbsp;(1569)</a> &gt; 0
	/// </p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1571")]
