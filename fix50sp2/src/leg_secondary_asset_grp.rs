...
pub struct LegSecondaryAssetGrp {
	/// NoLegSecondaryAssetClasses
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2076")]
	pub leg_secondary_asset_classes: Option<crate::entities::RepeatingValues<LegSecondaryAssetClasse>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct LegSecondaryAssetClasse {
	/// Required if NoLegSecondaryAssetClasses(2076) &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2077")]
	pub leg_secondary_asset_class: Option<LegSecondaryAssetClass>,
	/// Required if LegSecondaryAssetType(2079) is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2078")]
	pub leg_secondary_asset_sub_class: Option<LegSecondaryAssetSubClass>,
	/// Required if LegSecondaryAssetSubType(2743) is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2079")]
	pub leg_secondary_asset_type: Option<String>,
