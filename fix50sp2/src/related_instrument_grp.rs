...
pub struct RelatedInstrumentGrp {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct RelatedInstrument {
	/// Conditionally required when NoRelatedInstruments(1647) &gt; 0
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1648")]
	pub related_instrument_type: Option<RelatedInstrumentType>,
	/// Either RelatedSymbol(1649) or RelatedSecurityID(1650) must be specified. For RelatedInstrumentType(1648)=1 ("hedges for" instrument)
	/// this would be the instrument being used to offset the option Instrument. If one of the "related to" fields is specified, this
	...
	/// Either RelatedSymbol(1649) or RelatedSecurityID(1650) must be specified. If one of the "related to" fields is specified, this
	/// is the UnderlyingSecurityID(309) of an underlying instrument defining the related security in the current message.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1650")]
	pub related_security_id: Option<String>,
	/// Conditionally required when RelatedSecurityID(1650) is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1651")]
	pub related_security_id_source: Option<RelatedSecurityIDSource>,
	/// May be omitted if RelatedSecurityID(1650) or RelatedSymbol(1649) refers to an underlying instrument in the current message.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1652")]
	pub related_security_type: Option<RelatedSecurityType>,
	/// May be omitted if RelatedSecurityID(1650) or RelatedSymbol(1649) refers to an underlying instrument in the current message.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1653")]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2413")]
	pub related_to_security_id: Option<String>,
	/// Conditionally required when RelatedToSecurityID(2413) is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2414")]
	pub related_to_security_id_source: Option<String>,
	/// Mutually exclusive with RelatedToSecurityID(2413) and RelatedToDividendPeriodXIDRef(2417). If correlation is with the security
	/// in Instrument component then all "related to" fields may be omitted.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2415")]
	pub related_to_stream_xid_ref: Option<String>,
	/// Mutually exclusive with RelatedToSecurityID(2413) and RelatedToStreamXIDRef(2415). If correlation is with the security in
	/// Instrument component then all "related to" fields may be omitted.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2417")]
...
pub enum RelatedInstrumentType {
	...
	#[serde(rename = "4")]
	NearestExchangeTradedContract,
	/// Retail equivalent of wholesale instrument
	#[serde(rename = "5")]
	RetailEquivalentOfWholesaleInstrument,
	/// Leg
	#[serde(rename = "6")]
	Leg,
}
