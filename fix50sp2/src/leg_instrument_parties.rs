...
pub struct LegInstrumentParties {
	/// Repeating group below should contain unique combinations of LegInstrumentPartyID(2255), LegInstrumentPartyIDSource(2256) and
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct LegInstrumentPartie {
	/// Used to identify the source of PartyID. Required if LegInstrumentPartyIDSource(2256) is specified. Required if NoLegInstrumentParties(2254)
	/// &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2255")]
	pub leg_instrument_party_id: Option<String>,
	/// Used to identify class source of LegInstrumentPartyID(2255) value (e.g. BIC). Required if LegInstrumentPartyID(2255) is specified.
	/// Required if NoLegInstrumentParties(2254) &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2256")]
	pub leg_instrument_party_id_source: Option<LegInstrumentPartyIDSource>,
