...
pub struct Nested3PartyID {
	...
	/// Used to identify class source of <a href="tag_949_Nested3PartyID.html" target="bottom">Nested3PartyID&nbsp;(949)</a> value (e.g. BIC). Required if <a href="tag_949_Nested3PartyID.html" target="bottom">Nested3PartyID&nbsp;(949)</a> is specified. Required if <a href="tag_948_NoNested3PartyIDs.html" target="bottom">NoNested3PartyIDs&nbsp;(948)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "950")]
	pub nested_3_party_id_source: Option<Nested3PartyIDSource>,
	/// Identifies the type of <a href="tag_949_Nested3PartyID.html" target="bottom">Nested3PartyID&nbsp;(949)</a> (e.g. Executing Broker). Required if <a href="tag_948_NoNested3PartyIDs.html" target="bottom">NoNested3PartyIDs&nbsp;(948)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "951")]
	...
	#[serde(default)]
	#[serde(rename = "2382")]
	pub nested_3_party_role_qualifier: Option<i32>,
}
