...
pub struct EntitlementAttribGrp {
	/// NoEntitlementAttrib
...
pub struct EntitlementAttri {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1779")]
	pub entitlement_attrib_datatype: Option<EntitlementAttribDatatype>,
	/// Required if NoEntitlementAttrib(1777) &gt; 0
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1780")]
	pub entitlement_attrib_value: Option<String>,
...
pub enum EntitlementAttribDatatype {
	...
	/// </tr>
	/// <tr valign="top">
	/// <td class="val">'float'</td>
	/// <td class="val-descr">
	#[serde(rename = "data")]
	TdTrTrValignTopTdClassValFloatTdTdClassValDescr,
	/// </td>
	/// </tr>
	/// <tr valign="top">
	/// <td class="val">'char'</td>
	/// <td class="val-descr">
	#[serde(rename = "int")]
