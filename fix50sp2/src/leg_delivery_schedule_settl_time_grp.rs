...
pub struct LegDeliveryScheduleSettlTimeGrp {
	/// NoLegDeliveryScheduleSettlTimes
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41425")]
	pub leg_delivery_schedule_settl_times: Option<fix_common::RepeatingValues<LegDeliveryScheduleSettlTime>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct LegDeliveryScheduleSettlTime {
	/// Required if NoLegDeliveryScheduleSettlTimes(41425) &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41426")]
	pub leg_delivery_schedule_settl_start: Option<String>,
	/// Required if NoLegDeliveryScheduleSettlTimes(41425) &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41427")]
	pub leg_delivery_schedule_settl_end: Option<String>,
	/// May be defaulted to market convention or bilaterally agreed if not specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41428")]
	pub leg_delivery_schedule_settl_time_type: Option<LegDeliveryScheduleSettlTimeType>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum LegDeliveryScheduleSettlTimeType {
...
impl Default for LegDeliveryScheduleSettlTimeType {
	fn default() -> Self {
		LegDeliveryScheduleSettlTimeType::HourOfTheDayTheDeliveryStartEndHourIsSpecifiedAsTheEndOfTheIncludedHourForExampleAStartHourOf4BeginsAt3AMAnEndHourOf20EndsAt8PMAStartHourOf1AndAnEndHourOf24IndicatesMidnightToMidnightDelivery
	}
}
