...
pub struct SecondaryAssetGrp {
	/// NoSecondaryAssetClasses
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1976")]
	pub secondary_asset_classes: Option<crate::entities::RepeatingValues<SecondaryAssetClasse>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct SecondaryAssetClasse {
	/// Required if NoSecondaryAssetClasses(1976) &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1977")]
	pub secondary_asset_class: Option<SecondaryAssetClass>,
	/// Required if SecondaryAssetType(1979) is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1978")]
	pub secondary_asset_sub_class: Option<SecondaryAssetSubClass>,
	/// Required if SecondaryAssetSubType(2741) is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1979")]
	pub secondary_asset_type: Option<String>,
