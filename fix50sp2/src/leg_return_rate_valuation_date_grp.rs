...
pub struct LegReturnRateValuationDateGrp {
	...
	#[serde(rename = "42571")]
	pub leg_return_rate_valuation_dates: Option<crate::entities::RepeatingValues<LegReturnRateValuationDate>>,
}
...
pub struct LegReturnRateValuationDate {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42572")]
	pub leg_return_rate_valuation_date: Option<crate::entities::LocalMktDate>,
