...
pub struct UnderlyingProvisionCashSettlPaymentDateBusinessCenterGrp {
	...
	#[serde(rename = "42180")]
	pub underlying_provision_cash_settl_payment_date_business_centers: Option<fix_common::RepeatingValues<UnderlyingProvisionCashSettlPaymentDateBusinessCenter>>,
}
