...
pub struct PaymentStreamCompoundingDateGrp {
	...
	#[serde(rename = "42606")]
	pub payment_stream_compounding_dates: Option<crate::entities::RepeatingValues<PaymentStreamCompoundingDate>>,
}
...
pub struct PaymentStreamCompoundingDate {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42607")]
	pub payment_stream_compounding_date: Option<crate::entities::LocalMktDate>,
