...
pub struct UnderlyingCashSettlDate {
	...
	#[serde(rename = "42790")]
	pub underlying_cash_settl_date_unadjusted: Option<crate::entities::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42796")]
	pub underlying_cash_settl_date_adjusted: Option<crate::entities::LocalMktDate>,
}
