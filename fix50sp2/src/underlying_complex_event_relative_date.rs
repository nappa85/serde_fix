...
pub struct UnderlyingComplexEventRelativeDate {
	...
	#[serde(rename = "41739")]
	pub underlying_complex_event_date_unadjusted: Option<crate::entities::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41745")]
	pub underlying_complex_event_date_adjusted: Option<crate::entities::LocalMktDate>,
