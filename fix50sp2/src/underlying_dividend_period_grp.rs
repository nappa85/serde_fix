...
pub struct UnderlyingDividendPeriodGrp {
	...
	#[serde(rename = "42862")]
	pub underlying_dividend_periods: Option<fix_common::RepeatingValues<UnderlyingDividendPeriod>>,
}
...
pub struct UnderlyingDividendPeriod {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42864")]
	pub underlying_dividend_period_start_date_unadjusted: Option<fix_common::LocalMktDate>,
	/// UnderlyingDividendPeriodEndDateUnadjusted
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42865")]
	pub underlying_dividend_period_end_date_unadjusted: Option<fix_common::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42869")]
	pub underlying_dividend_period_valuation_date_unadjusted: Option<fix_common::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42874")]
	pub underlying_dividend_period_valuation_date_adjusted: Option<fix_common::LocalMktDate>,
	/// UnderlyingDividendPeriodPaymentDateUnadjusted
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42875")]
	pub underlying_dividend_period_payment_date_unadjusted: Option<fix_common::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42880")]
	pub underlying_dividend_period_payment_date_adjusted: Option<fix_common::LocalMktDate>,
