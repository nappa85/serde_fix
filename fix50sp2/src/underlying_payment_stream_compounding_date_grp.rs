...
pub struct UnderlyingPaymentStreamCompoundingDateGrp {
	...
	#[serde(rename = "42901")]
	pub underlying_payment_stream_compounding_dates: Option<fix_common::RepeatingValues<UnderlyingPaymentStreamCompoundingDate>>,
}
...
pub struct UnderlyingPaymentStreamCompoundingDate {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42902")]
	pub underlying_payment_stream_compounding_date: Option<fix_common::LocalMktDate>,
