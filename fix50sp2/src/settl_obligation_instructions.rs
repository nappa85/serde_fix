...
pub struct SettlObligationInstructions {
...
pub struct SettlObli {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1161")]
	pub settl_oblig_id: Option<String>,
	/// New, Replace, Cancel, or Restate.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1162")]
	pub settl_oblig_trans_type: Option<SettlObligTransType>,
	/// Required where <a href="tag_1162_SettlObligTransType.html" target="bottom">SettlObligTransType(1162)&nbsp;(1162)</a> is Cancel(C) or Replace(R). The <a href="tag_1161_SettlObligID.html" target="bottom">SettlObligID(1161)&nbsp;(1161)</a> of the settlement obligation being canceled or replaced.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1163")]
