...
pub struct UnderlyingPaymentStreamCompoundingDates {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42913")]
	pub underlying_payment_stream_bounds_first_date_unadjusted: Option<crate::entities::LocalMktDate>,
	/// UnderlyingPaymentStreamBoundsLastDateUnadjusted
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42914")]
	pub underlying_payment_stream_bounds_last_date_unadjusted: Option<crate::entities::LocalMktDate>,
}
