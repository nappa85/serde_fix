...
pub struct UnderlyingSettlRateDisruptionFallbackGrp {
	...
	#[serde(rename = "40659")]
	pub underlying_settl_rate_fallbacks: Option<fix_common::RepeatingValues<UnderlyingSettlRateFallback>>,
}
...
pub struct UnderlyingSettlRateFallback {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40662")]
	pub underlying_settl_rate_postponement_survey: Option<fix_common::Boolean>,
