...
pub struct ProvisionOptionRelevantUnderlyingDate {
	...
	#[serde(rename = "40155")]
	pub provision_option_relevant_underlying_date_unadjusted: Option<crate::entities::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40162")]
	pub provision_option_relevant_underlying_date_adjusted: Option<crate::entities::LocalMktDate>,
}
