...
pub struct RelatedPartyDetailAltSubGrp {
	/// NoRelatedPartyDetailAltSubIDs
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1572")]
	pub related_party_detail_alt_sub_i_ds: Option<fix_common::RepeatingValues<RelatedPartyDetailAltSubID>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct RelatedPartyDetailAltSubID {
	/// <p>Required when <a href="tag_1572_NoRelatedPartyDetailAltSubIDs.html" target="bottom">NoRelatedPartyDetailAltSubIDs (1572)&nbsp;(1572)</a> &gt; 0
	/// </p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1573")]
	pub related_party_detail_alt_sub_id: Option<String>,
	/// <p>Required when <a href="tag_1572_NoRelatedPartyDetailAltSubIDs.html" target="bottom">NoRelatedPartyDetailAltSubIDs (1572)&nbsp;(1572)</a> &gt; 0
	/// </p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1574")]
	pub related_party_detail_alt_sub_id_type: Option<RelatedPartyDetailAltSubIDType>,
}

#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum RelatedPartyDetailAltSubIDType {
	/// Firm
	#[serde(rename = "1")]
	N1,
	/// Person
...
impl Default for RelatedPartyDetailAltSubIDType {
	fn default() -> Self {
		RelatedPartyDetailAltSubIDType::N1
	}
}
