...
pub struct InstrmtMatchSideGrp {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct InstrmtMatchSide {
	/// Can be used to identify distinct price levels within a match event, e.g. Match Steps or Clips.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1891")]
	...
	/// <p>Trade quantity for this instrument within this match step. Trade Quantity for this instrument within this Match Step. This
	/// is determined as follows: For each TrdMatchSideGrp instance contained within this InstrmtMatchSideGrp instance, sum the SideLastQty
	/// field if the Side is a buy. Likewise, take the sum if the side is a sell. LastQty will be the greater of these two sums.
	/// </p>
	/// <p>The value is the greater of the sum of SideLastQty(1009) of each side (i.e. buy or sell) for each TrdMatchSideGrp instance
	/// within the current InstrmtMatchSideGrp instance.
	/// </p>
