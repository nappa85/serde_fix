...
pub struct LegPositionAmountData {
	/// Number of Position Amount entries.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1586")]
	pub leg_pos_amt: Option<crate::entities::RepeatingValues<LegPosAm>>,
}
...
pub struct LegPosAm {
	...
	#[serde(default)]
	#[serde(rename = "1587")]
	pub leg_pos_amt: Option<f64>,
	/// LegPosAmtType
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1588")]
	pub leg_pos_amt_type: Option<LegPosAmtType>,
	/// LegPosCurrency
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1589")]
	pub leg_pos_currency: Option<LegPosCurrency>,
	/// LegPosAmtReason
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1590")]
