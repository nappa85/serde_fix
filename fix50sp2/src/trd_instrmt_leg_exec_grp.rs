...
pub struct TrdInstrmtLegExecGrp {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct LegExec {
	/// Required when NoLegExecs (1892) &gt; 0. Used to identify a specific leg.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "654")]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1893")]
	pub leg_exec_id: Option<String>,
	/// LegExecRefID
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1901")]
	pub leg_exec_ref_id: Option<String>,
	/// LegTradeID
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1894")]
	pub leg_trade_id: Option<String>,
	/// LegTradeReportID
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1895")]
	...
	/// <p>Provide if the PositionEffect for the leg is different from that specified for the overall multileg security.</p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "564")]
	...
	/// Optional when LegSide(624) = 6(Short sale exempt)
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1689")]
