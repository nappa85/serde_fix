...
pub struct LegPaymentStreamFixingDateGrp {
	...
	#[serde(rename = "42459")]
	pub leg_payment_stream_fixing_dates: Option<crate::entities::RepeatingValues<LegPaymentStreamFixingDate>>,
}
...
pub struct LegPaymentStreamFixingDate {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42460")]
	pub leg_payment_stream_fixing_date: Option<crate::entities::LocalMktDate>,
