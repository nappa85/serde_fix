...
pub struct LegPaymentStubStartDate {
	...
	#[serde(rename = "42497")]
	pub leg_payment_stub_start_date_unadjusted: Option<crate::entities::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42503")]
	pub leg_payment_stub_start_date_adjusted: Option<crate::entities::LocalMktDate>,
}
