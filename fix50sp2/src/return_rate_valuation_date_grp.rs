...
pub struct ReturnRateValuationDateGrp {
	...
	#[serde(rename = "42772")]
	pub return_rate_valuation_dates: Option<fix_common::RepeatingValues<ReturnRateValuationDate>>,
}
...
pub struct ReturnRateValuationDate {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42773")]
	pub return_rate_valuation_date: Option<fix_common::LocalMktDate>,
