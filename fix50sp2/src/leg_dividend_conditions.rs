...
pub struct LegDividendConditions {
	...
	#[serde(rename = "42337")]
	pub leg_dividend_reinvestment_indicator: Option<fix_common::Boolean>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42352")]
	pub leg_special_dividends_indicator: Option<fix_common::Boolean>,
	/// LegMaterialDividendsIndicator
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42353")]
	pub leg_material_dividends_indicator: Option<fix_common::Boolean>,
	/// LegOptionsExchangeDividendsIndicator
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42354")]
	pub leg_options_exchange_dividends_indicator: Option<fix_common::Boolean>,
	/// LegAdditionalDividendsIndicator
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42355")]
	pub leg_additional_dividends_indicator: Option<fix_common::Boolean>,
	/// LegAllDividendsIndicator
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42356")]
	pub leg_all_dividends_indicator: Option<fix_common::Boolean>,
}
