...
pub struct UnderlyingProvisionParties {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct UnderlyingProvisionPartyID {
	/// Required if NoUnderlyingProvisionPartyIDs(42173) &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42174")]
	pub underlying_provision_party_id: Option<String>,
	/// Required if NoUnderlyingProvisionPartyIDs(42173) &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42175")]
	pub underlying_provision_party_id_source: Option<UnderlyingProvisionPartyIDSource>,
	/// Required if NoUnderlyingProvisionPartyIDs(42173) &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42176")]
	pub underlying_provision_party_role: Option<UnderlyingProvisionPartyRole>,
	/// UnderlyingProvisionPartyRoleQualifier
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40918")]
	pub underlying_provision_party_role_qualifier: Option<UnderlyingProvisionPartyRoleQualifier>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingProvisionPartyIDSource {
...
impl Default for UnderlyingProvisionPartyIDSource {
	fn default() -> Self {
		UnderlyingProvisionPartyIDSource::BicCode
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingProvisionPartyRole {
...
impl Default for UnderlyingProvisionPartyRole {
	fn default() -> Self {
		UnderlyingProvisionPartyRole::ExecutingFirm
	}
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum UnderlyingProvisionPartyRoleQualifier {
	/// Agency
	#[serde(rename = "0")]
	Agency,
	/// Principal
...
impl Default for UnderlyingProvisionPartyRoleQualifier {
	fn default() -> Self {
		UnderlyingProvisionPartyRoleQualifier::Agency
	}
}
