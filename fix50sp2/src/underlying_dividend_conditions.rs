...
pub struct UnderlyingDividendConditions {
	...
	#[serde(rename = "42826")]
	pub underlying_dividend_reinvestment_indicator: Option<fix_common::Boolean>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42841")]
	pub underlying_special_dividends_indicator: Option<fix_common::Boolean>,
	/// UnderlyingMaterialDividendsIndicator
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42842")]
	pub underlying_material_dividends_indicator: Option<fix_common::Boolean>,
	/// UnderlyingOptionsExchangeDividendsIndicator
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42843")]
	pub underlying_options_exchange_dividends_indicator: Option<fix_common::Boolean>,
	/// UnderlyingAdditionalDividendsIndicator
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42844")]
	pub underlying_additional_dividends_indicator: Option<fix_common::Boolean>,
	/// UnderlyingAllDividendsIndicator
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42845")]
	pub underlying_all_dividends_indicator: Option<fix_common::Boolean>,
}
