...
pub struct AllocGrp {
	...
	#[serde(flatten)]
	pub alloc_regulatory_trade_id_grp: Option<super::alloc_regulatory_trade_id_grp::AllocRegulatoryTradeIDGrp>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct Alloc {
	/// May specify the broker of credit if <a href="tag_81_ProcessCode.html" target="bottom">ProcessCode(81)&nbsp;(81)</a> is step-out or soft-dollar step-out and Institution does not wish to disclose individual account breakdowns to the executing
	/// broker. Required if <a href="tag_78_NoAllocs.html" target="bottom">NoAllocs(78)&nbsp;(78)</a> &gt; 0. Must be first field in repeating group. Conditionally required except when for <a href="tag_71_AllocTransType.html" target="bottom">AllocTransType(71)&nbsp;(71)</a> = 2 ("Cancel)", or when <a href="tag_626_AllocType.html" target="bottom">AllocType(626)&nbsp;(626)</a> = 5 (Ready-To-Book single order) or 7 (Warehouse instruction)
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "79")]
	...
	/// NetMoney for this AllocAccount ((AllocQty * AllocAvgPx) - Commission - sum of MiscFeeAmt + AccruedInterestAmt) if a Sell.
	/// ((AllocQty * AllocAvgPx) + Commission + sum of MiscFeeAmt + AccruedInterestAmt) if a Buy. For FX, if specified, expressed
	/// in terms of Currency(15). .
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "154")]
	pub alloc_net_money: Option<f64>,
	/// (Deprecated in FIX.4.4) Replaced by AllocSettlCurrAmt
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "119")]
	...
	/// (Deprecated in FIX.4.4) Replaced by AllocSettlCurrency. SettlCurrency for this AllocAccount if different from "overall" Currency.
	/// Required if SettlCurrAmt is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "120")]
	pub settl_currency: Option<SettlCurrency>,
	/// AllocSettlCurrency for this AllocAccount if different from "overall" Currency.Required if AllocSettlCurrAmt is specified.Required
	/// for NDFs.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "736")]
	...
	/// Allocation identifier assigned by the Firm submitting the allocation for an individual allocation instruction (as opposed
	/// to the overall message level identifier)
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1729")]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1735")]
	pub allocation_rollup_instruction: Option<AllocationRollupInstruction>,
	/// Custodial Lot Identifier. Only used for specific lot trades.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1752")]
	pub custodial_lot_id: Option<String>,
	/// Acquisition Date of the Lot. Defined as the effective acquisition date that would be used for gain-loss reporting. Only used
	...
	#[serde(default)]
	#[serde(rename = "2300")]
	pub alloc_gross_trade_amt: Option<f64>,
	/// Conditionally required when <a href="tag_2393_AllocRefRiskLimitCheckIDType.html" target="bottom">AllocRefRiskLimitCheckIDType(2393)&nbsp;(2393)</a> is specified
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2392")]
	pub alloc_ref_risk_limit_check_id: Option<String>,
	/// Conditionally required when <a href="tag_2392_AllocRefRiskLimitCheckID.html" target="bottom">AllocRefRiskLimitCheckID(2392)&nbsp;(2392)</a> is specified
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2393")]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2483")]
	pub alloc_risk_limit_check_status: Option<AllocRiskLimitCheckStatus>,
	...
	#[serde(default)]
	#[serde(rename = "2761")]
	pub alloc_group_amount: Option<f64>,
	/// AllocAvgPxIndicator
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2769")]
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum AllocRefRiskLimitCheckIDType {
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum AllocRiskLimitCheckStatus {
	/// Accepted
	#[serde(rename = "0")]
	Accepted,
	/// Rejected
