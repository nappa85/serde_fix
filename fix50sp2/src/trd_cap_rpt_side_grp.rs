...
impl Default for SideLiquidityInd {
	fn default() -> Self {
		SideLiquidityInd::AddedLiquidity
	}
}
...
impl Default for TradeAllocGroupInstruction {
	fn default() -> Self {
		TradeAllocGroupInstruction::AddToAnExistingAllocationGroupIfOneExists
	}
}
...
impl Default for BlockTrdAllocIndicator {
	fn default() -> Self {
...
impl Default for RemunerationIndicator {
	fn default() -> Self {
		RemunerationIndicator::NoRemunerationPaid
	}
}
