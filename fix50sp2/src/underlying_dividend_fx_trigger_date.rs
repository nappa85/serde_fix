...
pub struct UnderlyingDividendFXTriggerDate {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42850")]
	pub underlying_dividend_fx_trigger_date_unadjusted: Option<fix_common::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42852")]
	pub underlying_dividend_fx_trigger_date_adjusted: Option<fix_common::LocalMktDate>,
}
