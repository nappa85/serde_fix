...
pub struct Leg {
	...
	/// Provide if different from the value specified for the overall multileg security in CoveredOrUncovered(203) in the Instrument
	/// component.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "565")]
	...
	/// Takes precedence over a calculated LegSettlType(587) when specified regardless of LegSettlType(587) value. Conditionally required
	/// when LegSettlType(587) = B(Broken date).
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "588")]
	...
	/// For FX Futures can be used to express the notional value of a trade when LegLastQty(1418) and other quantity fields are expressed
	...
	/// Quantity execution for this leg.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "1418")]
	...
	#[serde(default)]
	#[serde(rename = "2358")]
	pub leg_last_multiplied_qty: Option<f64>,
	/// LegTotalTradeQty
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2357")]
	pub leg_total_trade_qty: Option<f64>,
	/// LegTotalTradeMultipliedQty
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2360")]
	pub leg_total_trade_multiplied_qty: Option<f64>,
	/// LegTotalGrossTradeAmt
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2359")]
	pub leg_total_gross_trade_amt: Option<f64>,
	/// LegDifferentialPrice
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2492")]
	pub leg_differential_price: Option<f64>,
	/// LegAccount
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2680")]
	pub leg_account: Option<String>,
	/// Provide if different from the value specified for the overall multileg security in ClearingAccountType(1816) in the Instrument
	/// component.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1817")]
