...
pub struct LegComplexEventPeriodDateGrp {
	...
	#[serde(rename = "41376")]
	pub leg_complex_event_period_date_times: Option<fix_common::RepeatingValues<LegComplexEventPeriodDateTime>>,
}
...
pub struct LegComplexEventPeriodDateTime {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41377")]
	pub leg_complex_event_period_date: Option<fix_common::LocalMktDate>,
