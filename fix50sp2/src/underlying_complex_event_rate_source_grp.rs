...
impl Default for UnderlyingComplexEventRateSourceItem {
	fn default() -> Self {
		UnderlyingComplexEventRateSourceItem::Bloomberg
	}
}
...
impl Default for UnderlyingComplexEventRateSourceType {
	fn default() -> Self {
		UnderlyingComplexEventRateSourceType::Primary
	}
}
