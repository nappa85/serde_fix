...
pub struct PaymentStreamFinalPricePaymentDate {
	...
	#[serde(rename = "42654")]
	pub payment_stream_final_price_payment_date_unadjusted: Option<crate::entities::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42659")]
	pub payment_stream_final_price_payment_date_adjusted: Option<crate::entities::LocalMktDate>,
}
