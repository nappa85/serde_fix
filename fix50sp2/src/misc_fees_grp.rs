...
pub struct MiscFee {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2712")]
	pub misc_fee_qualifier: Option<MiscFeeQualifier>,
	/// MiscFeeDesc
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2713")]
	pub misc_fee_desc: Option<String>,
}
...
pub enum MiscFeeType {
	...
	#[serde(rename = "25")]
	OrderOrQuoteEntryFee,
	/// Order or quote modification fee
	#[serde(rename = "26")]
	OrderOrQuoteModificationFee,
	/// Orders or quote cancellation fee
	#[serde(rename = "27")]
	OrdersOrQuoteCancellationFee,
