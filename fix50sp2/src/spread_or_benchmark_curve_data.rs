...
pub struct SpreadOrBenchmarkCurveData {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "220")]
	pub benchmark_curve_currency: Option<BenchmarkCurveCurrency>,
	/// BenchmarkCurveName
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "221")]
	...
	/// Must be present if <a href="tag_662_BenchmarkPrice.html" target="bottom">BenchmarkPrice&nbsp;(662)</a> is used.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "663")]
	pub benchmark_price_type: Option<BenchmarkPriceType>,
	/// The identifier of the benchmark security, e.g. Treasury against Corporate bond.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "699")]
	pub benchmark_security_id: Option<String>,
	/// Source of BenchmarkSecurityID. If not specified, then ID Source is understood to be the same as that in the <a href="block_Instrument.html" target="main">Instrument</a> block.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "761")]
...
pub enum BenchmarkCurveName {
	...
	Libor,
	/// MuniAAA
	#[serde(rename = "MuniAAA")]
	MuniAaa,
	/// OTHER
	#[serde(rename = "OTHER")]
	Other,
	/// Pfandbriefe
	#[serde(rename = "Pfandbriefe")]
	Pfandbriefe,
	/// SONIA
	#[serde(rename = "SONIA")]
	Sonia,
	...
	#[serde(rename = "FEDEFF")]
	UsFederalReserveFedFundsEffectiveRate,
	/// US fed funds target rate
	#[serde(rename = "FEDOPEN")]
	UsFedFundsTargetRate,
	/// Euro Interbank Offer Rate
	#[serde(rename = "EURIBOR")]
	EuroInterbankOfferRate,
	/// Australian Bank Bill Swap Rate
	#[serde(rename = "AUBSW")]
	AustralianBankBillSwapRate,
	/// Budapest Bank Offered Rate
	#[serde(rename = "BUBOR")]
	BudapestBankOfferedRate,
	/// Canadian Dollar Offered Rate
	#[serde(rename = "CDOR")]
	CanadianDollarOfferedRate,
	/// Copenhagen Interbank Offered Rate
	#[serde(rename = "CIBOR")]
	CopenhagenInterbankOfferedRate,
	/// Euro Overnight Index Average Swap Rate
	#[serde(rename = "EONIASWAP")]
	EuroOvernightIndexAverageSwapRate,
	/// Euro Short Term Rate
	#[serde(rename = "ESTR")]
	EuroShortTermRate,
	/// Euro Dollar Rate
	#[serde(rename = "EURODOLLAR")]
	EuroDollarRate,
	/// Euro Swiss Franc Rate
	#[serde(rename = "EUROSWISS")]
	EuroSwissFrancRate,
	/// DTCC General Collateral Finance Repo Index
	#[serde(rename = "GCFREPO")]
	DtccGeneralCollateralFinanceRepoIndex,
	/// ICE Swap Rate
	#[serde(rename = "ISDAFIX")]
	IceSwapRate,
	/// Johannesburg Interbank Agreed Rate
	#[serde(rename = "JIBAR")]
	JohannesburgInterbankAgreedRate,
	/// Moscow Prime Offered Rate
	#[serde(rename = "MOSPRIM")]
	MoscowPrimeOfferedRate,
	/// Nigeria Three Month Interbank Rate
	#[serde(rename = "NIBOR")]
	NigeriaThreeMonthInterbankRate,
	/// Czech Republic Interbank Offered Rate
	#[serde(rename = "PRIBOR")]
	CzechRepublicInterbankOfferedRate,
	/// Secured Overnight Financing Rate
	#[serde(rename = "SOFR")]
	SecuredOvernightFinancingRate,
	/// Stockholm Interbank Offered Rate
	#[serde(rename = "STIBOR")]
	StockholmInterbankOfferedRate,
	/// Bank of Israel Interbank Offered Rate
	#[serde(rename = "TELBOR")]
	BankOfIsraelInterbankOfferedRate,
