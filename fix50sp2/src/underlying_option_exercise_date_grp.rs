...
pub struct UnderlyingOptionExerciseDateGrp {
	...
	#[serde(rename = "41841")]
	pub underlying_option_exercise_dates: Option<crate::entities::RepeatingValues<UnderlyingOptionExerciseDate>>,
}
...
pub struct UnderlyingOptionExerciseDate {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41842")]
	pub underlying_option_exercise_date: Option<crate::entities::LocalMktDate>,
