...
pub struct StreamCommoditySettlPeriodGrp {
	/// NoStreamCommoditySettlPeriods
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41289")]
	pub stream_commodity_settl_periods: Option<crate::entities::RepeatingValues<StreamCommoditySettlPeriod>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct StreamCommoditySettlPeriod {
	/// Required if NoStreamCommoditySettlPeriods(41289) &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41290")]
	pub stream_commodity_settl_country: Option<String>,
	/// StreamCommoditySettlTimeZone
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41291")]
	pub stream_commodity_settl_time_zone: Option<String>,
	/// StreamCommoditySettlFlowType
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41292")]
	pub stream_commodity_settl_flow_type: Option<StreamCommoditySettlFlowType>,
	/// StreamCommoditySettlPeriodNotional
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "crate::entities::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "41293")]
	pub stream_commodity_settl_period_notional: Option<f64>,
	/// StreamCommoditySettlPeriodNotionalUnitOfMeasure
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41294")]
	pub stream_commodity_settl_period_notional_unit_of_measure: Option<StreamCommoditySettlPeriodNotionalUnitOfMeasure>,
	/// Conditionally required when StreamCommoditySettlFrequencyUnit(41296) is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "crate::entities::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "41295")]
	pub stream_commodity_settl_period_frequency_period: Option<i32>,
	/// Conditionally required when StreamCommoditySettlFrequencyPeriod(41295) is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41296")]
	pub stream_commodity_settl_period_frequency_unit: Option<StreamCommoditySettlPeriodFrequencyUnit>,
	/// StreamCommoditySettlPeriodPrice
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "crate::entities::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "41297")]
	pub stream_commodity_settl_period_price: Option<f64>,
	/// StreamCommoditySettlPeriodPriceUnitOfMeasure
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41298")]
	pub stream_commodity_settl_period_price_unit_of_measure: Option<StreamCommoditySettlPeriodPriceUnitOfMeasure>,
	/// StreamCommoditySettlPeriodPriceCurrency
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41299")]
	pub stream_commodity_settl_period_price_currency: Option<String>,
	/// StreamCommoditySettlHolidaysProcessingInstruction
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41300")]
	pub stream_commodity_settl_holidays_processing_instruction: Option<StreamCommoditySettlHolidaysProcessingInstruction>,
	/// StreamCommoditySettlPeriodXID
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41301")]
	pub stream_commodity_settl_period_xid: Option<String>,
	/// StreamCommoditySettlPeriodXIDRef
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41302")]
	pub stream_commodity_settl_period_xid_ref: Option<String>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum StreamCommoditySettlFlowType {
	/// All times
	#[serde(rename = "0")]
	N0,
	/// On peak
...
#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum StreamCommoditySettlPeriodPriceUnitOfMeasure {
	/// Barrels
	#[serde(rename = "Bbl")]
	Bbl,
	/// Billion cubic feet
