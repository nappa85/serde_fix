...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct RequestingPartyID {
	/// <p>Required when <a href="tag_1657_NoRequestingPartyIDs.html" target="bottom">NoRequestingPartyIDs (1657)&nbsp;(1657)</a> &gt; 0
	/// </p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1658")]
	pub requesting_party_id: Option<String>,
	/// <p>Required when <a href="tag_1657_NoRequestingPartyIDs.html" target="bottom">NoRequestingPartyIDs (1657)&nbsp;(1657)</a> &gt; 0
	/// </p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1659")]
	pub requesting_party_id_source: Option<RequestingPartyIDSource>,
	/// <p>Required when <a href="tag_1657_NoRequestingPartyIDs.html" target="bottom">NoRequestingPartyIDs (1657)&nbsp;(1657)</a> &gt; 0
	/// </p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1660")]
...
impl Default for RequestingPartyIDSource {
	fn default() -> Self {
		RequestingPartyIDSource::BicCode
	}
}
...
impl Default for RequestingPartyRole {
	fn default() -> Self {
		RequestingPartyRole::ExecutingFirm
	}
}
