...
pub struct PaymentStreamResetDates {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40773")]
	pub payment_stream_initial_fixing_date_adjusted: Option<crate::entities::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40780")]
	pub payment_stream_fixing_date_adjusted: Option<crate::entities::LocalMktDate>,
