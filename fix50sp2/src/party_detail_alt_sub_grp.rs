...
pub struct PartyDetailAltSubGrp {
	/// NoPartyDetailAltSubIDs
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1519")]
	pub party_detail_alt_sub_i_ds: Option<fix_common::RepeatingValues<PartyDetailAltSubID>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PartyDetailAltSubID {
	/// <p>Required when NoPartyAltSubIDs &gt; 0</p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1520")]
	pub party_detail_alt_sub_id: Option<String>,
	/// <p>Required when NoPartyAltSubIDs &gt; 0</p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1521")]
...
impl Default for PartyDetailAltSubIDType {
	fn default() -> Self {
		PartyDetailAltSubIDType::N1
	}
}
