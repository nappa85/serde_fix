...
pub struct RelatedPartyDetailSubGrp {
	/// NoRelatedPartyDetailSubIDs
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1566")]
	pub related_party_detail_sub_i_ds: Option<fix_common::RepeatingValues<RelatedPartyDetailSubID>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct RelatedPartyDetailSubID {
	/// <p>Required when <a href="tag_1566_NoRelatedPartyDetailSubIDs.html" target="bottom">NoRelatedPartyDetailSubIDs (1566)&nbsp;(1566)</a> &gt; 0
	/// </p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1567")]
	pub related_party_detail_sub_id: Option<String>,
	/// <p>Required when <a href="tag_1566_NoRelatedPartyDetailSubIDs.html" target="bottom">NoRelatedPartyDetailSubIDs (1566)&nbsp;(1566)</a> &gt; 0
	/// </p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1568")]
	pub related_party_detail_sub_id_type: Option<RelatedPartyDetailSubIDType>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum RelatedPartyDetailSubIDType {
	/// Firm
	#[serde(rename = "1")]
	N1,
	/// Person
...
impl Default for RelatedPartyDetailSubIDType {
	fn default() -> Self {
		RelatedPartyDetailSubIDType::N1
	}
}
