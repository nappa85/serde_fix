...
pub struct PartyDetailGrp {
	/// NoPartyDetails
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1671")]
	pub party_details: Option<crate::entities::RepeatingValues<PartyDetail>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PartyDetail {
	/// The identification of the party. Required when NoPartyDetails &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1691")]
	pub party_detail_id: Option<String>,
	/// Used to identify source of PartyID value (e.g. BIC). Required when NoPartyDetails &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1692")]
	pub party_detail_id_source: Option<PartyDetailIDSource>,
	/// Identifies the type of PartyID (e.g. Executing Broker). Required when NoPartyDetails &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1693")]
	pub party_detail_role: Option<PartyDetailRole>,
	/// PartyDetailRoleQualifier
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1674")]
	pub party_detail_role_qualifier: Option<PartyDetailRoleQualifier>,
	/// PartyDetailStatus
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1672")]
