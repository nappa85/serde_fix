...
pub struct UnderlyingProvisionCashSettlValueDateBusinessCenterGrp {
	...
	#[serde(rename = "42182")]
	pub underlying_provision_cash_settl_value_date_business_centers: Option<crate::entities::RepeatingValues<UnderlyingProvisionCashSettlValueDateBusinessCenter>>,
}
