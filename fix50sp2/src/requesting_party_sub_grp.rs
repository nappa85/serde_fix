...
pub struct RequestingPartySubGrp {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct RequestingPartySubID {
	/// <p>Required when <a href="tag_1661_NoRequestingPartySubIDs.html" target="bottom">NoRequestingPartySubIDs (1661)&nbsp;(1661)</a> &gt; 0
	/// </p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1662")]
	pub requesting_party_sub_id: Option<String>,
	/// <p>Required when <a href="tag_1661_NoRequestingPartySubIDs.html" target="bottom">NoRequestingPartySubIDs (1661)&nbsp;(1661)</a> &gt; 0
	/// </p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1663")]
	pub requesting_party_sub_id_type: Option<RequestingPartySubIDType>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum RequestingPartySubIDType {
	/// Firm
	#[serde(rename = "1")]
	N1,
	/// Person
