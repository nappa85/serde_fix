...
pub struct DividendPeriodGrp {
	...
	#[serde(rename = "42274")]
	pub dividend_periods: Option<crate::entities::RepeatingValues<DividendPeriod>>,
}
...
pub struct DividendPeriod {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42276")]
	pub dividend_period_start_date_unadjusted: Option<crate::entities::LocalMktDate>,
	/// DividendPeriodEndDateUnadjusted
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42277")]
	pub dividend_period_end_date_unadjusted: Option<crate::entities::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42281")]
	pub dividend_period_valuation_date_unadjusted: Option<crate::entities::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42286")]
	pub dividend_period_valuation_date_adjusted: Option<crate::entities::LocalMktDate>,
	/// DividendPeriodPaymentDateUnadjusted
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42287")]
	pub dividend_period_payment_date_unadjusted: Option<crate::entities::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42292")]
	pub dividend_period_payment_date_adjusted: Option<crate::entities::LocalMktDate>,
	/// DividendPeriodXID
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42293")]
