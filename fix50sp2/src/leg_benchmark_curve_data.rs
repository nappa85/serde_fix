...
pub struct LegBenchmarkCurveData {
	...
	#[serde(rename = "676")]
	pub leg_benchmark_curve_currency: Option<LegBenchmarkCurveCurrency>,
	/// LegBenchmarkCurveName
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "677")]
	pub leg_benchmark_curve_name: Option<LegBenchmarkCurveName>,
	/// LegBenchmarkCurvePoint
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "678")]
	pub leg_benchmark_curve_point: Option<String>,
	/// LegBenchmarkPrice
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "679")]
	pub leg_benchmark_price: Option<f64>,
