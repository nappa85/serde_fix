...
pub struct LegDividendPeriodGrp {
	...
	#[serde(rename = "42366")]
	pub leg_dividend_periods: Option<fix_common::RepeatingValues<LegDividendPeriod>>,
}
...
pub struct LegDividendPeriod {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42368")]
	pub leg_dividend_period_start_date_unadjusted: Option<fix_common::LocalMktDate>,
	/// LegDividendPeriodEndDateUnadjusted
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42369")]
	pub leg_dividend_period_end_date_unadjusted: Option<fix_common::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42373")]
	pub leg_dividend_period_valuation_date_unadjusted: Option<fix_common::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42378")]
	pub leg_dividend_period_valuation_date_adjusted: Option<fix_common::LocalMktDate>,
	/// LegDividendPeriodPaymentDateUnadjusted
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42379")]
	pub leg_dividend_period_payment_date_unadjusted: Option<fix_common::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42384")]
	pub leg_dividend_period_payment_date_adjusted: Option<fix_common::LocalMktDate>,
