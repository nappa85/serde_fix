...
pub struct UnderlyingReturnRateValuationDateGrp {
	...
	#[serde(rename = "43071")]
	pub underlying_return_rate_valuation_dates: Option<fix_common::RepeatingValues<UnderlyingReturnRateValuationDate>>,
}
...
pub struct UnderlyingReturnRateValuationDate {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "43072")]
	pub underlying_return_rate_valuation_date: Option<fix_common::LocalMktDate>,
