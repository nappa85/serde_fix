...
pub struct PaymentStreamCompoundingDates {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42618")]
	pub payment_stream_bounds_first_date_unadjusted: Option<crate::entities::LocalMktDate>,
	/// PaymentStreamBoundsLastDateUnadjusted
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42619")]
	pub payment_stream_bounds_last_date_unadjusted: Option<crate::entities::LocalMktDate>,
}
