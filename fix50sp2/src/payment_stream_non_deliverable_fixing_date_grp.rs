...
pub struct PaymentStreamNonDeliverableFixingDateGrp {
	...
	#[serde(rename = "40825")]
	pub non_deliverable_fixing_dates: Option<crate::entities::RepeatingValues<NonDeliverableFixingDate>>,
}
...
pub struct NonDeliverableFixingDate {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40826")]
	pub non_deliverable_fixing_date: Option<crate::entities::LocalMktDate>,
