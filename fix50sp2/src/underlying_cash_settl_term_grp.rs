...
pub struct UnderlyingCashSettlTermGrp {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct UnderlyingCashSettlTerm {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42046")]
	pub underlying_cash_settl_valuation_time: Option<String>,
	/// UnderlyingCashSettlBusinessCenter
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42047")]
	pub underlying_cash_settl_business_center: Option<String>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42058")]
	pub underlying_cash_settl_valuation_method: Option<UnderlyingCashSettlValuationMethod>,
	/// UnderlyingCashSettlTermXID
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42059")]
	pub underlying_cash_settl_term_xid: Option<String>,
