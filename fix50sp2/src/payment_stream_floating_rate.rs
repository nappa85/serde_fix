...
pub struct PaymentStreamFloatingRate {
	/// PaymentStreamRateIndex
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40789")]
	pub payment_stream_rate_index: Option<String>,
	/// PaymentStreamRateIndexSource
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40790")]
	pub payment_stream_rate_index_source: Option<PaymentStreamRateIndexSource>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40795")]
	pub payment_stream_rate_spread_position_type: Option<PaymentStreamRateSpreadPositionType>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40806")]
	pub payment_stream_averaging_method: Option<PaymentStreamAveragingMethod>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40809")]
	pub payment_stream_inflation_lag_unit: Option<PaymentStreamInflationLagUnit>,
	/// PaymentStreamInflationLagDayType
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40810")]
	pub payment_stream_inflation_lag_day_type: Option<PaymentStreamInflationLagDayType>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41195")]
	pub payment_stream_rate_index_curve_unit_2: Option<PaymentStreamRateIndexCurveUnit2>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41198")]
	pub payment_stream_rate_index_unit_of_measure: Option<PaymentStreamRateIndexUnitOfMeasure>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41201")]
	pub payment_stream_reference_level_unit_of_measure: Option<PaymentStreamReferenceLevelUnitOfMeasure>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41203")]
	pub payment_stream_rate_spread_currency: Option<PaymentStreamRateSpreadCurrency>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41212")]
	pub payment_stream_first_observation_date_offset_unit: Option<PaymentStreamFirstObservationDateOffsetUnit>,
	/// PaymentStreamPricingDayType
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41213")]
	pub payment_stream_pricing_day_type: Option<PaymentStreamPricingDayType>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41216")]
	pub payment_stream_pricing_business_calendar: Option<String>,
	/// PaymentStreamPricingBusinessDayConvention
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41217")]
	pub payment_stream_pricing_business_day_convention: Option<PaymentStreamPricingBusinessDayConvention>,
	/// PaymentStreamPricingBusinessCenterGrp
	#[serde(flatten)]
	pub payment_stream_pricing_business_center_grp: Option<super::payment_stream_pricing_business_center_grp::PaymentStreamPricingBusinessCenterGrp>,
	/// PaymentStreamPricingDayGrp
	#[serde(flatten)]
	pub payment_stream_pricing_day_grp: Option<super::payment_stream_pricing_day_grp::PaymentStreamPricingDayGrp>,
	/// PaymentStreamPricingDateGrp
	#[serde(flatten)]
	pub payment_stream_pricing_date_grp: Option<super::payment_stream_pricing_date_grp::PaymentStreamPricingDateGrp>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42667")]
	pub payment_stream_underlier_ref_id: Option<String>,
	/// PaymentStreamFormula
	#[serde(flatten)]
	pub payment_stream_formula: Option<super::payment_stream_formula::PaymentStreamFormula>,
	/// DividendConditions
	#[serde(flatten)]
	pub dividend_conditions: Option<super::dividend_conditions::DividendConditions>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42679")]
	pub payment_stream_realized_variance_method: Option<PaymentStreamRealizedVarianceMethod>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "43090")]
	pub payment_stream_rate_index_id: Option<String>,
	/// Conditionally required when PaymentStreamRateIndexID(43090) is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "43091")]
	pub payment_stream_rate_index_id_source: Option<String>,
}

#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum PaymentStreamRateIndexSource {
	/// Bloomberg
	#[serde(rename = "0")]
	Bloomberg,
	/// Reuters
...
#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum PaymentStreamRateTreatment {
...
#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum PaymentStreamFloorRateBuySide {
	/// Buyer of the trade
	#[serde(rename = "1")]
	BuyerOfTheTrade,
	/// Seller of the trade
...
#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum PaymentStreamInflationLagUnit {
	/// Day
	#[serde(rename = "D")]
	Day,
	/// Week
...
#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum PaymentStreamInflationLagDayType {
	/// Business
	#[serde(rename = "0")]
	Business,
	/// Calendar
...
#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum PaymentStreamFRADiscounting {
	/// None
	#[serde(rename = "0")]
	None,
...
#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum PaymentStreamRateIndexCurveUnit2 {
	/// Day
	#[serde(rename = "D")]
	Day,
	/// Week
...
#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum PaymentStreamRateIndexUnitOfMeasure {
	/// Barrels
	#[serde(rename = "Bbl")]
	Bbl,
	/// Billion cubic feet
...
#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum PaymentStreamReferenceLevelUnitOfMeasure {
	/// Barrels
	#[serde(rename = "Bbl")]
	Bbl,
	/// Billion cubic feet
...
#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum PaymentStreamRateSpreadCurrency {
	/// Afghani
	#[serde(rename = "AFA")]
	Afa,
	/// Algerian Dinar
...
#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum PaymentStreamCalculationLagUnit {
	/// Day
	#[serde(rename = "D")]
	Day,
	/// Week
...
#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum PaymentStreamPricingDayType {
	/// Business
	#[serde(rename = "0")]
	Business,
	/// Calendar
...
#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum PaymentStreamPricingBusinessDayConvention {
	/// Not applicable
	#[serde(rename = "0")]
	NotApplicable,
	/// None (current day)
...
#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum PaymentStreamRealizedVarianceMethod {
	/// Previous
	#[serde(rename = "0")]
	Previous,
	/// Last
