...
pub struct PartyDetailSubGrp {
	/// NoPartyDetailSubIDs
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1694")]
	pub party_detail_sub_i_ds: Option<crate::entities::RepeatingValues<PartyDetailSubID>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PartyDetailSubID {
	/// <p>Required when <a href="tag_1694_NoPartyDetailSubIDs.html" target="bottom">NoPartyDetailSubIDs (1694)&nbsp;(1694)</a> &gt; 0
	/// </p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1695")]
	pub party_detail_sub_id: Option<String>,
	/// <p>Required when <a href="tag_1694_NoPartyDetailSubIDs.html" target="bottom">NoPartyDetailSubIDs (1694)&nbsp;(1694)</a> &gt; 0
	/// </p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1696")]
	pub party_detail_sub_id_type: Option<PartyDetailSubIDType>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum PartyDetailSubIDType {
	/// Firm
	#[serde(rename = "1")]
	N1,
	/// Person
