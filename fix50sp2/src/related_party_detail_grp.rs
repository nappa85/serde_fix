...
pub struct RelatedPartyDetailGrp {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct RelatedPartyDetailID {
	/// <p>Required when <a href="tag_1562_NoRelatedPartyDetailIDs.html" target="bottom">NoRelatedPartyDetailIDs (1562)&nbsp;(1562)</a> &gt; 0
	/// </p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1563")]
	pub related_party_detail_id: Option<String>,
	/// <p>Required when <a href="tag_1562_NoRelatedPartyDetailIDs.html" target="bottom">NoRelatedPartyDetailIDs (1562)&nbsp;(1562)</a> &gt; 0
	/// </p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1564")]
	pub related_party_detail_id_source: Option<RelatedPartyDetailIDSource>,
	/// <p>Required when <a href="tag_1562_NoRelatedPartyDetailIDs.html" target="bottom">NoRelatedPartyDetailIDs (1562)&nbsp;(1562)</a> &gt; 0
	/// </p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1565")]
	pub related_party_detail_role: Option<RelatedPartyDetailRole>,
...
impl Default for RelatedPartyDetailIDSource {
	fn default() -> Self {
		RelatedPartyDetailIDSource::BicCode
	}
}
...
impl Default for RelatedPartyDetailRole {
	fn default() -> Self {
		RelatedPartyDetailRole::ExecutingFirm
	}
}
...
impl Default for RelatedPartyDetailRoleQualifier {
	fn default() -> Self {
		RelatedPartyDetailRoleQualifier::Agency
	}
}
