...
pub struct LegAlloc {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1756")]
	pub leg_custodial_lot_id: Option<String>,
	...
	/// for specific lot trades. If this field is used, either LegVersusPurchasePrice(1758) or LegCurrentCostBasis(1759) should be
	/// specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1757")]
