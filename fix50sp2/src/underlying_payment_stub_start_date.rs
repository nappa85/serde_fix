...
pub struct UnderlyingPaymentStubStartDate {
	...
	#[serde(rename = "42993")]
	pub underlying_payment_stub_start_date_unadjusted: Option<crate::entities::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42999")]
	pub underlying_payment_stub_start_date_adjusted: Option<crate::entities::LocalMktDate>,
}
