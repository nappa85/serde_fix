...
pub struct UnderlyingPaymentScheduleFixingDayGrp {
	...
	#[serde(rename = "41878")]
	pub underlying_payment_schedule_fixing_days: Option<fix_common::RepeatingValues<UnderlyingPaymentScheduleFixingDay>>,
}
...
impl Default for UnderlyingPaymentScheduleFixingDayOfWeek {
	fn default() -> Self {
		UnderlyingPaymentScheduleFixingDayOfWeek::EveryDay
	}
}
