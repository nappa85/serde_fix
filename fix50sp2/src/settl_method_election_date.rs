...
pub struct SettlMethodElectionDate {
	...
	#[serde(rename = "42777")]
	pub settl_method_election_date_unadjusted: Option<crate::entities::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42783")]
	pub settl_method_election_date_adjusted: Option<crate::entities::LocalMktDate>,
}
