...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct TargetPartySubID {
	/// TargetPartySubID
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2434")]
	pub target_party_sub_id: Option<String>,
	/// TargetPartySubIDType
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2435")]
	pub target_party_sub_id_type: Option<TargetPartySubIDType>,
}

#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum TargetPartySubIDType {
	/// Firm
	#[serde(rename = "1")]
	N1,
	/// Person
...
impl Default for TargetPartySubIDType {
	fn default() -> Self {
		TargetPartySubIDType::N1
	}
}
