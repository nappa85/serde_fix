...
pub struct LegPaymentStreamFinalPricePaymentDate {
	...
	#[serde(rename = "42453")]
	pub leg_payment_stream_final_price_payment_date_unadjusted: Option<crate::entities::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42458")]
	pub leg_payment_stream_final_price_payment_date_adjusted: Option<crate::entities::LocalMktDate>,
}
