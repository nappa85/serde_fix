...
pub struct UnderlyingProtectionTermGrp {
...
pub struct UnderlyingProtectionTerm {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42070")]
	pub underlying_protection_term_currency: Option<UnderlyingProtectionTermCurrency>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42073")]
	pub underlying_protection_term_event_business_center: Option<String>,
