...
pub struct PaymentStreamCompoundingStartDate {
	...
	#[serde(rename = "42646")]
	pub payment_stream_compounding_start_date_unadjusted: Option<crate::entities::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42651")]
	pub payment_stream_compounding_start_date_adjusted: Option<crate::entities::LocalMktDate>,
}
