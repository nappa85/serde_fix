...
pub struct LegInstrumentPtysSubGrp {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct LegInstrumentPartySubID {
	/// Required if NoLegInstrumentPartySubIDs(2258) &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2259")]
	pub leg_instrument_party_sub_id: Option<String>,
	/// LegInstrumentPartySubIDType
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2260")]
	pub leg_instrument_party_sub_id_type: Option<LegInstrumentPartySubIDType>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum LegInstrumentPartySubIDType {
	/// Firm
	#[serde(rename = "1")]
	N1,
	/// Person
