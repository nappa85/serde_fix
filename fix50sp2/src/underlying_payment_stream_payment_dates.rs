...
pub struct UnderlyingPaymentStreamPaymentDates {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40586")]
	pub underlying_payment_stream_first_payment_date_unadjusted: Option<crate::entities::LocalMktDate>,
	/// UnderlyingPaymentStreamLastRegularPaymentDateUnadjusted
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40587")]
	pub underlying_payment_stream_last_regular_payment_date_unadjusted: Option<crate::entities::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41940")]
	pub underlying_payment_stream_master_agreement_payment_dates_indicator: Option<crate::entities::Boolean>,
