...
pub struct UnderlyingPaymentScheduleInterimExchangeDateBusinessCenterGrp {
	...
	#[serde(rename = "40967")]
	pub underlying_payment_schedule_interim_exchange_date_business_centers: Option<fix_common::RepeatingValues<UnderlyingPaymentScheduleInterimExchangeDateBusinessCenter>>,
}
