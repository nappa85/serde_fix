...
pub struct LegPaymentStreamCompoundingDateGrp {
	...
	#[serde(rename = "42405")]
	pub leg_payment_stream_compounding_dates: Option<crate::entities::RepeatingValues<LegPaymentStreamCompoundingDate>>,
}
...
pub struct LegPaymentStreamCompoundingDate {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42406")]
	pub leg_payment_stream_compounding_date: Option<crate::entities::LocalMktDate>,
