...
pub struct UnderlyingPaymentStreamFinalPricePaymentDate {
	...
	#[serde(rename = "42949")]
	pub underlying_payment_stream_final_price_payment_date_unadjusted: Option<crate::entities::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42954")]
	pub underlying_payment_stream_final_price_payment_date_adjusted: Option<crate::entities::LocalMktDate>,
}
