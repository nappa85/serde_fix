...
pub struct UnderlyingPaymentStubEndDate {
	...
	#[serde(rename = "42984")]
	pub underlying_payment_stub_end_date_unadjusted: Option<crate::entities::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42990")]
	pub underlying_payment_stub_end_date_adjusted: Option<crate::entities::LocalMktDate>,
}
