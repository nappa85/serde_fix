...
pub struct LegPaymentStreamNonDeliverableSettlRateSource {
	/// LegPaymentStreamNonDeliverableSettlRateSource
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40087")]
	pub leg_payment_stream_non_deliverable_settl_rate_source_item: Option<LegPaymentStreamNonDeliverableSettlRateSourceItem>,
