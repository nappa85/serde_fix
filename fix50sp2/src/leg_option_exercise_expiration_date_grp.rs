...
pub struct LegOptionExerciseExpirationDateGrp {
	...
	#[serde(rename = "41527")]
	pub leg_option_exercise_expiration_dates: Option<crate::entities::RepeatingValues<LegOptionExerciseExpirationDate>>,
}
...
pub struct LegOptionExerciseExpirationDate {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41528")]
	pub leg_option_exercise_expiration_date: Option<crate::entities::LocalMktDate>,
