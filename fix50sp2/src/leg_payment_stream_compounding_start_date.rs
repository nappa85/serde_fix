...
pub struct LegPaymentStreamCompoundingStartDate {
	...
	#[serde(rename = "42445")]
	pub leg_payment_stream_compounding_start_date_unadjusted: Option<fix_common::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42450")]
	pub leg_payment_stream_compounding_start_date_adjusted: Option<fix_common::LocalMktDate>,
}
