...
pub struct UndlyInstrumentParties {
	...
	#[serde(rename = "1058")]
	pub undly_instrument_parties: Option<fix_common::RepeatingValues<UndlyInstrumentPartie>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct UndlyInstrumentPartie {
	/// Used to identify the source of PartyID. Required if UnderlyingInstrumentPartyIDSource(1060) is specified. Required if NoUndlyInstrumentParties(1058)
	/// &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1059")]
	pub underlying_instrument_party_id: Option<String>,
	/// Used to identify class source of UnderlyingInstrumentPartyID(1059) value (e.g. BIC). Required if UnderlyingInstrumentPartyID(1059)
	/// is specified. Required if NoUndlyInstrumentParties(1058) &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1060")]
	pub underlying_instrument_party_id_source: Option<UnderlyingInstrumentPartyIDSource>,
	/// Identifies the type of UnderlyingInstrumentPartyID(1059) (e.g. Executing Broker). Required if NoUndlyInstrumentParties(1058)
	/// &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1061")]
	pub underlying_instrument_party_role: Option<UnderlyingInstrumentPartyRole>,
...
impl Default for UnderlyingInstrumentPartyIDSource {
	fn default() -> Self {
		UnderlyingInstrumentPartyIDSource::BicCode
	}
}
...
impl Default for UnderlyingInstrumentPartyRole {
	fn default() -> Self {
		UnderlyingInstrumentPartyRole::ExecutingFirm
	}
}
