...
pub struct UnderlyingProtectionTermEventGrp {
...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct UnderlyingProtectionTermEvent {
	/// Required if NoUnderlyingProtectionTermEvents (42078) &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42078")]
	pub underlying_protection_term_event_type: Option<String>,
	/// UnderlyingProtectionTermEventValue
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42079")]
	pub underlying_protection_term_event_value: Option<String>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42082")]
	pub underlying_protection_term_event_unit: Option<String>,
	/// UnderlyingProtectionTermEventDayType
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42083")]
	pub underlying_protection_term_event_day_type: Option<UnderlyingProtectionTermEventDayType>,
