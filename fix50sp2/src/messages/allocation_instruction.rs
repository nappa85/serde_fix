...
pub struct AllocationInstruction {
	...
	/// Conditionally required except when <a href="tag_71_AllocTransType.html" target="bottom">AllocTransType&nbsp;(71)</a> = Cancel, or when AllocType = "Ready-to-book" or "Warehouse instruction"
	#[serde(flatten)]
