...
pub struct PositionTransferInstruction {
	...
	/// <p>Conditionally required when responding to a Position <a href="message_Position_Transfer_Report_DN.html" target="main">TransferReport&nbsp;(DN)</a> message (e.g. when accepting or declining a transfer) or performing an action on a transfer (e.g. cancel or replace.
	/// </p>
	...
	#[serde(flatten)]
	pub target_parties: super::super::target_parties::TargetParties,
	/// <p>Business date the transfer would clear</p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "715")]
	pub clearing_business_date: Option<fix_common::LocalMktDate>,
	/// <p>Trade date associated with the position being transferred.</p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "75")]
	...
	/// <p>If not specified, indicates the transfer is for all instruments.</p>
	#[serde(flatten)]
	...
	/// <p>Position to transfer from the perspective of the source party prior to the transfer. If not specified, indicates transfer
	/// of all positions for an a specified instrument, if Instrument is specified, or transfer of all positions if no Instrument
	/// is not specified
	/// </p>
	#[serde(flatten)]
	pub position_qty: Option<super::super::position_qty::PositionQty>,
	/// <p>Price at which the position is transferred.</p>
	#[serde(skip_serializing_if = "Option::is_none")]
	...
	/// <p>Optionally used to include cash residuals, etc., viewed from the perspective of the source party prior to the transfer.</p>
	#[serde(flatten)]
