...
pub struct PositionReport {
	/// MsgType = AP
	#[serde(flatten)]
	pub standard_message_header: super::super::standard_message_header::StandardMessageHeader<'A', 'P'>,
	...
	/// Unique identifier for the Request for Positions associated with this report This field should not be provided if the report
	/// was sent unsolicited.
	...
	/// Account may also be specified through via <a href="block_Parties.html" target="main">Parties</a> Block using Party Role 27 which signifies Account
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1")]
	...
	/// Type of account associated with the order (Origin). <a href="tag_1_Account.html" target="bottom">Account&nbsp;(1)</a> may also be specified through via <a href="block_Parties.html" target="main">Parties</a> Block using Party Role 27 which signifies Account
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "581")]
	...
	/// Used to indicate if a <a href="message_Position_Report_AP.html" target="main">Position Report&nbsp;(AP)</a> is matched or unmatched
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "573")]
	...
	#[serde(flatten)]
	pub pos_und_instrmt_grp: Option<super::super::pos_und_instrmt_grp::PosUndInstrmtGrp>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1833")]
	pub contract_ref_pos_type: Option<ContractRefPosType>,
	/// PositionCapacity
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1834")]
	pub position_capacity: Option<PositionCapacity>,
	/// TransactTime
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "60")]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1886")]
	pub settl_price_unit_of_measure: Option<SettlPriceUnitOfMeasure>,
	/// SettlPriceUnitOfMeasureCurrency
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1887")]
	pub settl_price_unit_of_measure_currency: Option<SettlPriceUnitOfMeasureCurrency>,
...
pub enum PosReqResult {
	...
	/// Other (use <a href="tag_58_Text.html" target="bottom">Text&nbsp;(58)</a> in conjunction with this code for an explaination)
	#[serde(rename = "99")]
	OtherAInConjunctionWithThisCodeForAnExplaination,
}

impl Default for PosReqResult {
	fn default() -> Self {
...
impl Default for ModelType {
	fn default() -> Self {
		ModelType::UtilityProvidedStandardModel
	}
}
...
pub enum ContractRefPosType {
	...
	#[serde(rename = "0")]
	TwoComponentIntercommoditySpread,
	/// Index or basket
	#[serde(rename = "1")]
	IndexOrBasket,
	/// Two component locational basis
	#[serde(rename = "2")]
	TwoComponentLocationalBasis,
	/// Other
	#[serde(rename = "99")]
	Other,
}
...
impl Default for SettlPriceUnitOfMeasure {
	fn default() -> Self {
		SettlPriceUnitOfMeasure::Bbl
	}
}
...
impl Default for SettlPriceUnitOfMeasureCurrency {
	fn default() -> Self {
		SettlPriceUnitOfMeasureCurrency::Afa
	}
}
