...
pub struct Order {
	...
	/// The <a href="tag_11_ClOrdID.html" target="bottom">ClOrdID&nbsp;(11)</a> of the order whose status is being requested. Conditionally required if the <a href="tag_37_OrderID.html" target="bottom">OrderID(37)&nbsp;(37)</a> is not provided. Either OrderID or ClOrdID must be provided.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "11")]
