...
pub struct MarketDefinition {
	/// MsgType = BU
	#[serde(flatten)]
	pub standard_message_header: super::super::standard_message_header::StandardMessageHeader<'B', 'U'>,
	...
	#[serde(rename = "1394")]
	pub market_report_id: Option<String>,
	/// MarketReqID
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1393")]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2542")]
	pub market_segment_status: Option<MarketSegmentStatus>,
	/// Used to specify the purpose of a special market segment identified by MarketSegmentID(1300). Conditionally required if MarketSegmentSubType(2544)
	/// is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2543")]
	pub market_segment_type: Option<MarketSegmentType>,
	/// MarketSegmentSubType
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2544")]
	pub market_segment_sub_type: Option<MarketSegmentSubType>,
	...
	#[serde(flatten)]
	pub related_market_segment_grp: Option<super::super::related_market_segment_grp::RelatedMarketSegmentGrp>,
	/// Used to specify the auction order types that are valid for trading on the identified market or market segment.
	#[serde(flatten)]
	pub auction_type_rule_grp: Option<super::super::auction_type_rule_grp::AuctionTypeRuleGrp>,
	/// Used to specify the market data feed types that are valid for trading on the identified market or market segment.
	#[serde(flatten)]
	pub market_data_feed_types: Option<super::super::market_data_feed_types::MarketDataFeedTypes>,
	/// Used to specify the matching rules that are valid for trading on the identified market or market segment.
	#[serde(flatten)]
	pub match_rules: Option<super::super::match_rules::MatchRules>,
	/// Specifies the eligibility indicators for the creation of flexible securities.
	#[serde(flatten)]
	pub flex_product_eligibility_grp: Option<super::super::flex_product_eligibility_grp::FlexProductEligibilityGrp>,
