...
pub struct OrderCancelReplaceRequest {
	...
	/// Takes precedence over <a href="tag_63_SettlType.html" target="bottom">SettlType&nbsp;(63)</a> value and conditionally required/omitted for specific <a href="tag_63_SettlType.html" target="bottom">SettlType&nbsp;(63)</a> values. For NDFs either SettlType or SettlDate should be specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "64")]
	...
	/// Note: OrderQty(38) value should be the "Total Intended Order Quantity" (including the amount already executed for this chain
	/// of orders).
	#[serde(flatten)]
	...
	/// Required if <a href="tag_121_ForexReq.html" target="bottom">ForexReq&nbsp;(121)</a> = Y. Required for NDFs.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "120")]
...
impl Default for DuplicateClOrdIDIndicator {
	fn default() -> Self {
		DuplicateClOrdIDIndicator::UniqueClOrdId
	}
}
