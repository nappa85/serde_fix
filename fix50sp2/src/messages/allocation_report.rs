...
pub struct AllocationReport {
	...
	/// <p>Indicates how the orders being booked and allocated by an Allocation Instruction or Allocation Report message are identified,
	/// e.g. by explicit definition in the OrdAllocGrp or ExecAllocGrp components , or not identified explicitly.
	/// </p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "857")]
	...
	#[serde(rename = "54")]
	pub side: Side,
	/// Insert here the set of "Instrument" fields defined in "Common Components of Application Messages". For NDFs, fixing date (specified
	/// in <a href="tag_541_MaturityDate.html" target="bottom">MaturityDate(541)&nbsp;(541)</a> ) is required. Fixing time (specified in <a href="tag_1079_MaturityTime.html" target="bottom">MaturityTime(1079)&nbsp;(1079)</a> ) is optional.
	#[serde(flatten)]
	...
	/// For F/X orders, should be the "all-in" rate (spot rate adjusted for forward points), expressed in terms of <a href="tag_15_Currency.html" target="bottom">Currency(15)&nbsp;(15)</a> .
	#[serde(deserialize_with = "fix_common::workarounds::from_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(rename = "6")]
	pub avg_px: f64,
	/// AvgParPx
	...
	/// Takes precedence over <a href="tag_63_SettlType.html" target="bottom">SettlType&nbsp;(63)</a> value and conditionally required/omitted for specific <a href="tag_63_SettlType.html" target="bottom">SettlType&nbsp;(63)</a> values. Required for NDFs to specify the "value date".
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "64")]
	...
	/// Expressed in same currency as <a href="tag_6_AvgPx.html" target="bottom">AvgPx&nbsp;(6)</a> . ( <a href="tag_53_Quantity.html" target="bottom">Quantity&nbsp;(53)</a> * <a href="tag_6_AvgPx.html" target="bottom">AvgPx&nbsp;(6)</a> or <a href="tag_860_AvgParPx.html" target="bottom">AvgParPx&nbsp;(860)</a> ) or sum of ( <a href="tag_80_AllocQty.html" target="bottom">AllocQty&nbsp;(80)</a> * <a href="tag_153_AllocAvgPx.html" target="bottom">AllocAvgPx&nbsp;(153)</a> or <a href="tag_366_AllocPrice.html" target="bottom">AllocPrice&nbsp;(366)</a> ). For Fixed Income, <a href="tag_860_AvgParPx.html" target="bottom">AvgParPx&nbsp;(860)</a> is used when <a href="tag_6_AvgPx.html" target="bottom">AvgPx&nbsp;(6)</a> is not expressed as "percent of par" price.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "381")]
	...
	/// <p>Can be used for reporting on status of reversal transaction when <a href="tag_794_AllocReportType.html" target="bottom">AllocReportType(794)&nbsp;(794)</a> is 18 (Alleged reversal) or 17 (Reversal)
	/// </p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1738")]
	pub alloc_reversal_status: Option<AllocReversalStatus>,
	...
	/// Conditionally required when <a href="tag_2335_RefRiskLimitCheckIDType.html" target="bottom">RefRiskLimitCheckIDType(2335)&nbsp;(2335)</a> is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2334")]
	pub ref_risk_limit_check_id: Option<String>,
	/// Conditionally required when <a href="tag_2334_RefRiskLimitCheckID.html" target="bottom">RefRiskLimitCheckID(2334)&nbsp;(2334)</a> is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2335")]
	pub ref_risk_limit_check_id_type: Option<RefRiskLimitCheckIDType>,
	/// Used to identify on what kind of venue the trade originated when communicating with a party that may not have access to all
	/// trade details, e.g. a clearing organization.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1430")]
...
impl Default for AllocGroupStatus {
	fn default() -> Self {
		AllocGroupStatus::N0
	}
}
...
impl Default for AllocReversalStatus {
	fn default() -> Self {
