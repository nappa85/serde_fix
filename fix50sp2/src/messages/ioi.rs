...
pub struct IOI {
	...
	/// Side of Indication. Valid subset of values: 1 = Buy, 2 = Sell, 7 = Undisclosed, B = As Defined (for multilegs), C = Opposite
	/// (for multilegs)
	#[serde(rename = "54")]
	pub side: Side,
	/// QtyType
	...
	/// Insert here the set of "Instrument" fields defined in "Common Components of Application Messages". The value zero is used
	/// if <a href="tag_555_NoLegs.html" target="bottom">NoLegs&nbsp;(555)</a> repeating group is used. Applicable if needed to express <a href="tag_152_CashOrderQty.html" target="bottom">CashOrderQty (tag 152)&nbsp;(152)</a> .
	#[serde(flatten)]
	pub order_qty_data: Option<super::super::order_qty_data::OrderQtyData>,
	/// The value zero is used if <a href="tag_555_NoLegs.html" target="bottom">NoLegs&nbsp;(555)</a> repeating group is used
	#[serde(rename = "27")]
	pub ioi_qty: IOIQty,
	/// Currency
	#[serde(skip_serializing_if = "Option::is_none")]
	...
	#[serde(flatten)]
	pub instrmt_leg_ioi_grp: Option<super::super::instrmt_leg_ioi_grp::InstrmtLegIOIGrp>,
	/// PriceType
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "423")]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "130")]
	pub ioi_natural_flag: Option<IOINaturalFlag>,
	/// Required if any IOIQualifiers are specified. Indicates the number of repeating IOIQualifiers.
	#[serde(flatten)]
	pub ioi_qual_grp: Option<super::super::ioi_qual_grp::IOIQualGrp>,
	/// Text
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "58")]
...
impl Default for IOINaturalFlag {
	fn default() -> Self {
		IOINaturalFlag::NotNatural
	}
}
