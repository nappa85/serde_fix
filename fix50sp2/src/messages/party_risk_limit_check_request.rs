...
pub struct PartyRiskLimitCheckRequest {
	/// MsgType = DF
	#[serde(flatten)]
	pub standard_message_header: super::super::standard_message_header::StandardMessageHeader<'D', 'F'>,
	/// Either RiskLimitCheckRequestID(2318) or RiskLimitCheckID(2319) must be specified. RiskLimitCheckRequestID(2318) is conditionally
	/// required in a message-chaining model in which a subsequent message may refer to a prior message via RiskLimitCheckRequestRefID(2322).
	/// The alternative is an entity-based model in which RiskLimitCheckID(2319) is used to statically identify a given request. In
	/// this case RiskLimitCheckID(2319) is required and RiskLimitRequestID(1666) can be optionally specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2318")]
	pub risk_limit_check_request_id: Option<String>,
	/// Either RiskLimitCheckRequestID(2318) or RiskLimitCheckID(2319) must be specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2319")]
	pub risk_limit_check_id: Option<String>,
	/// RiskLimitCheckTransType
	#[serde(rename = "2320")]
	pub risk_limit_check_trans_type: RiskLimitCheckTransType,
	/// RiskLimitCheckType
	#[serde(rename = "2321")]
	pub risk_limit_check_type: RiskLimitCheckType,
	...
	#[serde(default)]
	#[serde(rename = "2322")]
	pub risk_limit_check_request_ref_id: Option<i32>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2323")]
	pub risk_limit_check_request_type: Option<RiskLimitCheckRequestType>,
	/// Specifies the amount being requested or consumed, as indicated by RiskLimitCheckType(2321).
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2324")]
	pub risk_limit_check_amount: Option<f64>,
	/// Currency
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "15")]
