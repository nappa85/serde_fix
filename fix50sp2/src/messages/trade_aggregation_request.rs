...
pub struct TradeAggregationRequest {
	...
	#[serde(rename = "2787")]
	pub trade_aggregation_request_ref_id: Option<String>,
	/// Note that for the recommended practices only "new" is supported.
	#[serde(rename = "2788")]
	pub trade_aggregation_trans_type: TradeAggregationTransType,
	...
	/// Identifies the dealt currency for aggregation.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "15")]
	...
	#[serde(flatten)]
	pub order_aggregation_grp: Option<super::super::order_aggregation_grp::OrderAggregationGrp>,
	/// Maybe used to specify the IDs of the execution fills being aggregated together. This will be mandatory for FX recommended
	/// practices.
	#[serde(flatten)]
	pub execution_aggregation_grp: Option<super::super::execution_aggregation_grp::ExecutionAggregationGrp>,
	/// Aggregation or holding account identifier.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1")]
