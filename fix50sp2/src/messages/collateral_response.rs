...
pub struct CollateralResponse {
	/// MsgType = AZ
	#[serde(flatten)]
	pub standard_message_header: super::super::standard_message_header::StandardMessageHeader<'A', 'Z'>,
	/// Unique identifer for the collateral response
	#[serde(rename = "904")]
	pub coll_resp_id: String,
	/// Conditionally required when responding to a <a href="message_Collateral_Assignment_AY.html" target="main">Collateral Assignment&nbsp;(AY)</a> message
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "902")]
	pub coll_asgn_id: Option<String>,
	/// Identifer of <a href="tag_894_CollReqID.html" target="bottom">CollReqID&nbsp;(894)</a> to which the <a href="message_Collateral_Assignment_AY.html" target="main">Collateral Assignment&nbsp;(AY)</a> is in response
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "894")]
	pub coll_req_id: Option<String>,
	/// Conditionally required when responding to a <a href="message_Collateral_Assignment_AY.html" target="main">Collateral Assignment&nbsp;(AY)</a> message
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "895")]
	...
	/// Conditionally required when <a href="tag_905_CollAsgnRespType.html" target="bottom">CollAsgnRespType(905)&nbsp;(905)</a> = 3 (Rejected).
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "906")]
	...
	#[serde(flatten)]
	pub exec_coll_grp: Option<super::super::exec_coll_grp::ExecCollGrp>,
	/// Trades for which collateral is required
	#[serde(flatten)]
	pub trd_coll_grp: Option<super::super::trd_coll_grp::TrdCollGrp>,
	/// Instrument
	#[serde(flatten)]
	...
	/// Can be used to specify the value date of the collateral transaction where the transaction is for a specific future date (e.g.
	...
	/// The unique transaction entity identifier assigned by the counterparty to the transaction, if known. Echoes the value from <a href="message_Collateral_Assignment_AY.html" target="main">Collateral Assignment (AY)&nbsp;(AY)</a> message if provided.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2484")]
	pub firm_transaction_id: Option<String>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2516")]
	pub collateral_request_instruction: Option<String>,
...
pub enum CollAsgnRespType {
	...
	#[serde(rename = "3")]
	Rejected,
	/// Transaction pending (The collateral assignment transaction is pending at the recipient.)
	#[serde(rename = "4")]
	TransactionPending,
