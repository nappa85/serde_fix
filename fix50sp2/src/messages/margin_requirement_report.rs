...
pub struct MarginRequirementReport {
	/// MsgType = CJ
	#[serde(flatten)]
	pub standard_message_header: super::super::standard_message_header::StandardMessageHeader<'C', 'J'>,
	...
	#[serde(rename = "1642")]
	pub margin_reqmt_rpt_id: String,
	...
	/// Set to 'Y' if message is sent as a result of a subscription request or out of band configuration as opposed to a Margin Requirement
	/// Inquiry.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "325")]
	...
	#[serde(flatten)]
	pub margin_amount: super::super::margin_amount::MarginAmount,
