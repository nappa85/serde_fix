...
pub struct MarketDataStatisticsReport {
	/// MsgType = DP
	#[serde(flatten)]
	pub standard_message_header: super::super::standard_message_header::StandardMessageHeader<'D', 'P'>,
	/// ApplicationSequenceControl
	#[serde(flatten)]
	pub application_sequence_control: Option<super::super::application_sequence_control::ApplicationSequenceControl>,
	/// <p>Unique message identifier for the report</p>
	#[serde(rename = "2453")]
	pub md_statistic_rpt_id: String,
	/// <p>Unique message identifier for the request or the identifier of a previous request when unsubscribing. Conditionally required
	/// if report is sent in response to a MarketDataStatisticsRequest(35=DO) message
	/// </p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2452")]
	pub md_statistic_req_id: Option<String>,
	/// <p>Conditionally required if report is sent in response to a MarketDataStatisticsRequest(35=DO) message.</p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2473")]
	pub md_statistic_request_result: Option<MDStatisticRequestResult>,
	/// <p>Set to "Y" if message is sent as a result of a subscription request not a snapshot request</p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "325")]
	...
	/// MDStatisticRptGrp
	#[serde(flatten)]
	pub md_statistic_rpt_grp: super::super::md_statistic_rpt_grp::MDStatisticRptGrp,
...
pub enum MDStatisticRequestResult {
	...
	#[serde(rename = "6")]
	TradeDateOutOfSupportedRange,
	/// Statistic type not supported
	#[serde(rename = "7")]
	StatisticTypeNotSupported,
	/// Scope or sub-scope not supported
	#[serde(rename = "8")]
	ScopeOrSubScopeNotSupported,
	/// Scope type not supported
	#[serde(rename = "9")]
	ScopeTypeNotSupported,
