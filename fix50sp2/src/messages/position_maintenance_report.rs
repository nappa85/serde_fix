...
pub struct Position {
	...
	/// Reference to the <a href="tag_710_PosReqID.html" target="bottom">PosReqID&nbsp;(710)</a> of a previous maintenance request that is being replaced or canceled.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "713")]
	pub orig_pos_req_ref_id: Option<String>,
	/// Status of Position Maintenance Request. Condtionally required when responding to a PositionMaintenanceRequest.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "722")]
	pub pos_maint_status: Option<PosMaintStatus>,
	/// PosMaintResult
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "723")]
	...
	/// Reference to a <a href="tag_721_PosMaintRptID.html" target="bottom">PosMaintRptID&nbsp;(721)</a> (Tag 721) from a previous <a href="message_Position_Maintenance_Report_AM.html" target="main">Position Maintenance Report&nbsp;(AM)</a> that is being replaced or canceled
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "714")]
	...
	/// Can be set to true when a position maintenance request is being performed contrary to current money position, i.e. for an
	...
	/// Time this order request was initiated/released by the trader, trading system, or intermediary. Conditionally required except
	...
	/// Insert here here the set of "Position Amount Data" fields "Common Components of Application Messages".
	#[serde(flatten)]
	pub position_amount_data: Option<super::super::position_amount_data::PositionAmountData>,
	/// Type of adjustment to be applied Delta_plus, Delta_minus, Final. If <a href="tag_334_Adjustment.html" target="bottom">Adjustment&nbsp;(334)</a> Type is null, the PCS request will be processed as Margin Disposition only
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "718")]
