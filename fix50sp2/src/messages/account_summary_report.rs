...
pub struct AccountSummaryReport {
	/// MsgType = CQ
	#[serde(flatten)]
	pub standard_message_header: super::super::standard_message_header::StandardMessageHeader<'C', 'Q'>,
	...
	/// SettlementAmountGrp
	#[serde(flatten)]
	pub settlement_amount_grp: Option<super::super::settlement_amount_grp::SettlementAmountGrp>,
	/// MarginAmount
	#[serde(flatten)]
	pub margin_amount: Option<super::super::margin_amount::MarginAmount>,
	...
	/// PayCollectGrp
	#[serde(flatten)]
	pub pay_collect_grp: Option<super::super::pay_collect_grp::PayCollectGrp>,
	/// SettlSessID
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "716")]
