...
pub struct MarginRequirementInquiryAck {
	/// MsgType = CI
	#[serde(flatten)]
	pub standard_message_header: super::super::standard_message_header::StandardMessageHeader<'C', 'I'>,
...
impl Default for MarginReqmtInqStatus {
	fn default() -> Self {
		MarginReqmtInqStatus::Accepted
	}
}
...
impl Default for MarginReqmtInqResult {
	fn default() -> Self {
