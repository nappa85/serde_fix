...
pub struct OrderMassActionRequest {
	/// MsgType = CA
	#[serde(flatten)]
	pub standard_message_header: super::super::standard_message_header::StandardMessageHeader<'C', 'A'>,
...
impl Default for MassActionReason {
	fn default() -> Self {
		MassActionReason::NoSpecialReason
	}
}
