...
pub struct Quote {
	...
	/// Required when responding to the <a href="message_QuoteResponse_AJ.html" target="main">Quote Response&nbsp;(AJ)</a> message. The counterparty specified ID of the <a href="message_QuoteResponse_AJ.html" target="main">Quote Response&nbsp;(AJ)</a> message.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "693")]
	...
	/// <p>Can be used when modifying an existing quote.</p>
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1751")]
	...
	/// Required when quote is in response to a Quote Request(35=R) message.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "37")]
	...
	#[serde(default)]
	#[serde(rename = "2533")]
	pub bid_spread: Option<f64>,
	/// SpreadOrBenchmarkCurveData component may be used to specify the benchmark.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "fix_common::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "2534")]
	pub offer_spread: Option<f64>,
	/// RelativeValueGrp
	#[serde(flatten)]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2837")]
	pub single_quote_indicator: Option<SingleQuoteIndicator>,
	/// OwnerType
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "522")]
...
#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum SingleQuoteIndicator {
	/// Multiple quotes allowed
	#[serde(rename = "N")]
	MultipleQuotesAllowed,
	/// Only one quote allowed
	#[serde(rename = "Y")]
	OnlyOneQuoteAllowed,
}

impl Default for SingleQuoteIndicator {
	fn default() -> Self {
		SingleQuoteIndicator::MultipleQuotesAllowed
	}
}
