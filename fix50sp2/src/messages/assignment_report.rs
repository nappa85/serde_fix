...
pub struct AssignmentReport {
	...
	/// If specified, the identifier of the <a href="message_Request_For_Positions_AN.html" target="main">RequestForPositions&nbsp;(AN)</a> to which this message is sent in response.
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "747")]
	pub exercise_method: Option<ExerciseMethod>,
	/// SettlSessID
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "716")]
