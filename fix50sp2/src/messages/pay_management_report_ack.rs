...
pub struct PayManagementReportAck {
	/// MsgType = DZ
	#[serde(flatten)]
	pub standard_message_header: super::super::standard_message_header::StandardMessageHeader<'D', 'Z'>,
	/// PayReportID
	#[serde(rename = "2799")]
...
impl Default for PayReportStatus {
	fn default() -> Self {
		PayReportStatus::ReceivedNotYetProcessed
	}
}
