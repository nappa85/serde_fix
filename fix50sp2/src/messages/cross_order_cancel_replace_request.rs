...
pub struct Cross {
	...
	#[serde(rename = "548")]
	pub cross_id: String,
	/// Must match the <a href="tag_548_CrossID.html" target="bottom">CrossID&nbsp;(548)</a> of the previous cross order. Same order chaining mechanism as ClOrdID/OrigClOrdID with single order Cancel/Replace.
	#[serde(rename = "551")]
