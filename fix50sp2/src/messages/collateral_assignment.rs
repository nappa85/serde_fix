...
pub struct CollateralAssignment {
	...
	#[serde(rename = "903")]
	pub coll_asgn_trans_type: CollAsgnTransType,
	/// Collateral assignment to which this transaction refers
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "907")]
	pub coll_asgn_ref_id: Option<String>,
	/// TransactTime
	#[serde(rename = "60")]
	...
	/// Can be used to provide the value date of the collateral transaction where the deposit or withdrawal is for a specific future
	/// date.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "64")]
	...
	/// The unique transaction entity identifier assigned by the firm sending the <a href="message_Collateral_Assignment_AY.html" target="main">Collateral Assignment (AY)&nbsp;(AY)</a> message
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2484")]
