...
pub struct MassOrderAck {
	/// MsgType = DK
	#[serde(flatten)]
	pub standard_message_header: super::super::standard_message_header::StandardMessageHeader<'D', 'K'>,
...
impl Default for MassOrderRequestStatus {
	fn default() -> Self {
...
impl Default for MassOrderRequestResult {
	fn default() -> Self {
