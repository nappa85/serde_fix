...
pub struct PartyRiskLimitCheckRequestAck {
	/// MsgType = DG
	#[serde(flatten)]
	...
	#[serde(rename = "2325")]
	pub risk_limit_check_request_status: RiskLimitCheckRequestStatus,
	/// RiskLimitCheckRequestResult
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2326")]
	pub risk_limit_check_request_result: Option<RiskLimitCheckRequestResult>,
	...
	#[serde(default)]
	#[serde(rename = "2327")]
	pub risk_limit_approved_amount: Option<f64>,
...
pub enum RiskLimitCheckRequestResult {
	...
	#[serde(rename = "2")]
	RequestedAmountExceedsCreditLimit,
	/// Requested amount exceeds clip size limit
	#[serde(rename = "3")]
	RequestedAmountExceedsClipSizeLimit,
	/// Request exceeds maximum notional order amount
	#[serde(rename = "4")]
	RequestExceedsMaximumNotionalOrderAmount,
	/// Other
	#[serde(rename = "99")]
	Other,
}
