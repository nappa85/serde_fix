...
pub struct New {
	...
	#[serde(flatten)]
	pub side_cross_ord_mod_grp: super::super::side_cross_ord_mod_grp::SideCrossOrdModGrp,
	...
	/// (Deprecated in FIX.5.0) Mandatory for a <a href="tag_847_TargetStrategy.html" target="bottom">TargetStrategy&nbsp;(847)</a> =Participate order and specifies the target particpation rate. For other order types optionally specifies a volume limit (i.e.
