...
pub struct PositionTransferReport {
	...
	/// TransferTransType
	#[serde(rename = "2439")]
	pub transfer_trans_type: TransferTransType,
	/// TransferReportType
	#[serde(rename = "2444")]
	pub transfer_report_type: TransferReportType,
	/// TransferStatus
	#[serde(rename = "2442")]
	...
	/// <p>Position to transfer from the perspective of the source party prior to the transfer.</p>
	/// <p>If not specified, indicates transfer of all positions for a specified instrument, if Instrument is specified, or transfer
	/// of all positions if Instrument is not specified.
	/// </p>
	#[serde(flatten)]
	...
	/// <p>Optionally used to include cash residuals, etc., from the perspective of the source party prior to the transfer</p>
	#[serde(flatten)]
...
impl Default for TransferReportType {
	fn default() -> Self {
		TransferReportType::Submit
	}
}
