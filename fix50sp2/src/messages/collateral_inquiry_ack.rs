...
pub struct Collateral {
	...
	/// Status of the <a href="message_Collateral_Inquiry_BB.html" target="main">Collateral Inquiry&nbsp;(BB)</a> referenced by CollInquiryID
	#[serde(rename = "945")]
	pub coll_inquiry_status: CollInquiryStatus,
	/// Result of the Collateral Inquriy referenced by <a href="tag_909_CollInquiryID.html" target="bottom">CollInquiryID&nbsp;(909)</a> - specifies any errors or warnings
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "946")]
	pub coll_inquiry_result: Option<CollInquiryResult>,
	/// Number of qualifiers to inquiry
	#[serde(flatten)]
	pub coll_inq_qual_grp: Option<super::super::coll_inq_qual_grp::CollInqQualGrp>,
