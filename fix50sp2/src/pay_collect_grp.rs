...
#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PayCollect {
	/// Required if NoPayCollects(1707) &gt; 0
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1708")]
	pub pay_collect_type: Option<String>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1712")]
	pub pay_collect_market_segment_id: Option<String>,
	/// PayCollectMarketID
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1713")]
