...
pub struct UnderlyingDividendPaymentGrp {
	...
	#[serde(rename = "42855")]
	pub underlying_dividend_payments: Option<crate::entities::RepeatingValues<UnderlyingDividendPayment>>,
}
...
pub struct UnderlyingDividendPayment {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42856")]
	pub underlying_dividend_payment_date: Option<crate::entities::LocalMktDate>,
	/// Required if NoUnderlyingDividendPayments (42855) &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
