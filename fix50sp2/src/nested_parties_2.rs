...
pub struct NestedParties2 {
	...
	#[serde(rename = "756")]
	pub nested_2_party_i_ds: Option<crate::entities::RepeatingValues<Nested2PartyID>>,
}
...
pub struct Nested2PartyID {
	...
	/// Used to identify class source of <a href="tag_757_Nested2PartyID.html" target="bottom">Nested2PartyID&nbsp;(757)</a> value (e.g. BIC). Required if <a href="tag_757_Nested2PartyID.html" target="bottom">Nested2PartyID&nbsp;(757)</a> is specified. Required if <a href="tag_756_NoNested2PartyIDs.html" target="bottom">NoNested2PartyIDs&nbsp;(756)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "758")]
	pub nested_2_party_id_source: Option<Nested2PartyIDSource>,
	/// Identifies the type of <a href="tag_757_Nested2PartyID.html" target="bottom">Nested2PartyID&nbsp;(757)</a> (e.g. Executing Broker). Required if <a href="tag_756_NoNested2PartyIDs.html" target="bottom">NoNested2PartyIDs&nbsp;(756)</a> &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "759")]
	...
	#[serde(default)]
	#[serde(rename = "2381")]
	pub nested_2_party_role_qualifier: Option<i32>,
}
