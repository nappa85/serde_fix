...
pub struct UnderlyingProvisionGrp {
	/// NoUnderlyingProvisions
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42149")]
	pub underlying_provisions: Option<crate::entities::RepeatingValues<UnderlyingProvision>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct UnderlyingProvision {
	/// Required if NoUnderlyingProvisions(42149) &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42150")]
	pub underlying_provision_type: Option<UnderlyingProvisionType>,
	/// UnderlyingProvisionDateUnadjusted
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42151")]
	pub underlying_provision_date_unadjusted: Option<crate::entities::LocalMktDate>,
	...
	/// The specified value would be specific to this instance of the instrument provisions.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42152")]
	pub underlying_provision_date_business_day_convention: Option<UnderlyingProvisionDateBusinessDayConvention>,
	/// UnderlyingProvisionDateAdjusted
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42153")]
	pub underlying_provision_date_adjusted: Option<crate::entities::LocalMktDate>,
	/// Conditionally required when UnderlyingProvisionDateTenorUnit(42155) is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "crate::entities::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "42154")]
	pub underlying_provision_date_tenor_period: Option<i32>,
	/// Conditionally required when UnderlyingProvisionDateTenorPeriod(42154) is specified.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42155")]
	pub underlying_provision_date_tenor_unit: Option<UnderlyingProvisionDateTenorUnit>,
	/// UnderlyingProvisionCalculationAgent
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42156")]
	pub underlying_provision_calculation_agent: Option<UnderlyingProvisionCalculationAgent>,
	/// UnderlyingProvisionOptionSinglePartyBuyerSide
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42157")]
	pub underlying_provision_option_single_party_buyer_side: Option<UnderlyingProvisionOptionSinglePartyBuyerSide>,
	/// UnderlyingProvisionOptionSinglePartySellerSide
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42158")]
	pub underlying_provision_option_single_party_seller_side: Option<UnderlyingProvisionOptionSinglePartySellerSide>,
	/// UnderlyingProvisionOptionExerciseStyle
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42159")]
	pub underlying_provision_option_exercise_style: Option<UnderlyingProvisionOptionExerciseStyle>,
	/// UnderlyingProvisionOptionExerciseMultipleNotional
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "crate::entities::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "42160")]
	pub underlying_provision_option_exercise_multiple_notional: Option<f64>,
	/// UnderlyingProvisionOptionExerciseMinimumNotional
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "crate::entities::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "42161")]
	pub underlying_provision_option_exercise_minimum_notional: Option<f64>,
	/// UnderlyingProvisionOptionExerciseMaximumNotional
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "crate::entities::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "42162")]
	pub underlying_provision_option_exercise_maximum_notional: Option<f64>,
	/// UnderlyingProvisionOptionMinimumNumber
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "crate::entities::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "42163")]
	pub underlying_provision_option_minimum_number: Option<i32>,
	/// UnderlyingProvisionOptionMaximumNumber
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "crate::entities::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	#[serde(rename = "42164")]
	pub underlying_provision_option_maximum_number: Option<i32>,
	/// UnderlyingProvisionOptionExerciseConfirmation
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42165")]
	pub underlying_provision_option_exercise_confirmation: Option<crate::entities::Boolean>,
	/// UnderlyingProvisionCashSettlMethod
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42166")]
	pub underlying_provision_cash_settl_method: Option<UnderlyingProvisionCashSettlMethod>,
	/// UnderlyingProvisionCashSettlCurrency
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42167")]
	pub underlying_provision_cash_settl_currency: Option<UnderlyingProvisionCashSettlCurrency>,
	/// UnderlyingProvisionCashSettlCurrency2
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42168")]
	pub underlying_provision_cash_settl_currency_2: Option<UnderlyingProvisionCashSettlCurrency2>,
	/// UnderlyingProvisionCashSettlQuoteType
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42169")]
	pub underlying_provision_cash_settl_quote_type: Option<UnderlyingProvisionCashSettlQuoteType>,
	...
	#[serde(default)]
	#[serde(rename = "43002")]
	pub underlying_provision_break_fee_election: Option<i32>,
