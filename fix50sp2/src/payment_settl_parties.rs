...
pub struct PaymentSettlParties {
	/// NoPaymentSettlPartyIDs
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40233")]
	pub payment_settl_party_i_ds: Option<crate::entities::RepeatingValues<PaymentSettlPartyID>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct PaymentSettlPartyID {
	/// Required if NoPaymentSettlPartyIDs(40233) &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40234")]
	pub payment_settl_party_id: Option<String>,
	/// Required if NoPaymentSettlPartyIDs(40233) &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40235")]
	pub payment_settl_party_id_source: Option<PaymentSettlPartyIDSource>,
	/// Required if NoPaymentSettlPartyIDs(40233) &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40236")]
	pub payment_settl_party_role: Option<PaymentSettlPartyRole>,
	/// PaymentSettlPartyRoleQualifier
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40237")]
	pub payment_settl_party_role_qualifier: Option<PaymentSettlPartyRoleQualifier>,
}

#[derive(Serialize, Deserialize, Clone, Debug, PartialEq)]
pub enum PaymentSettlPartyIDSource {
