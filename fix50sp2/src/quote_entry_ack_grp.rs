...
pub struct QuoteEntryAckGrp {
	/// The number of quotes for this Symbol (QuoteSet) that follow in this message.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "295")]
	pub quote_entries: Option<crate::entities::RepeatingValues<QuoteEntrie>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct QuoteEntrie {
	/// Uniquely identifies the quote across the complete set of all quotes for a given quote provider. First field in repeating group.
	...
	/// (Deprecated in FIX.5.0) Can be used with OrdType = "Forex - Swap" to specify the "value date" for the future portion of a
	/// F/X swap.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "193")]
	pub settl_date_2: Option<crate::entities::LocalMktDate>,
	/// (Deprecated in FIX.5.0) Can be used with OrdType = "Forex - Swap" to specify the order quantity for the future portion of
	/// a F/X swap.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(deserialize_with = "crate::entities::workarounds::from_opt_str")]// https://github.com/serde-rs/serde/issues/1183
	#[serde(default)]
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1167")]
	pub quote_entry_status: Option<QuoteEntryStatus>,
