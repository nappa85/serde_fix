...
pub struct LegSettlMethodElectionDate {
	...
	#[serde(rename = "42574")]
	pub leg_settl_method_election_date_unadjusted: Option<crate::entities::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42580")]
	pub leg_settl_method_election_date_adjusted: Option<crate::entities::LocalMktDate>,
}
