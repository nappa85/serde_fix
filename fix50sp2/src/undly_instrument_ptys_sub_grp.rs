...
pub struct UndlyInstrumentPtysSubGrp {
...
pub struct UndlyInstrumentPartySubID {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1063")]
	pub underlying_instrument_party_sub_id: Option<String>,
...
impl Default for UnderlyingInstrumentPartySubIDType {
	fn default() -> Self {
		UnderlyingInstrumentPartySubIDType::N1
	}
}
