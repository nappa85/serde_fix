...
pub struct UnderlyingComplexEventPeriodDateGrp {
	...
	#[serde(rename = "41726")]
	pub underlying_complex_event_period_date_times: Option<crate::entities::RepeatingValues<UnderlyingComplexEventPeriodDateTime>>,
}
...
pub struct UnderlyingComplexEventPeriodDateTime {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41727")]
	pub underlying_complex_event_period_date: Option<crate::entities::LocalMktDate>,
