...
pub struct BaseTradingRules {
	/// Specifies price tick rules for the security.
	#[serde(flatten)]
	pub tick_rules: Option<super::tick_rules::TickRules>,
	/// Specifies the lot types that are valid for trading.
	#[serde(flatten)]
	pub lot_type_rules: Option<super::lot_type_rules::LotTypeRules>,
	/// Specifies the price limits that are valid for trading.
	#[serde(flatten)]
	pub price_limits: Option<super::price_limits::PriceLimits>,
	/// ExpirationCycle
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "1786")]
	pub trade_vol_type: Option<TradeVolType>,
	/// Specifies the valid price range tables for trading.
	#[serde(flatten)]
	pub price_range_rule_grp: Option<super::price_range_rule_grp::PriceRangeRuleGrp>,
	/// Specifies the valid quote sizes for trading.
	#[serde(flatten)]
	pub quote_size_rule_grp: Option<super::quote_size_rule_grp::QuoteSizeRuleGrp>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "2559")]
	pub quote_side_indicator: Option<QuoteSideIndicator>,
}
...
pub enum QuoteSideIndicator {
	...
	#[serde(rename = "N")]
	SingleSidedQuotesAreNotAllowed,
