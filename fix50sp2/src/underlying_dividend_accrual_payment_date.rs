...
pub struct UnderlyingDividendAccrualPaymentDate {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42823")]
	pub underlying_dividend_accrual_payment_date_unadjusted: Option<crate::entities::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42825")]
	pub underlying_dividend_accrual_payment_date_adjusted: Option<crate::entities::LocalMktDate>,
}
