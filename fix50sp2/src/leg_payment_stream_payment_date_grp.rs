...
pub struct LegPaymentStreamPaymentDateGrp {
	...
	#[serde(rename = "41589")]
	pub leg_payment_stream_payment_dates: Option<crate::entities::RepeatingValues<LegPaymentStreamPaymentDate>>,
}
...
pub struct LegPaymentStreamPaymentDate {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "41590")]
	pub leg_payment_stream_payment_date: Option<crate::entities::LocalMktDate>,
