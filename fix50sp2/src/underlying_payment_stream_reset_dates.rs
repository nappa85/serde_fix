...
pub struct UnderlyingPaymentStreamResetDates {
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40604")]
	pub underlying_payment_stream_initial_fixing_date_adjusted: Option<fix_common::LocalMktDate>,
	...
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "40611")]
	pub underlying_payment_stream_fixing_date_adjusted: Option<fix_common::LocalMktDate>,
