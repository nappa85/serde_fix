...
pub struct UnderlyingProvisionPtysSubGrp {
	/// NoUnderlyingProvisionPartySubIDs
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42177")]
	pub underlying_provision_party_sub_i_ds: Option<fix_common::RepeatingValues<UnderlyingProvisionPartySubID>>,
}

#[derive(Serialize, Deserialize, Clone, Debug, Default, PartialEq)]
pub struct UnderlyingProvisionPartySubID {
	/// Required if NoUnderlyingProvisionPartySubIDs(42177) &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42178")]
	pub underlying_provision_party_sub_id: Option<String>,
	/// Required if NoUnderlyingProvisionPartySubIDs(42177) &gt; 0.
	#[serde(skip_serializing_if = "Option::is_none")]
	#[serde(rename = "42179")]
	pub underlying_provision_party_sub_id_type: Option<UnderlyingProvisionPartySubIDType>,
}

#[derive(Serialize, Deserialize, Clone, Copy, Debug, PartialEq)]
pub enum UnderlyingProvisionPartySubIDType {
	/// Firm
	#[serde(rename = "1")]
	N1,
	/// Person
...
impl Default for UnderlyingProvisionPartySubIDType {
	fn default() -> Self {
		UnderlyingProvisionPartySubIDType::N1
	}
}
